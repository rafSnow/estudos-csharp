(function(){const C=document.createElement("link").relList;if(C&&C.supports&&C.supports("modulepreload"))return;for(const E of document.querySelectorAll('link[rel="modulepreload"]'))b(E);new MutationObserver(E=>{for(const S of E)if(S.type==="childList")for(const R of S.addedNodes)R.tagName==="LINK"&&R.rel==="modulepreload"&&b(R)}).observe(document,{childList:!0,subtree:!0});function c(E){const S={};return E.integrity&&(S.integrity=E.integrity),E.referrerPolicy&&(S.referrerPolicy=E.referrerPolicy),E.crossOrigin==="use-credentials"?S.credentials="include":E.crossOrigin==="anonymous"?S.credentials="omit":S.credentials="same-origin",S}function b(E){if(E.ep)return;E.ep=!0;const S=c(E);fetch(E.href,S)}})();var Ki={exports:{}},_t={},Yi={exports:{}},ae={};/**
 * @license React
 ...
 */var Jc;function dm(){if(Jc)return ae;Jc=1;var l=Symbol.for("react.element"),C=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),b=Symbol.for("react.strict_mode"),E=Symbol.for("react.profiler"),S=Symbol.for("react.provider"),R=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),O=Symbol.for("react.memo"),z=Symbol.for("react.lazy"),q=Symbol.iterator;function k(f){return f===null||typeof f!="object"?null:(f=q&&f[q]||f["@@iterator"],typeof f=="function"?f:null)}var K={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,V={};function U(f,I,J){this.props=f,this.context=I,this.refs=V,this.updater=J||K}U.prototype.isReactComponent={},U.prototype.setState=function(f,I){if(typeof f!="object"&&typeof f!="function"&&f!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,f,I,"setState")},U.prototype.forceUpdate=function(f){this.updater.enqueueForceUpdate(this,f,"forceUpdate")};function G(){}G.prototype=U.prototype;function X(f,I,J){this.props=f,this.context=I,this.refs=V,this.updater=J||K}var ue=X.prototype=new G;ue.constructor=X,Z(ue,U.prototype),ue.isPureReactComponent=!0;var be=Array.isArray,Me=Object.prototype.hasOwnProperty,Re={current:null},me={key:!0,ref:!0,__self:!0,__source:!0};function Oe(f,I,J){var ee,te={},re=null,le=null;if(I!=null)for(ee in I.ref!==void 0&&(le=I.ref),I.key!==void 0&&(re=""+I.key),I)Me.call(I,ee)&&!me.hasOwnProperty(ee)&&(te[ee]=I[ee]);var ie=arguments.length-2;if(ie===1)te.children=J;else if(1<ie){for(var H=Array(ie),oe=0;oe<ie;oe++)H[oe]=arguments[oe+2];te.children=H}if(f&&f.defaultProps)for(ee in ie=f.defaultProps,ie)te[ee]===void 0&&(te[ee]=ie[ee]);return{$$typeof:l,type:f,key:re,ref:le,props:te,_owner:Re.current}}function ro(f,I){return{$$typeof:l,type:f.type,key:I,ref:f.ref,props:f.props,_owner:f._owner}}function ge(f){return typeof f=="object"&&f!==null&&f.$$typeof===l}function Lo(f){var I={"=":"=0",":":"=2"};return"$"+f.replace(/[=:]/g,function(J){return I[J]})}var no=/\/+/g;function Ue(f,I){return typeof f=="object"&&f!==null&&f.key!=null?Lo(""+f.key):I.toString(36)}function Ye(f,I,J,ee,te){var re=typeof f;(re==="undefined"||re==="boolean")&&(f=null);var le=!1;if(f===null)le=!0;else switch(re){case"string":case"number":le=!0;break;case"object":switch(f.$$typeof){case l:case C:le=!0}}if(le)return le=f,te=te(le),f=ee===""?"."+Ue(le,0):ee,be(te)?(J="",f!=null&&(J=f.replace(no,"$&/")+"/"),Ye(te,I,J,"",function(oe){return oe})):te!=null&&(ge(te)&&(te=ro(te,J+(!te.key||le&&le.key===te.key?"":(""+te.key).replace(no,"$&/")+"/")+f)),I.push(te)),1;if(le=0,ee=ee===""?".":ee+":",be(f))for(var ie=0;ie<f.length;ie++){re=f[ie];var H=ee+Ue(re,ie);le+=Ye(re,I,J,H,te)}else if(H=k(f),typeof H=="function")for(f=H.call(f),ie=0;!(re=f.next()).done;)re=re.value,H=ee+Ue(re,ie++),le+=Ye(re,I,J,H,te);else if(re==="object")throw I=String(f),Error("Objects are not valid as a React child (found: "+(I==="[object Object]"?"object with keys {"+Object.keys(f).join(", ")+"}":I)+"). If you meant to render a collection of children, use an array instead.");return le}function io(f,I,J){if(f==null)return f;var ee=[],te=0;return Ye(f,ee,"","",function(re){return I.call(J,re,te++)}),ee}function _e(f){if(f._status===-1){var I=f._result;I=I(),I.then(function(J){(f._status===0||f._status===-1)&&(f._status=1,f._result=J)},function(J){(f._status===0||f._status===-1)&&(f._status=2,f._result=J)}),f._status===-1&&(f._status=0,f._result=I)}if(f._status===1)return f._result.default;throw f._result}var ve={current:null},N={transition:null},W={ReactCurrentDispatcher:ve,ReactCurrentBatchConfig:N,ReactCurrentOwner:Re};function L(){throw Error("act(...) is not supported in production builds of React.")}return ae.Children={map:io,forEach:function(f,I,J){io(f,function(){I.apply(this,arguments)},J)},count:function(f){var I=0;return io(f,function(){I++}),I},toArray:function(f){return io(f,function(I){return I})||[]},only:function(f){if(!ge(f))throw Error("React.Children.only expected to receive a single React element child.");return f}},ae.Component=U,ae.Fragment=c,ae.Profiler=E,ae.PureComponent=X,ae.StrictMode=b,ae.Suspense=y,ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=W,ae.act=L,ae.cloneElement=function(f,I,J){if(f==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+f+".");var ee=Z({},f.props),te=f.key,re=f.ref,le=f._owner;if(I!=null){if(I.ref!==void 0&&(re=I.ref,le=Re.current),I.key!==void 0&&(te=""+I.key),f.type&&f.type.defaultProps)var ie=f.type.defaultProps;for(H in I)Me.call(I,H)&&!me.hasOwnProperty(H)&&(ee[H]=I[H]===void 0&&ie!==void 0?ie[H]:I[H])}var H=arguments.length-2;if(H===1)ee.children=J;else if(1<H){ie=Array(H);for(var oe=0;oe<H;oe++)ie[oe]=arguments[oe+2];ee.children=ie}return{$$typeof:l,type:f.type,key:te,ref:re,props:ee,_owner:le}},ae.createContext=function(f){return f={$$typeof:R,_currentValue:f,_currentValue2:f,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},f.Provider={$$typeof:S,_context:f},f.Consumer=f},ae.createElement=Oe,ae.createFactory=function(f){var I=Oe.bind(null,f);return I.type=f,I},ae.createRef=function(){return{current:null}},ae.forwardRef=function(f){return{$$typeof:P,render:f}},ae.isValidElement=ge,ae.lazy=function(f){return{$$typeof:z,_payload:{_status:-1,_result:f},_init:_e}},ae.memo=function(f,I){return{$$typeof:O,type:f,compare:I===void 0?null:I}},ae.startTransition=function(f){var I=N.transition;N.transition={};try{f()}finally{N.transition=I}},ae.unstable_act=L,ae.useCallback=function(f,I){return ve.current.useCallback(f,I)},ae.useContext=function(f){return ve.current.useContext(f)},ae.useDebugValue=function(){},ae.useDeferredValue=function(f){return ve.current.useDeferredValue(f)},ae.useEffect=function(f,I){return ve.current.useEffect(f,I)},ae.useId=function(){return ve.current.useId()},ae.useImperativeHandle=function(f,I,J){return ve.current.useImperativeHandle(f,I,J)},ae.useInsertionEffect=function(f,I){return ve.current.useInsertionEffect(f,I)},ae.useLayoutEffect=function(f,I){return ve.current.useLayoutEffect(f,I)},ae.useMemo=function(f,I){return ve.current.useMemo(f,I)},ae.useReducer=function(f,I,J){return ve.current.useReducer(f,I,J)},ae.useRef=function(f){return ve.current.useRef(f)},ae.useState=function(f){return ve.current.useState(f)},ae.useSyncExternalStore=function(f,I,J){return ve.current.useSyncExternalStore(f,I,J)},ae.useTransition=function(){return ve.current.useTransition()},ae.version="18.3.1",ae}var Zc;function ts(){return Zc||(Zc=1,Yi.exports=dm()),Yi.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ed;function um(){if(ed)return _t;ed=1;var l=ts(),C=Symbol.for("react.element"),c=Symbol.for("react.fragment"),b=Object.prototype.hasOwnProperty,E=l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,S={key:!0,ref:!0,__self:!0,__source:!0};function R(P,y,O){var z,q={},k=null,K=null;O!==void 0&&(k=""+O),y.key!==void 0&&(k=""+y.key),y.ref!==void 0&&(K=y.ref);for(z in y)b.call(y,z)&&!S.hasOwnProperty(z)&&(q[z]=y[z]);if(P&&P.defaultProps)for(z in y=P.defaultProps,y)q[z]===void 0&&(q[z]=y[z]);return{$$typeof:C,type:P,key:k,ref:K,props:q,_owner:E.current}}return _t.Fragment=c,_t.jsx=R,_t.jsxs=R,_t}var od;function mm(){return od||(od=1,Ki.exports=um()),Ki.exports}var d=mm(),Kr={},Xi={exports:{}},to={},Ji={exports:{}},Zi={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ad;function pm(){return ad||(ad=1,(function(l){function C(N,W){var L=N.length;N.push(W);e:for(;0<L;){var f=L-1>>>1,I=N[f];if(0<E(I,W))N[f]=W,N[L]=I,L=f;else break e}}function c(N){return N.length===0?null:N[0]}function b(N){if(N.length===0)return null;var W=N[0],L=N.pop();if(L!==W){N[0]=L;e:for(var f=0,I=N.length,J=I>>>1;f<J;){var ee=2*(f+1)-1,te=N[ee],re=ee+1,le=N[re];if(0>E(te,L))re<I&&0>E(le,te)?(N[f]=le,N[re]=L,f=re):(N[f]=te,N[ee]=L,f=ee);else if(re<I&&0>E(le,L))N[f]=le,N[re]=L,f=re;else break e}}return W}function E(N,W){var L=N.sortIndex-W.sortIndex;return L!==0?L:N.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var S=performance;l.unstable_now=function(){return S.now()}}else{var R=Date,P=R.now();l.unstable_now=function(){return R.now()-P}}var y=[],O=[],z=1,q=null,k=3,K=!1,Z=!1,V=!1,U=typeof setTimeout=="function"?setTimeout:null,G=typeof clearTimeout=="function"?clearTimeout:null,X=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ue(N){for(var W=c(O);W!==null;){if(W.callback===null)b(O);else if(W.startTime<=N)b(O),W.sortIndex=W.expirationTime,C(y,W);else break;W=c(O)}}function be(N){if(V=!1,ue(N),!Z)if(c(y)!==null)Z=!0,_e(Me);else{var W=c(O);W!==null&&ve(be,W.startTime-N)}}function Me(N,W){Z=!1,V&&(V=!1,G(Oe),Oe=-1),K=!0;var L=k;try{for(ue(W),q=c(y);q!==null&&(!(q.expirationTime>W)||N&&!Lo());){var f=q.callback;if(typeof f=="function"){q.callback=null,k=q.priorityLevel;var I=f(q.expirationTime<=W);W=l.unstable_now(),typeof I=="function"?q.callback=I:q===c(y)&&b(y),ue(W)}else b(y);q=c(y)}if(q!==null)var J=!0;else{var ee=c(O);ee!==null&&ve(be,ee.startTime-W),J=!1}return J}finally{q=null,k=L,K=!1}}var Re=!1,me=null,Oe=-1,ro=5,ge=-1;function Lo(){return!(l.unstable_now()-ge<ro)}function no(){if(me!==null){var N=l.unstable_now();ge=N;var W=!0;try{W=me(!0,N)}finally{W?Ue():(Re=!1,me=null)}}else Re=!1}var Ue;if(typeof X=="function")Ue=function(){X(no)};else if(typeof MessageChannel<"u"){var Ye=new MessageChannel,io=Ye.port2;Ye.port1.onmessage=no,Ue=function(){io.postMessage(null)}}else Ue=function(){U(no,0)};function _e(N){me=N,Re||(Re=!0,Ue())}function ve(N,W){Oe=U(function(){N(l.unstable_now())},W)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(N){N.callback=null},l.unstable_continueExecution=function(){Z||K||(Z=!0,_e(Me))},l.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ro=0<N?Math.floor(1e3/N):5},l.unstable_getCurrentPriorityLevel=function(){return k},l.unstable_getFirstCallbackNode=function(){return c(y)},l.unstable_next=function(N){switch(k){case 1:case 2:case 3:var W=3;break;default:W=k}var L=k;k=W;try{return N()}finally{k=L}},l.unstable_pauseExecution=function(){},l.unstable_requestPaint=function(){},l.unstable_runWithPriority=function(N,W){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var L=k;k=N;try{return W()}finally{k=L}},l.unstable_scheduleCallback=function(N,W,L){var f=l.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?f+L:f):L=f,N){case 1:var I=-1;break;case 2:I=250;break;case 5:I=1073741823;break;case 4:I=1e4;break;default:I=5e3}return I=L+I,N={id:z++,callback:W,priorityLevel:N,startTime:L,expirationTime:I,sortIndex:-1},L>f?(N.sortIndex=L,C(O,N),c(y)===null&&N===c(O)&&(V?(G(Oe),Oe=-1):V=!0,ve(be,L-f))):(N.sortIndex=I,C(y,N),Z||K||(Z=!0,_e(Me))),N},l.unstable_shouldYield=Lo,l.unstable_wrapCallback=function(N){var W=k;return function(){var L=k;k=W;try{return N.apply(this,arguments)}finally{k=L}}}})(Zi)),Zi}var td;function fm(){return td||(td=1,Ji.exports=pm()),Ji.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rd;function gm(){if(rd)return to;rd=1;var l=ts(),C=fm();function c(e){for(var o="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)o+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+o+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var b=new Set,E={};function S(e,o){R(e,o),R(e+"Capture",o)}function R(e,o){for(E[e]=o,e=0;e<o.length;e++)b.add(o[e])}var P=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),y=Object.prototype.hasOwnProperty,O=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,z={},q={};function k(e){return y.call(q,e)?!0:y.call(z,e)?!1:O.test(e)?q[e]=!0:(z[e]=!0,!1)}function K(e,o,a,t){if(a!==null&&a.type===0)return!1;switch(typeof o){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function Z(e,o,a,t){if(o===null||typeof o>"u"||K(e,o,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!o;case 4:return o===!1;case 5:return isNaN(o);case 6:return isNaN(o)||1>o}return!1}function V(e,o,a,t,r,n,i){this.acceptsBooleans=o===2||o===3||o===4,this.attributeName=t,this.attributeNamespace=r,this.mustUseProperty=a,this.propertyName=e,this.type=o,this.sanitizeURL=n,this.removeEmptyString=i}var U={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){U[e]=new V(e,0,!1,e,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var o=e[0];U[o]=new V(o,1,!1,e[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(e){U[e]=new V(e,2,!1,e.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){U[e]=new V(e,2,!1,e,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){U[e]=new V(e,3,!1,e.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(e){U[e]=new V(e,3,!0,e,null,!1,!1)}),["capture","download"].forEach(function(e){U[e]=new V(e,4,!1,e,null,!1,!1)}),["cols","rows","size","span"].forEach(function(e){U[e]=new V(e,6,!1,e,null,!1,!1)}),["rowSpan","start"].forEach(function(e){U[e]=new V(e,5,!1,e.toLowerCase(),null,!1,!1)});var G=/[\-:]([a-z])/g;function X(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var o=e.replace(G,X);U[o]=new V(o,1,!1,e,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var o=e.replace(G,X);U[o]=new V(o,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(e){var o=e.replace(G,X);U[o]=new V(o,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(e){U[e]=new V(e,1,!1,e.toLowerCase(),null,!1,!1)}),U.xlinkHref=new V("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(e){U[e]=new V(e,1,!1,e.toLowerCase(),null,!0,!0)});function ue(e,o,a,t){var r=U.hasOwnProperty(o)?U[o]:null;(r!==null?r.type!==0:t||!(2<o.length)||o[0]!=="o"&&o[0]!=="O"||o[1]!=="n"&&o[1]!=="N")&&(Z(o,a,r,t)&&(a=null),t||r===null?k(o)&&(a===null?e.removeAttribute(o):e.setAttribute(o,""+a)):r.mustUseProperty?e[r.propertyName]=a===null?r.type===3?!1:"":a:(o=r.attributeName,t=r.attributeNamespace,a===null?e.removeAttribute(o):(r=r.type,a=r===3||r===4&&a===!0?"":""+a,t?e.setAttributeNS(t,o,a):e.setAttribute(o,a))))}var be=l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Me=Symbol.for("react.element"),Re=Symbol.for("react.portal"),me=Symbol.for("react.fragment"),Oe=Symbol.for("react.strict_mode"),ro=Symbol.for("react.profiler"),ge=Symbol.for("react.provider"),Lo=Symbol.for("react.context"),no=Symbol.for("react.forward_ref"),Ue=Symbol.for("react.suspense"),Ye=Symbol.for("react.suspense_list"),io=Symbol.for("react.memo"),_e=Symbol.for("react.lazy"),ve=Symbol.for("react.offscreen"),N=Symbol.iterator;function W(e){return e===null||typeof e!="object"?null:(e=N&&e[N]||e["@@iterator"],typeof e=="function"?e:null)}var L=Object.assign,f;function I(e){if(f===void 0)try{throw Error()}catch(a){var o=a.stack.trim().match(/\n( *(at )?)/);f=o&&o[1]||""}return`
...
`+r[i].replace(" at new "," at ");return e.displayName&&u.includes("<anonymous>")&&(u=u.replace("<anonymous>",e.displayName)),u}while(1<=i&&0<=s);break}}}finally{J=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?I(e):""}function te(e){switch(e.tag){case 5:return I(e.type);case 16:return I("Lazy");case 13:return I("Suspense");case 19:return I("SuspenseList");case 0:case 2:case 15:return e=ee(e.type,!1),e;case 11:return e=ee(e.type.render,!1),e;case 1:return e=ee(e.type,!0),e;default:return""}}function re(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case me:return"Fragment";case Re:return"Portal";case ro:return"Profiler";case Oe:return"StrictMode";case Ue:return"Suspense";case Ye:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Lo:return(e.displayName||"Context")+".Consumer";case ge:return(e._context.displayName||"Context")+".Provider";case no:var o=e.render;return e=e.displayName,e||(e=o.displayName||o.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case io:return o=e.displayName||null,o!==null?o:re(e.type)||"Memo";case _e:o=e._payload,e=e._init;try{return re(e(o))}catch{}}return null}function le(e){var o=e.type;switch(e.tag){case 24:return"Cache";case 9:return(o.displayName||"Context")+".Consumer";case 10:return(o._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return e=o.render,e=e.displayName||e.name||"",o.displayName||(e!==""?"ForwardRef("+e+")":"ForwardRef");case 7:return"Fragment";case 5:return o;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return re(o);case 8:return o===Oe?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof o=="function")return o.displayName||o.name||null;if(typeof o=="string")return o}return null}function ie(e){switch(typeof e){case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function H(e){var o=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(o==="checkbox"||o==="radio")}function oe(e){var o=H(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,o),t=""+e[o];if(!e.hasOwnProperty(o)&&typeof a<"u"&&typeof a.get=="function"&&typeof a.set=="function"){var r=a.get,n=a.set;return Object.defineProperty(e,o,{configurable:!0,get:function(){return r.call(this)},set:function(i){t=""+i,n.call(this,i)}}),Object.defineProperty(e,o,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(i){t=""+i},stopTracking:function(){e._valueTracker=null,delete e[o]}}}}function pe(e){e._valueTracker||(e._valueTracker=oe(e))}function Be(e){if(!e)return!1;var o=e._valueTracker;if(!o)return!0;var a=o.getValue(),t="";return e&&(t=H(e)?e.checked?"true":"false":e.value),e=t,e!==a?(o.setValue(e),!0):!1}function so(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}function Xe(e,o){var a=o.checked;return L({},o,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a??e._wrapperState.initialChecked})}function ns(e,o){var a=o.defaultValue==null?"":o.defaultValue,t=o.checked!=null?o.checked:o.defaultChecked;a=ie(o.value!=null?o.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:o.type==="checkbox"||o.type==="radio"?o.checked!=null:o.value!=null}}function is(e,o){o=o.checked,o!=null&&ue(e,"checked",o,!1)}function an(e,o){is(e,o);var a=ie(o.value),t=o.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}o.hasOwnProperty("value")?tn(e,o.type,a):o.hasOwnProperty("defaultValue")&&tn(e,o.type,ie(o.defaultValue)),o.checked==null&&o.defaultChecked!=null&&(e.defaultChecked=!!o.defaultChecked)}function ss(e,o,a){if(o.hasOwnProperty("value")||o.hasOwnProperty("defaultValue")){var t=o.type;if(!(t!=="submit"&&t!=="reset"||o.value!==void 0&&o.value!==null))return;o=""+e._wrapperState.initialValue,a||o===e.value||(e.value=o),e.defaultValue=o}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function tn(e,o,a){(o!=="number"||so(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}var Za=Array.isArray;function xa(e,o,a,t){if(e=e.options,o){o={};for(var r=0;r<a.length;r++)o["$"+a[r]]=!0;for(a=0;a<e.length;a++)r=o.hasOwnProperty("$"+e[a].value),e[a].selected!==r&&(e[a].selected=r),r&&t&&(e[a].defaultSelected=!0)}else{for(a=""+ie(a),o=null,r=0;r<e.length;r++){if(e[r].value===a){e[r].selected=!0,t&&(e[r].defaultSelected=!0);return}o!==null||e[r].disabled||(o=e[r])}o!==null&&(o.selected=!0)}}function rn(e,o){if(o.dangerouslySetInnerHTML!=null)throw Error(c(91));return L({},o,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function ls(e,o){var a=o.value;if(a==null){if(a=o.children,o=o.defaultValue,a!=null){if(o!=null)throw Error(c(92));if(Za(a)){if(1<a.length)throw Error(c(93));a=a[0]}o=a}o==null&&(o=""),a=o}e._wrapperState={initialValue:ie(a)}}function cs(e,o){var a=ie(o.value),t=ie(o.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),o.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function ds(e){var o=e.textContent;o===e._wrapperState.initialValue&&o!==""&&o!==null&&(e.value=o)}function us(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function nn(e,o){return e==null||e==="http://www.w3.org/1999/xhtml"?us(o):e==="http://www.w3.org/2000/svg"&&o==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Ut,ms=(function(e){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(o,a,t,r){MSApp.execUnsafeLocalFunction(function(){return e(o,a,t,r)})}:e})(function(e,o){if(e.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in e)e.innerHTML=o;else{for(Ut=Ut||document.createElement("div"),Ut.innerHTML="<svg>"+o.valueOf().toString()+"</svg>",o=Ut.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;o.firstChild;)e.appendChild(o.firstChild)}});function et(e,o){if(o){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=o;return}}e.textContent=o}var ot={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},fd=["Webkit","ms","Moz","O"];Object.keys(ot).forEach(function(e){fd.forEach(function(o){o=o+e.charAt(0).toUpperCase()+e.substring(1),ot[o]=ot[e]})});function ps(e,o,a){return o==null||typeof o=="boolean"||o===""?"":a||typeof o!="number"||o===0||ot.hasOwnProperty(e)&&ot[e]?(""+o).trim():o+"px"}function fs(e,o){e=e.style;for(var a in o)if(o.hasOwnProperty(a)){var t=a.indexOf("--")===0,r=ps(a,o[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,r):e[a]=r}}var gd=L({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function sn(e,o){if(o){if(gd[e]&&(o.children!=null||o.dangerouslySetInnerHTML!=null))throw Error(c(137,e));if(o.dangerouslySetInnerHTML!=null){if(o.children!=null)throw Error(c(60));if(typeof o.dangerouslySetInnerHTML!="object"||!("__html"in o.dangerouslySetInnerHTML))throw Error(c(61))}if(o.style!=null&&typeof o.style!="object")throw Error(c(62))}}function ln(e,o){if(e.indexOf("-")===-1)return typeof o.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var cn=null;function dn(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var un=null,Aa=null,Pa=null;function gs(e){if(e=It(e)){if(typeof un!="function")throw Error(c(280));var o=e.stateNode;o&&(o=dr(o),un(e.stateNode,e.type,o))}}function vs(e){Aa?Pa?Pa.push(e):Pa=[e]:Aa=e}function Cs(){if(Aa){var e=Aa,o=Pa;if(Pa=Aa=null,gs(e),o)for(e=0;e<o.length;e++)gs(o[e])}}function hs(e,o){return e(o)}function Ss(){}var mn=!1;function Es(e,o,a){if(mn)return e(o,a);mn=!0;try{return hs(e,o,a)}finally{mn=!1,(Aa!==null||Pa!==null)&&(Ss(),Cs())}}function at(e,o){var a=e.stateNode;if(a===null)return null;var t=dr(a);if(t===null)return null;a=t[o];e:switch(o){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(c(231,o,typeof a));return a}var pn=!1;if(P)try{var tt={};Object.defineProperty(tt,"passive",{get:function(){pn=!0}}),window.addEventListener("test",tt,tt),window.removeEventListener("test",tt,tt)}catch{pn=!1}function vd(e,o,a,t,r,n,i,s,u){var h=Array.prototype.slice.call(arguments,3);try{o.apply(a,h)}catch(x){this.onError(x)}}var rt=!1,Bt=null,Vt=!1,fn=null,Cd={onError:function(e){rt=!0,Bt=e}};function hd(e,o,a,t,r,n,i,s,u){rt=!1,Bt=null,vd.apply(Cd,arguments)}function Sd(e,o,a,t,r,n,i,s,u){if(hd.apply(this,arguments),rt){if(rt){var h=Bt;rt=!1,Bt=null}else throw Error(c(198));Vt||(Vt=!0,fn=h)}}function ua(e){var o=e,a=e;if(e.alternate)for(;o.return;)o=o.return;else{e=o;do o=e,(o.flags&4098)!==0&&(a=o.return),e=o.return;while(e)}return o.tag===3?a:null}function bs(e){if(e.tag===13){var o=e.memoizedState;if(o===null&&(e=e.alternate,e!==null&&(o=e.memoizedState)),o!==null)return o.dehydrated}return null}function ys(e){if(ua(e)!==e)throw Error(c(188))}function Ed(e){var o=e.alternate;if(!o){if(o=ua(e),o===null)throw Error(c(188));return o!==e?null:e}for(var a=e,t=o;;){var r=a.return;if(r===null)break;var n=r.alternate;if(n===null){if(t=r.return,t!==null){a=t;continue}break}if(r.child===n.child){for(n=r.child;n;){if(n===a)return ys(r),e;if(n===t)return ys(r),o;n=n.sibling}throw Error(c(188))}if(a.return!==t.return)a=r,t=n;else{for(var i=!1,s=r.child;s;){if(s===a){i=!0,a=r,t=n;break}if(s===t){i=!0,t=r,a=n;break}s=s.sibling}if(!i){for(s=n.child;s;){if(s===a){i=!0,a=n,t=r;break}if(s===t){i=!0,t=n,a=r;break}s=s.sibling}if(!i)throw Error(c(189))}}if(a.alternate!==t)throw Error(c(190))}if(a.tag!==3)throw Error(c(188));return a.stateNode.current===a?e:o}function Is(e){return e=Ed(e),e!==null?Ts(e):null}function Ts(e){if(e.tag===5||e.tag===6)return e;for(e=e.child;e!==null;){var o=Ts(e);if(o!==null)return o;e=e.sibling}return null}var xs=C.unstable_scheduleCallback,As=C.unstable_cancelCallback,bd=C.unstable_shouldYield,yd=C.unstable_requestPaint,xe=C.unstable_now,Id=C.unstable_getCurrentPriorityLevel,gn=C.unstable_ImmediatePriority,Ps=C.unstable_UserBlockingPriority,Wt=C.unstable_NormalPriority,Td=C.unstable_LowPriority,Rs=C.unstable_IdlePriority,Ht=null,Do=null;function xd(e){if(Do&&typeof Do.onCommitFiberRoot=="function")try{Do.onCommitFiberRoot(Ht,e,void 0,(e.current.flags&128)===128)}catch{}}var So=Math.clz32?Math.clz32:Rd,Ad=Math.log,Pd=Math.LN2;function Rd(e){return e>>>=0,e===0?32:31-(Ad(e)/Pd|0)|0}var Gt=64,Qt=4194304;function nt(e){switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return e&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return e}}function $t(e,o){var a=e.pendingLanes;if(a===0)return 0;var t=0,r=e.suspendedLanes,n=e.pingedLanes,i=a&268435455;if(i!==0){var s=i&~r;s!==0?t=nt(s):(n&=i,n!==0&&(t=nt(n)))}else i=a&~r,i!==0?t=nt(i):n!==0&&(t=nt(n));if(t===0)return 0;if(o!==0&&o!==t&&(o&r)===0&&(r=t&-t,n=o&-o,r>=n||r===16&&(n&4194240)!==0))return o;if((t&4)!==0&&(t|=a&16),o=e.entangledLanes,o!==0)for(e=e.entanglements,o&=t;0<o;)a=31-So(o),r=1<<a,t|=e[a],o&=~r;return t}function Dd(e,o){switch(e){case 1:case 2:case 4:return o+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return o+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function Nd(e,o){for(var a=e.suspendedLanes,t=e.pingedLanes,r=e.expirationTimes,n=e.pendingLanes;0<n;){var i=31-So(n),s=1<<i,u=r[i];u===-1?((s&a)===0||(s&t)!==0)&&(r[i]=Dd(s,o)):u<=o&&(e.expiredLanes|=s),n&=~s}}function vn(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Ds(){var e=Gt;return Gt<<=1,(Gt&4194240)===0&&(Gt=64),e}function Cn(e){for(var o=[],a=0;31>a;a++)o.push(e);return o}function it(e,o,a){e.pendingLanes|=o,o!==536870912&&(e.suspendedLanes=0,e.pingedLanes=0),e=e.eventTimes,o=31-So(o),e[o]=a}function Od(e,o){var a=e.pendingLanes&~o;e.pendingLanes=o,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=o,e.mutableReadLanes&=o,e.entangledLanes&=o,o=e.entanglements;var t=e.eventTimes;for(e=e.expirationTimes;0<a;){var r=31-So(a),n=1<<r;o[r]=0,t[r]=-1,e[r]=-1,a&=~n}}function hn(e,o){var a=e.entangledLanes|=o;for(e=e.entanglements;a;){var t=31-So(a),r=1<<t;r&o|e[t]&o&&(e[t]|=o),a&=~r}}var ce=0;function Ns(e){return e&=-e,1<e?4<e?(e&268435455)!==0?16:536870912:4:1}var Os,Sn,qs,ws,Ls,En=!1,Kt=[],Ho=null,Go=null,Qo=null,st=new Map,lt=new Map,$o=[],qd="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function ks(e,o){switch(e){case"focusin":case"focusout":Ho=null;break;case"dragenter":case"dragleave":Go=null;break;case"mouseover":case"mouseout":Qo=null;break;case"pointerover":case"pointerout":st.delete(o.pointerId);break;case"gotpointercapture":case"lostpointercapture":lt.delete(o.pointerId)}}function ct(e,o,a,t,r,n){return e===null||e.nativeEvent!==n?(e={blockedOn:o,domEventName:a,eventSystemFlags:t,nativeEvent:n,targetContainers:[r]},o!==null&&(o=It(o),o!==null&&Sn(o)),e):(e.eventSystemFlags|=t,o=e.targetContainers,r!==null&&o.indexOf(r)===-1&&o.push(r),e)}function wd(e,o,a,t,r){switch(o){case"focusin":return Ho=ct(Ho,e,o,a,t,r),!0;case"dragenter":return Go=ct(Go,e,o,a,t,r),!0;case"mouseover":return Qo=ct(Qo,e,o,a,t,r),!0;case"pointerover":var n=r.pointerId;return st.set(n,ct(st.get(n)||null,e,o,a,t,r)),!0;case"gotpointercapture":return n=r.pointerId,lt.set(n,ct(lt.get(n)||null,e,o,a,t,r)),!0}return!1}function Fs(e){var o=ma(e.target);if(o!==null){var a=ua(o);if(a!==null){if(o=a.tag,o===13){if(o=bs(a),o!==null){e.blockedOn=o,Ls(e.priority,function(){qs(a)});return}}else if(o===3&&a.stateNode.current.memoizedState.isDehydrated){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Yt(e){if(e.blockedOn!==null)return!1;for(var o=e.targetContainers;0<o.length;){var a=yn(e.domEventName,e.eventSystemFlags,o[0],e.nativeEvent);if(a===null){a=e.nativeEvent;var t=new a.constructor(a.type,a);cn=t,a.target.dispatchEvent(t),cn=null}else return o=It(a),o!==null&&Sn(o),e.blockedOn=a,!1;o.shift()}return!0}function Ms(e,o,a){Yt(e)&&a.delete(o)}function Ld(){En=!1,Ho!==null&&Yt(Ho)&&(Ho=null),Go!==null&&Yt(Go)&&(Go=null),Qo!==null&&Yt(Qo)&&(Qo=null),st.forEach(Ms),lt.forEach(Ms)}function dt(e,o){e.blockedOn===o&&(e.blockedOn=null,En||(En=!0,C.unstable_scheduleCallback(C.unstable_NormalPriority,Ld)))}function ut(e){function o(r){return dt(r,e)}if(0<Kt.length){dt(Kt[0],e);for(var a=1;a<Kt.length;a++){var t=Kt[a];t.blockedOn===e&&(t.blockedOn=null)}}for(Ho!==null&&dt(Ho,e),Go!==null&&dt(Go,e),Qo!==null&&dt(Qo,e),st.forEach(o),lt.forEach(o),a=0;a<$o.length;a++)t=$o[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<$o.length&&(a=$o[0],a.blockedOn===null);)Fs(a),a.blockedOn===null&&$o.shift()}var Ra=be.ReactCurrentBatchConfig,Xt=!0;function kd(e,o,a,t){var r=ce,n=Ra.transition;Ra.transition=null;try{ce=1,bn(e,o,a,t)}finally{ce=r,Ra.transition=n}}function Fd(e,o,a,t){var r=ce,n=Ra.transition;Ra.transition=null;try{ce=4,bn(e,o,a,t)}finally{ce=r,Ra.transition=n}}function bn(e,o,a,t){if(Xt){var r=yn(e,o,a,t);if(r===null)zn(e,o,t,Jt,a),ks(e,t);else if(wd(r,e,o,a,t))t.stopPropagation();else if(ks(e,t),o&4&&-1<qd.indexOf(e)){for(;r!==null;){var n=It(r);if(n!==null&&Os(n),n=yn(e,o,a,t),n===null&&zn(e,o,t,Jt,a),n===r)break;r=n}r!==null&&t.stopPropagation()}else zn(e,o,t,null,a)}}var Jt=null;function yn(e,o,a,t){if(Jt=null,e=dn(t),e=ma(e),e!==null)if(o=ua(e),o===null)e=null;else if(a=o.tag,a===13){if(e=bs(o),e!==null)return e;e=null}else if(a===3){if(o.stateNode.current.memoizedState.isDehydrated)return o.tag===3?o.stateNode.containerInfo:null;e=null}else o!==e&&(e=null);return Jt=e,null}function _s(e){switch(e){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(Id()){case gn:return 1;case Ps:return 4;case Wt:case Td:return 16;case Rs:return 536870912;default:return 16}default:return 16}}var Ko=null,In=null,Zt=null;function zs(){if(Zt)return Zt;var e,o=In,a=o.length,t,r="value"in Ko?Ko.value:Ko.textContent,n=r.length;for(e=0;e<a&&o[e]===r[e];e++);var i=a-e;for(t=1;t<=i&&o[a-t]===r[n-t];t++);return Zt=r.slice(e,1<t?1-t:void 0)}function er(e){var o=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&o===13&&(e=13)):e=o,e===10&&(e=13),32<=e||e===13?e:0}function or(){return!0}function js(){return!1}function lo(e){function o(a,t,r,n,i){this._reactName=a,this._targetInst=r,this.type=t,this.nativeEvent=n,this.target=i,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(n):n[s]);return this.isDefaultPrevented=(n.defaultPrevented!=null?n.defaultPrevented:n.returnValue===!1)?or:js,this.isPropagationStopped=js,this}return L(o.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=or)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=or)},persist:function(){},isPersistent:or}),o}var Da={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Tn=lo(Da),mt=L({},Da,{view:0,detail:0}),Md=lo(mt),xn,An,pt,ar=L({},mt,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Rn,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==pt&&(pt&&e.type==="mousemove"?(xn=e.screenX-pt.screenX,An=e.screenY-pt.screenY):An=xn=0,pt=e),xn)},movementY:function(e){return"movementY"in e?e.movementY:An}}),Us=lo(ar),_d=L({},ar,{dataTransfer:0}),zd=lo(_d),jd=L({},mt,{relatedTarget:0}),Pn=lo(jd),Ud=L({},Da,{animationName:0,elapsedTime:0,pseudoElement:0}),Bd=lo(Ud),Vd=L({},Da,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Wd=lo(Vd),Hd=L({},Da,{data:0}),Bs=lo(Hd),Gd={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Qd={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},$d={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Kd(e){var o=this.nativeEvent;return o.getModifierState?o.getModifierState(e):(e=$d[e])?!!o[e]:!1}function Rn(){return Kd}var Yd=L({},mt,{key:function(e){if(e.key){var o=Gd[e.key]||e.key;if(o!=="Unidentified")return o}return e.type==="keypress"?(e=er(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?Qd[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Rn,charCode:function(e){return e.type==="keypress"?er(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?er(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),Xd=lo(Yd),Jd=L({},ar,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Vs=lo(Jd),Zd=L({},mt,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Rn}),eu=lo(Zd),ou=L({},Da,{propertyName:0,elapsedTime:0,pseudoElement:0}),au=lo(ou),tu=L({},ar,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),ru=lo(tu),nu=[9,13,27,32],Dn=P&&"CompositionEvent"in window,ft=null;P&&"documentMode"in document&&(ft=document.documentMode);var iu=P&&"TextEvent"in window&&!ft,Ws=P&&(!Dn||ft&&8<ft&&11>=ft),Hs=" ",Gs=!1;function Qs(e,o){switch(e){case"keyup":return nu.indexOf(o.keyCode)!==-1;case"keydown":return o.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function $s(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Na=!1;function su(e,o){switch(e){case"compositionend":return $s(o);case"keypress":return o.which!==32?null:(Gs=!0,Hs);case"textInput":return e=o.data,e===Hs&&Gs?null:e;default:return null}}function lu(e,o){if(Na)return e==="compositionend"||!Dn&&Qs(e,o)?(e=zs(),Zt=In=Ko=null,Na=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(o.ctrlKey||o.altKey||o.metaKey)||o.ctrlKey&&o.altKey){if(o.char&&1<o.char.length)return o.char;if(o.which)return String.fromCharCode(o.which)}return null;case"compositionend":return Ws&&o.locale!=="ko"?null:o.data;default:return null}}var cu={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Ks(e){var o=e&&e.nodeName&&e.nodeName.toLowerCase();return o==="input"?!!cu[e.type]:o==="textarea"}function Ys(e,o,a,t){vs(t),o=sr(o,"onChange"),0<o.length&&(a=new Tn("onChange","change",null,a,t),e.push({event:a,listeners:o}))}var gt=null,vt=null;function du(e){fl(e,0)}function tr(e){var o=ka(e);if(Be(o))return e}function uu(e,o){if(e==="change")return o}var Xs=!1;if(P){var Nn;if(P){var On="oninput"in document;if(!On){var Js=document.createElement("div");Js.setAttribute("oninput","return;"),On=typeof Js.oninput=="function"}Nn=On}else Nn=!1;Xs=Nn&&(!document.documentMode||9<document.documentMode)}function Zs(){gt&&(gt.detachEvent("onpropertychange",el),vt=gt=null)}function el(e){if(e.propertyName==="value"&&tr(vt)){var o=[];Ys(o,vt,e,dn(e)),Es(du,o)}}function mu(e,o,a){e==="focusin"?(Zs(),gt=o,vt=a,gt.attachEvent("onpropertychange",el)):e==="focusout"&&Zs()}function pu(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return tr(vt)}function fu(e,o){if(e==="click")return tr(o)}function gu(e,o){if(e==="input"||e==="change")return tr(o)}function vu(e,o){return e===o&&(e!==0||1/e===1/o)||e!==e&&o!==o}var Eo=typeof Object.is=="function"?Object.is:vu;function Ct(e,o){if(Eo(e,o))return!0;if(typeof e!="object"||e===null||typeof o!="object"||o===null)return!1;var a=Object.keys(e),t=Object.keys(o);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++){var r=a[t];if(!y.call(o,r)||!Eo(e[r],o[r]))return!1}return!0}function ol(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function al(e,o){var a=ol(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=o&&t>=o)return{node:a,offset:o-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=ol(a)}}function tl(e,o){return e&&o?e===o?!0:e&&e.nodeType===3?!1:o&&o.nodeType===3?tl(e,o.parentNode):"contains"in e?e.contains(o):e.compareDocumentPosition?!!(e.compareDocumentPosition(o)&16):!1:!1}function rl(){for(var e=window,o=so();o instanceof e.HTMLIFrameElement;){try{var a=typeof o.contentWindow.location.href=="string"}catch{a=!1}if(a)e=o.contentWindow;else break;o=so(e.document)}return o}function qn(e){var o=e&&e.nodeName&&e.nodeName.toLowerCase();return o&&(o==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||o==="textarea"||e.contentEditable==="true")}function Cu(e){var o=rl(),a=e.focusedElem,t=e.selectionRange;if(o!==a&&a&&a.ownerDocument&&tl(a.ownerDocument.documentElement,a)){if(t!==null&&qn(a)){if(o=t.start,e=t.end,e===void 0&&(e=o),"selectionStart"in a)a.selectionStart=o,a.selectionEnd=Math.min(e,a.value.length);else if(e=(o=a.ownerDocument||document)&&o.defaultView||window,e.getSelection){e=e.getSelection();var r=a.textContent.length,n=Math.min(t.start,r);t=t.end===void 0?n:Math.min(t.end,r),!e.extend&&n>t&&(r=t,t=n,n=r),r=al(a,n);var i=al(a,t);r&&i&&(e.rangeCount!==1||e.anchorNode!==r.node||e.anchorOffset!==r.offset||e.focusNode!==i.node||e.focusOffset!==i.offset)&&(o=o.createRange(),o.setStart(r.node,r.offset),e.removeAllRanges(),n>t?(e.addRange(o),e.extend(i.node,i.offset)):(o.setEnd(i.node,i.offset),e.addRange(o)))}}for(o=[],e=a;e=e.parentNode;)e.nodeType===1&&o.push({element:e,left:e.scrollLeft,top:e.scrollTop});for(typeof a.focus=="function"&&a.focus(),a=0;a<o.length;a++)e=o[a],e.element.scrollLeft=e.left,e.element.scrollTop=e.top}}var hu=P&&"documentMode"in document&&11>=document.documentMode,Oa=null,wn=null,ht=null,Ln=!1;function nl(e,o,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Ln||Oa==null||Oa!==so(t)||(t=Oa,"selectionStart"in t&&qn(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),ht&&Ct(ht,t)||(ht=t,t=sr(wn,"onSelect"),0<t.length&&(o=new Tn("onSelect","select",null,o,a),e.push({event:o,listeners:t}),o.target=Oa)))}function rr(e,o){var a={};return a[e.toLowerCase()]=o.toLowerCase(),a["Webkit"+e]="webkit"+o,a["Moz"+e]="moz"+o,a}var qa={animationend:rr("Animation","AnimationEnd"),animationiteration:rr("Animation","AnimationIteration"),animationstart:rr("Animation","AnimationStart"),transitionend:rr("Transition","TransitionEnd")},kn={},il={};P&&(il=document.createElement("div").style,"AnimationEvent"in window||(delete qa.animationend.animation,delete qa.animationiteration.animation,delete qa.animationstart.animation),"TransitionEvent"in window||delete qa.transitionend.transition);function nr(e){if(kn[e])return kn[e];if(!qa[e])return e;var o=qa[e],a;for(a in o)if(o.hasOwnProperty(a)&&a in il)return kn[e]=o[a];return e}var sl=nr("animationend"),ll=nr("animationiteration"),cl=nr("animationstart"),dl=nr("transitionend"),ul=new Map,ml="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function Yo(e,o){ul.set(e,o),S(o,[e])}for(var Fn=0;Fn<ml.length;Fn++){var Mn=ml[Fn],Su=Mn.toLowerCase(),Eu=Mn[0].toUpperCase()+Mn.slice(1);Yo(Su,"on"+Eu)}Yo(sl,"onAnimationEnd"),Yo(ll,"onAnimationIteration"),Yo(cl,"onAnimationStart"),Yo("dblclick","onDoubleClick"),Yo("focusin","onFocus"),Yo("focusout","onBlur"),Yo(dl,"onTransitionEnd"),R("onMouseEnter",["mouseout","mouseover"]),R("onMouseLeave",["mouseout","mouseover"]),R("onPointerEnter",["pointerout","pointerover"]),R("onPointerLeave",["pointerout","pointerover"]),S("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),S("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),S("onBeforeInput",["compositionend","keypress","textInput","paste"]),S("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),S("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),S("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var St="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),bu=new Set("cancel close invalid load scroll toggle".split(" ").concat(St));function pl(e,o,a){var t=e.type||"unknown-event";e.currentTarget=a,Sd(t,o,void 0,e),e.currentTarget=null}function fl(e,o){o=(o&4)!==0;for(var a=0;a<e.length;a++){var t=e[a],r=t.event;t=t.listeners;e:{var n=void 0;if(o)for(var i=t.length-1;0<=i;i--){var s=t[i],u=s.instance,h=s.currentTarget;if(s=s.listener,u!==n&&r.isPropagationStopped())break e;pl(r,s,h),n=u}else for(i=0;i<t.length;i++){if(s=t[i],u=s.instance,h=s.currentTarget,s=s.listener,u!==n&&r.isPropagationStopped())break e;pl(r,s,h),n=u}}}if(Vt)throw e=fn,Vt=!1,fn=null,e}function Ce(e,o){var a=o[Hn];a===void 0&&(a=o[Hn]=new Set);var t=e+"__bubble";a.has(t)||(gl(o,e,2,!1),a.add(t))}function _n(e,o,a){var t=0;o&&(t|=4),gl(a,e,t,o)}var ir="_reactListening"+Math.random().toString(36).slice(2);function Et(e){if(!e[ir]){e[ir]=!0,b.forEach(function(a){a!=="selectionchange"&&(bu.has(a)||_n(a,!1,e),_n(a,!0,e))});var o=e.nodeType===9?e:e.ownerDocument;o===null||o[ir]||(o[ir]=!0,_n("selectionchange",!1,o))}}function gl(e,o,a,t){switch(_s(o)){case 1:var r=kd;break;case 4:r=Fd;break;default:r=bn}a=r.bind(null,o,a,e),r=void 0,!pn||o!=="touchstart"&&o!=="touchmove"&&o!=="wheel"||(r=!0),t?r!==void 0?e.addEventListener(o,a,{capture:!0,passive:r}):e.addEventListener(o,a,!0):r!==void 0?e.addEventListener(o,a,{passive:r}):e.addEventListener(o,a,!1)}function zn(e,o,a,t,r){var n=t;if((o&1)===0&&(o&2)===0&&t!==null)e:for(;;){if(t===null)return;var i=t.tag;if(i===3||i===4){var s=t.stateNode.containerInfo;if(s===r||s.nodeType===8&&s.parentNode===r)break;if(i===4)for(i=t.return;i!==null;){var u=i.tag;if((u===3||u===4)&&(u=i.stateNode.containerInfo,u===r||u.nodeType===8&&u.parentNode===r))return;i=i.return}for(;s!==null;){if(i=ma(s),i===null)return;if(u=i.tag,u===5||u===6){t=n=i;continue e}s=s.parentNode}}t=t.return}Es(function(){var h=n,x=dn(a),A=[];e:{var T=ul.get(e);if(T!==void 0){var w=Tn,_=e;switch(e){case"keypress":if(er(a)===0)break e;case"keydown":case"keyup":w=Xd;break;case"focusin":_="focus",w=Pn;break;case"focusout":_="blur",w=Pn;break;case"beforeblur":case"afterblur":w=Pn;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":w=Us;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":w=zd;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":w=eu;break;case sl:case ll:case cl:w=Bd;break;case dl:w=au;break;case"scroll":w=Md;break;case"wheel":w=ru;break;case"copy":case"cut":case"paste":w=Wd;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":w=Vs}var j=(o&4)!==0,Ae=!j&&e==="scroll",g=j?T!==null?T+"Capture":null:T;j=[];for(var p=h,v;p!==null;){v=p;var D=v.stateNode;if(v.tag===5&&D!==null&&(v=D,g!==null&&(D=at(p,g),D!=null&&j.push(bt(p,D,v)))),Ae)break;p=p.return}0<j.length&&(T=new w(T,_,null,a,x),A.push({event:T,listeners:j}))}}if((o&7)===0){e:{if(T=e==="mouseover"||e==="pointerover",w=e==="mouseout"||e==="pointerout",T&&a!==cn&&(_=a.relatedTarget||a.fromElement)&&(ma(_)||_[ko]))break e;if((w||T)&&(T=x.window===x?x:(T=x.ownerDocument)?T.defaultView||T.parentWindow:window,w?(_=a.relatedTarget||a.toElement,w=h,_=_?ma(_):null,_!==null&&(Ae=ua(_),_!==Ae||_.tag!==5&&_.tag!==6)&&(_=null)):(w=null,_=h),w!==_)){if(j=Us,D="onMouseLeave",g="onMouseEnter",p="mouse",(e==="pointerout"||e==="pointerover")&&(j=Vs,D="onPointerLeave",g="onPointerEnter",p="pointer"),Ae=w==null?T:ka(w),v=_==null?T:ka(_),T=new j(D,p+"leave",w,a,x),T.target=Ae,T.relatedTarget=v,D=null,ma(x)===h&&(j=new j(g,p+"enter",_,a,x),j.target=v,j.relatedTarget=Ae,D=j),Ae=D,w&&_)o:{for(j=w,g=_,p=0,v=j;v;v=wa(v))p++;for(v=0,D=g;D;D=wa(D))v++;for(;0<p-v;)j=wa(j),p--;for(;0<v-p;)g=wa(g),v--;for(;p--;){if(j===g||g!==null&&j===g.alternate)break o;j=wa(j),g=wa(g)}j=null}else j=null;w!==null&&vl(A,T,w,j,!1),_!==null&&Ae!==null&&vl(A,Ae,_,j,!0)}}e:{if(T=h?ka(h):window,w=T.nodeName&&T.nodeName.toLowerCase(),w==="select"||w==="input"&&T.type==="file")var B=uu;else if(Ks(T))if(Xs)B=gu;else{B=pu;var Q=mu}else(w=T.nodeName)&&w.toLowerCase()==="input"&&(T.type==="checkbox"||T.type==="radio")&&(B=fu);if(B&&(B=B(e,h))){Ys(A,B,a,x);break e}Q&&Q(e,T,h),e==="focusout"&&(Q=T._wrapperState)&&Q.controlled&&T.type==="number"&&tn(T,"number",T.value)}switch(Q=h?ka(h):window,e){case"focusin":(Ks(Q)||Q.contentEditable==="true")&&(Oa=Q,wn=h,ht=null);break;case"focusout":ht=wn=Oa=null;break;case"mousedown":Ln=!0;break;case"contextmenu":case"mouseup":case"dragend":Ln=!1,nl(A,a,x);break;case"selectionchange":if(hu)break;case"keydown":case"keyup":nl(A,a,x)}var $;if(Dn)e:{switch(e){case"compositionstart":var Y="onCompositionStart";break e;case"compositionend":Y="onCompositionEnd";break e;case"compositionupdate":Y="onCompositionUpdate";break e}Y=void 0}else Na?Qs(e,a)&&(Y="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(Y="onCompositionStart");Y&&(Ws&&a.locale!=="ko"&&(Na||Y!=="onCompositionStart"?Y==="onCompositionEnd"&&Na&&($=zs()):(Ko=x,In="value"in Ko?Ko.value:Ko.textContent,Na=!0)),Q=sr(h,Y),0<Q.length&&(Y=new Bs(Y,e,null,a,x),A.push({event:Y,listeners:Q}),$?Y.data=$:($=$s(a),$!==null&&(Y.data=$)))),($=iu?su(e,a):lu(e,a))&&(h=sr(h,"onBeforeInput"),0<h.length&&(x=new Bs("onBeforeInput","beforeinput",null,a,x),A.push({event:x,listeners:h}),x.data=$))}fl(A,o)})}function bt(e,o,a){return{instance:e,listener:o,currentTarget:a}}function sr(e,o){for(var a=o+"Capture",t=[];e!==null;){var r=e,n=r.stateNode;r.tag===5&&n!==null&&(r=n,n=at(e,a),n!=null&&t.unshift(bt(e,n,r)),n=at(e,o),n!=null&&t.push(bt(e,n,r))),e=e.return}return t}function wa(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function vl(e,o,a,t,r){for(var n=o._reactName,i=[];a!==null&&a!==t;){var s=a,u=s.alternate,h=s.stateNode;if(u!==null&&u===t)break;s.tag===5&&h!==null&&(s=h,r?(u=at(a,n),u!=null&&i.unshift(bt(a,u,s))):r||(u=at(a,n),u!=null&&i.push(bt(a,u,s)))),a=a.return}i.length!==0&&e.push({event:o,listeners:i})}var yu=/\r\n?/g,Iu=/\u0000|\uFFFD/g;function Cl(e){return(typeof e=="string"?e:""+e).replace(yu,`
`).replace(Iu,"")}function lr(e,o,a){if(o=Cl(o),Cl(e)!==o&&a)throw Error(c(425))}function cr(){}var jn=null,Un=null;function Bn(e,o){return e==="textarea"||e==="noscript"||typeof o.children=="string"||typeof o.children=="number"||typeof o.dangerouslySetInnerHTML=="object"&&o.dangerouslySetInnerHTML!==null&&o.dangerouslySetInnerHTML.__html!=null}var Vn=typeof setTimeout=="function"?setTimeout:void 0,Tu=typeof clearTimeout=="function"?clearTimeout:void 0,hl=typeof Promise=="function"?Promise:void 0,xu=typeof queueMicrotask=="function"?queueMicrotask:typeof hl<"u"?function(e){return hl.resolve(null).then(e).catch(Au)}:Vn;function Au(e){setTimeout(function(){throw e})}function Wn(e,o){var a=o,t=0;do{var r=a.nextSibling;if(e.removeChild(a),r&&r.nodeType===8)if(a=r.data,a==="/$"){if(t===0){e.removeChild(r),ut(o);return}t--}else a!=="$"&&a!=="$?"&&a!=="$!"||t++;a=r}while(a);ut(o)}function Xo(e){for(;e!=null;e=e.nextSibling){var o=e.nodeType;if(o===1||o===3)break;if(o===8){if(o=e.data,o==="$"||o==="$!"||o==="$?")break;if(o==="/$")return null}}return e}function Sl(e){e=e.previousSibling;for(var o=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(o===0)return e;o--}else a==="/$"&&o++}e=e.previousSibling}return null}var La=Math.random().toString(36).slice(2),No="__reactFiber$"+La,yt="__reactProps$"+La,ko="__reactContainer$"+La,Hn="__reactEvents$"+La,Pu="__reactListeners$"+La,Ru="__reactHandles$"+La;function ma(e){var o=e[No];if(o)return o;for(var a=e.parentNode;a;){if(o=a[ko]||a[No]){if(a=o.alternate,o.child!==null||a!==null&&a.child!==null)for(e=Sl(e);e!==null;){if(a=e[No])return a;e=Sl(e)}return o}e=a,a=e.parentNode}return null}function It(e){return e=e[No]||e[ko],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function ka(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(c(33))}function dr(e){return e[yt]||null}var Gn=[],Fa=-1;function Jo(e){return{current:e}}function he(e){0>Fa||(e.current=Gn[Fa],Gn[Fa]=null,Fa--)}function fe(e,o){Fa++,Gn[Fa]=e.current,e.current=o}var Zo={},Ve=Jo(Zo),Je=Jo(!1),pa=Zo;function Ma(e,o){var a=e.type.contextTypes;if(!a)return Zo;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===o)return t.__reactInternalMemoizedMaskedChildContext;var r={},n;for(n in a)r[n]=o[n];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=o,e.__reactInternalMemoizedMaskedChildContext=r),r}function Ze(e){return e=e.childContextTypes,e!=null}function ur(){he(Je),he(Ve)}function El(e,o,a){if(Ve.current!==Zo)throw Error(c(168));fe(Ve,o),fe(Je,a)}function bl(e,o,a){var t=e.stateNode;if(o=o.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var r in t)if(!(r in o))throw Error(c(108,le(e)||"Unknown",r));return L({},a,t)}function mr(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||Zo,pa=Ve.current,fe(Ve,e),fe(Je,Je.current),!0}function yl(e,o,a){var t=e.stateNode;if(!t)throw Error(c(169));a?(e=bl(e,o,pa),t.__reactInternalMemoizedMergedChildContext=e,he(Je),he(Ve),fe(Ve,e)):he(Je),fe(Je,a)}var Fo=null,pr=!1,Qn=!1;function Il(e){Fo===null?Fo=[e]:Fo.push(e)}function Du(e){pr=!0,Il(e)}function ea(){if(!Qn&&Fo!==null){Qn=!0;var e=0,o=ce;try{var a=Fo;for(ce=1;e<a.length;e++){var t=a[e];do t=t(!0);while(t!==null)}Fo=null,pr=!1}catch(r){throw Fo!==null&&(Fo=Fo.slice(e+1)),xs(gn,ea),r}finally{ce=o,Qn=!1}}return null}var _a=[],za=0,fr=null,gr=0,po=[],fo=0,fa=null,Mo=1,_o="";function ga(e,o){_a[za++]=gr,_a[za++]=fr,fr=e,gr=o}function Tl(e,o,a){po[fo++]=Mo,po[fo++]=_o,po[fo++]=fa,fa=e;var t=Mo;e=_o;var r=32-So(t)-1;t&=~(1<<r),a+=1;var n=32-So(o)+r;if(30<n){var i=r-r%5;n=(t&(1<<i)-1).toString(32),t>>=i,r-=i,Mo=1<<32-So(o)+r|a<<r|t,_o=n+e}else Mo=1<<n|a<<r|t,_o=e}function $n(e){e.return!==null&&(ga(e,1),Tl(e,1,0))}function Kn(e){for(;e===fr;)fr=_a[--za],_a[za]=null,gr=_a[--za],_a[za]=null;for(;e===fa;)fa=po[--fo],po[fo]=null,_o=po[--fo],po[fo]=null,Mo=po[--fo],po[fo]=null}var co=null,uo=null,Ee=!1,bo=null;function xl(e,o){var a=ho(5,null,null,0);a.elementType="DELETED",a.stateNode=o,a.return=e,o=e.deletions,o===null?(e.deletions=[a],e.flags|=16):o.push(a)}function Al(e,o){switch(e.tag){case 5:var a=e.type;return o=o.nodeType!==1||a.toLowerCase()!==o.nodeName.toLowerCase()?null:o,o!==null?(e.stateNode=o,co=e,uo=Xo(o.firstChild),!0):!1;case 6:return o=e.pendingProps===""||o.nodeType!==3?null:o,o!==null?(e.stateNode=o,co=e,uo=null,!0):!1;case 13:return o=o.nodeType!==8?null:o,o!==null?(a=fa!==null?{id:Mo,overflow:_o}:null,e.memoizedState={dehydrated:o,treeContext:a,retryLane:1073741824},a=ho(18,null,null,0),a.stateNode=o,a.return=e,e.child=a,co=e,uo=null,!0):!1;default:return!1}}function Yn(e){return(e.mode&1)!==0&&(e.flags&128)===0}function Xn(e){if(Ee){var o=uo;if(o){var a=o;if(!Al(e,o)){if(Yn(e))throw Error(c(418));o=Xo(a.nextSibling);var t=co;o&&Al(e,o)?xl(t,a):(e.flags=e.flags&-4097|2,Ee=!1,co=e)}}else{if(Yn(e))throw Error(c(418));e.flags=e.flags&-4097|2,Ee=!1,co=e}}}function Pl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;co=e}function vr(e){if(e!==co)return!1;if(!Ee)return Pl(e),Ee=!0,!1;var o;if((o=e.tag!==3)&&!(o=e.tag!==5)&&(o=e.type,o=o!=="head"&&o!=="body"&&!Bn(e.type,e.memoizedProps)),o&&(o=uo)){if(Yn(e))throw Rl(),Error(c(418));for(;o;)xl(e,o),o=Xo(o.nextSibling)}if(Pl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(c(317));e:{for(e=e.nextSibling,o=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(o===0){uo=Xo(e.nextSibling);break e}o--}else a!=="$"&&a!=="$!"&&a!=="$?"||o++}e=e.nextSibling}uo=null}}else uo=co?Xo(e.stateNode.nextSibling):null;return!0}function Rl(){for(var e=uo;e;)e=Xo(e.nextSibling)}function ja(){uo=co=null,Ee=!1}function Jn(e){bo===null?bo=[e]:bo.push(e)}var Nu=be.ReactCurrentBatchConfig;function Tt(e,o,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(c(309));var t=a.stateNode}if(!t)throw Error(c(147,e));var r=t,n=""+e;return o!==null&&o.ref!==null&&typeof o.ref=="function"&&o.ref._stringRef===n?o.ref:(o=function(i){var s=r.refs;i===null?delete s[n]:s[n]=i},o._stringRef=n,o)}if(typeof e!="string")throw Error(c(284));if(!a._owner)throw Error(c(290,e))}return e}function Cr(e,o){throw e=Object.prototype.toString.call(o),Error(c(31,e==="[object Object]"?"object with keys {"+Object.keys(o).join(", ")+"}":e))}function Dl(e){var o=e._init;return o(e._payload)}function Nl(e){function o(g,p){if(e){var v=g.deletions;v===null?(g.deletions=[p],g.flags|=16):v.push(p)}}function a(g,p){if(!e)return null;for(;p!==null;)o(g,p),p=p.sibling;return null}function t(g,p){for(g=new Map;p!==null;)p.key!==null?g.set(p.key,p):g.set(p.index,p),p=p.sibling;return g}function r(g,p){return g=la(g,p),g.index=0,g.sibling=null,g}function n(g,p,v){return g.index=v,e?(v=g.alternate,v!==null?(v=v.index,v<p?(g.flags|=2,p):v):(g.flags|=2,p)):(g.flags|=1048576,p)}function i(g){return e&&g.alternate===null&&(g.flags|=2),g}function s(g,p,v,D){return p===null||p.tag!==6?(p=Vi(v,g.mode,D),p.return=g,p):(p=r(p,v),p.return=g,p)}function u(g,p,v,D){var B=v.type;return B===me?x(g,p,v.props.children,D,v.key):p!==null&&(p.elementType===B||typeof B=="object"&&B!==null&&B.$$typeof===_e&&Dl(B)===p.type)?(D=r(p,v.props),D.ref=Tt(g,p,v),D.return=g,D):(D=Ur(v.type,v.key,v.props,null,g.mode,D),D.ref=Tt(g,p,v),D.return=g,D)}function h(g,p,v,D){return p===null||p.tag!==4||p.stateNode.containerInfo!==v.containerInfo||p.stateNode.implementation!==v.implementation?(p=Wi(v,g.mode,D),p.return=g,p):(p=r(p,v.children||[]),p.return=g,p)}function x(g,p,v,D,B){return p===null||p.tag!==7?(p=Ia(v,g.mode,D,B),p.return=g,p):(p=r(p,v),p.return=g,p)}function A(g,p,v){if(typeof p=="string"&&p!==""||typeof p=="number")return p=Vi(""+p,g.mode,v),p.return=g,p;if(typeof p=="object"&&p!==null){switch(p.$$typeof){case Me:return v=Ur(p.type,p.key,p.props,null,g.mode,v),v.ref=Tt(g,null,p),v.return=g,v;case Re:return p=Wi(p,g.mode,v),p.return=g,p;case _e:var D=p._init;return A(g,D(p._payload),v)}if(Za(p)||W(p))return p=Ia(p,g.mode,v,null),p.return=g,p;Cr(g,p)}return null}function T(g,p,v,D){var B=p!==null?p.key:null;if(typeof v=="string"&&v!==""||typeof v=="number")return B!==null?null:s(g,p,""+v,D);if(typeof v=="object"&&v!==null){switch(v.$$typeof){case Me:return v.key===B?u(g,p,v,D):null;case Re:return v.key===B?h(g,p,v,D):null;case _e:return B=v._init,T(g,p,B(v._payload),D)}if(Za(v)||W(v))return B!==null?null:x(g,p,v,D,null);Cr(g,v)}return null}function w(g,p,v,D,B){if(typeof D=="string"&&D!==""||typeof D=="number")return g=g.get(v)||null,s(p,g,""+D,B);if(typeof D=="object"&&D!==null){switch(D.$$typeof){case Me:return g=g.get(D.key===null?v:D.key)||null,u(p,g,D,B);case Re:return g=g.get(D.key===null?v:D.key)||null,h(p,g,D,B);case _e:var Q=D._init;return w(g,p,v,Q(D._payload),B)}if(Za(D)||W(D))return g=g.get(v)||null,x(p,g,D,B,null);Cr(p,D)}return null}function _(g,p,v,D){for(var B=null,Q=null,$=p,Y=p=0,Le=null;$!==null&&Y<v.length;Y++){$.index>Y?(Le=$,$=null):Le=$.sibling;var se=T(g,$,v[Y],D);if(se===null){$===null&&($=Le);break}e&&$&&se.alternate===null&&o(g,$),p=n(se,p,Y),Q===null?B=se:Q.sibling=se,Q=se,$=Le}if(Y===v.length)return a(g,$),Ee&&ga(g,Y),B;if($===null){for(;Y<v.length;Y++)$=A(g,v[Y],D),$!==null&&(p=n($,p,Y),Q===null?B=$:Q.sibling=$,Q=$);return Ee&&ga(g,Y),B}for($=t(g,$);Y<v.length;Y++)Le=w($,g,Y,v[Y],D),Le!==null&&(e&&Le.alternate!==null&&$.delete(Le.key===null?Y:Le.key),p=n(Le,p,Y),Q===null?B=Le:Q.sibling=Le,Q=Le);return e&&$.forEach(function(ca){return o(g,ca)}),Ee&&ga(g,Y),B}function j(g,p,v,D){var B=W(v);if(typeof B!="function")throw Error(c(150));if(v=B.call(v),v==null)throw Error(c(151));for(var Q=B=null,$=p,Y=p=0,Le=null,se=v.next();$!==null&&!se.done;Y++,se=v.next()){$.index>Y?(Le=$,$=null):Le=$.sibling;var ca=T(g,$,se.value,D);if(ca===null){$===null&&($=Le);break}e&&$&&ca.alternate===null&&o(g,$),p=n(ca,p,Y),Q===null?B=ca:Q.sibling=ca,Q=ca,$=Le}if(se.done)return a(g,$),Ee&&ga(g,Y),B;if($===null){for(;!se.done;Y++,se=v.next())se=A(g,se.value,D),se!==null&&(p=n(se,p,Y),Q===null?B=se:Q.sibling=se,Q=se);return Ee&&ga(g,Y),B}for($=t(g,$);!se.done;Y++,se=v.next())se=w($,g,Y,se.value,D),se!==null&&(e&&se.alternate!==null&&$.delete(se.key===null?Y:se.key),p=n(se,p,Y),Q===null?B=se:Q.sibling=se,Q=se);return e&&$.forEach(function(cm){return o(g,cm)}),Ee&&ga(g,Y),B}function Ae(g,p,v,D){if(typeof v=="object"&&v!==null&&v.type===me&&v.key===null&&(v=v.props.children),typeof v=="object"&&v!==null){switch(v.$$typeof){case Me:e:{for(var B=v.key,Q=p;Q!==null;){if(Q.key===B){if(B=v.type,B===me){if(Q.tag===7){a(g,Q.sibling),p=r(Q,v.props.children),p.return=g,g=p;break e}}else if(Q.elementType===B||typeof B=="object"&&B!==null&&B.$$typeof===_e&&Dl(B)===Q.type){a(g,Q.sibling),p=r(Q,v.props),p.ref=Tt(g,Q,v),p.return=g,g=p;break e}a(g,Q);break}else o(g,Q);Q=Q.sibling}v.type===me?(p=Ia(v.props.children,g.mode,D,v.key),p.return=g,g=p):(D=Ur(v.type,v.key,v.props,null,g.mode,D),D.ref=Tt(g,p,v),D.return=g,g=D)}return i(g);case Re:e:{for(Q=v.key;p!==null;){if(p.key===Q)if(p.tag===4&&p.stateNode.containerInfo===v.containerInfo&&p.stateNode.implementation===v.implementation){a(g,p.sibling),p=r(p,v.children||[]),p.return=g,g=p;break e}else{a(g,p);break}else o(g,p);p=p.sibling}p=Wi(v,g.mode,D),p.return=g,g=p}return i(g);case _e:return Q=v._init,Ae(g,p,Q(v._payload),D)}if(Za(v))return _(g,p,v,D);if(W(v))return j(g,p,v,D);Cr(g,v)}return typeof v=="string"&&v!==""||typeof v=="number"?(v=""+v,p!==null&&p.tag===6?(a(g,p.sibling),p=r(p,v),p.return=g,g=p):(a(g,p),p=Vi(v,g.mode,D),p.return=g,g=p),i(g)):a(g,p)}return Ae}var Ua=Nl(!0),Ol=Nl(!1),hr=Jo(null),Sr=null,Ba=null,Zn=null;function ei(){Zn=Ba=Sr=null}function oi(e){var o=hr.current;he(hr),e._currentValue=o}function ai(e,o,a){for(;e!==null;){var t=e.alternate;if((e.childLanes&o)!==o?(e.childLanes|=o,t!==null&&(t.childLanes|=o)):t!==null&&(t.childLanes&o)!==o&&(t.childLanes|=o),e===a)break;e=e.return}}function Va(e,o){Sr=e,Zn=Ba=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&o)!==0&&(eo=!0),e.firstContext=null)}function go(e){var o=e._currentValue;if(Zn!==e)if(e={context:e,memoizedValue:o,next:null},Ba===null){if(Sr===null)throw Error(c(308));Ba=e,Sr.dependencies={lanes:0,firstContext:e}}else Ba=Ba.next=e;return o}var va=null;function ti(e){va===null?va=[e]:va.push(e)}function ql(e,o,a,t){var r=o.interleaved;return r===null?(a.next=a,ti(o)):(a.next=r.next,r.next=a),o.interleaved=a,zo(e,t)}function zo(e,o){e.lanes|=o;var a=e.alternate;for(a!==null&&(a.lanes|=o),a=e,e=e.return;e!==null;)e.childLanes|=o,a=e.alternate,a!==null&&(a.childLanes|=o),a=e,e=e.return;return a.tag===3?a.stateNode:null}var oa=!1;function ri(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function wl(e,o){e=e.updateQueue,o.updateQueue===e&&(o.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function jo(e,o){return{eventTime:e,lane:o,tag:0,payload:null,callback:null,next:null}}function aa(e,o,a){var t=e.updateQueue;if(t===null)return null;if(t=t.shared,(ne&2)!==0){var r=t.pending;return r===null?o.next=o:(o.next=r.next,r.next=o),t.pending=o,zo(e,a)}return r=t.interleaved,r===null?(o.next=o,ti(t)):(o.next=r.next,r.next=o),t.interleaved=o,zo(e,a)}function Er(e,o,a){if(o=o.updateQueue,o!==null&&(o=o.shared,(a&4194240)!==0)){var t=o.lanes;t&=e.pendingLanes,a|=t,o.lanes=a,hn(e,a)}}function Ll(e,o){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var r=null,n=null;if(a=a.firstBaseUpdate,a!==null){do{var i={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};n===null?r=n=i:n=n.next=i,a=a.next}while(a!==null);n===null?r=n=o:n=n.next=o}else r=n=o;a={baseState:t.baseState,firstBaseUpdate:r,lastBaseUpdate:n,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=o:e.next=o,a.lastBaseUpdate=o}function br(e,o,a,t){var r=e.updateQueue;oa=!1;var n=r.firstBaseUpdate,i=r.lastBaseUpdate,s=r.shared.pending;if(s!==null){r.shared.pending=null;var u=s,h=u.next;u.next=null,i===null?n=h:i.next=h,i=u;var x=e.alternate;x!==null&&(x=x.updateQueue,s=x.lastBaseUpdate,s!==i&&(s===null?x.firstBaseUpdate=h:s.next=h,x.lastBaseUpdate=u))}if(n!==null){var A=r.baseState;i=0,x=h=u=null,s=n;do{var T=s.lane,w=s.eventTime;if((t&T)===T){x!==null&&(x=x.next={eventTime:w,lane:0,tag:s.tag,payload:s.payload,callback:s.callback,next:null});e:{var _=e,j=s;switch(T=o,w=a,j.tag){case 1:if(_=j.payload,typeof _=="function"){A=_.call(w,A,T);break e}A=_;break e;case 3:_.flags=_.flags&-65537|128;case 0:if(_=j.payload,T=typeof _=="function"?_.call(w,A,T):_,T==null)break e;A=L({},A,T);break e;case 2:oa=!0}}s.callback!==null&&s.lane!==0&&(e.flags|=64,T=r.effects,T===null?r.effects=[s]:T.push(s))}else w={eventTime:w,lane:T,tag:s.tag,payload:s.payload,callback:s.callback,next:null},x===null?(h=x=w,u=A):x=x.next=w,i|=T;if(s=s.next,s===null){if(s=r.shared.pending,s===null)break;T=s,s=T.next,T.next=null,r.lastBaseUpdate=T,r.shared.pending=null}}while(!0);if(x===null&&(u=A),r.baseState=u,r.firstBaseUpdate=h,r.lastBaseUpdate=x,o=r.shared.interleaved,o!==null){r=o;do i|=r.lane,r=r.next;while(r!==o)}else n===null&&(r.shared.lanes=0);Sa|=i,e.lanes=i,e.memoizedState=A}}function kl(e,o,a){if(e=o.effects,o.effects=null,e!==null)for(o=0;o<e.length;o++){var t=e[o],r=t.callback;if(r!==null){if(t.callback=null,t=a,typeof r!="function")throw Error(c(191,r));r.call(t)}}}var xt={},Oo=Jo(xt),At=Jo(xt),Pt=Jo(xt);function Ca(e){if(e===xt)throw Error(c(174));return e}function ni(e,o){switch(fe(Pt,o),fe(At,e),fe(Oo,xt),e=o.nodeType,e){case 9:case 11:o=(o=o.documentElement)?o.namespaceURI:nn(null,"");break;default:e=e===8?o.parentNode:o,o=e.namespaceURI||null,e=e.tagName,o=nn(o,e)}he(Oo),fe(Oo,o)}function Wa(){he(Oo),he(At),he(Pt)}function Fl(e){Ca(Pt.current);var o=Ca(Oo.current),a=nn(o,e.type);o!==a&&(fe(At,e),fe(Oo,a))}function ii(e){At.current===e&&(he(Oo),he(At))}var ye=Jo(0);function yr(e){for(var o=e;o!==null;){if(o.tag===13){var a=o.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return o}else if(o.tag===19&&o.memoizedProps.revealOrder!==void 0){if((o.flags&128)!==0)return o}else if(o.child!==null){o.child.return=o,o=o.child;continue}if(o===e)break;for(;o.sibling===null;){if(o.return===null||o.return===e)return null;o=o.return}o.sibling.return=o.return,o=o.sibling}return null}var si=[];function li(){for(var e=0;e<si.length;e++)si[e]._workInProgressVersionPrimary=null;si.length=0}var Ir=be.ReactCurrentDispatcher,ci=be.ReactCurrentBatchConfig,ha=0,Ie=null,De=null,qe=null,Tr=!1,Rt=!1,Dt=0,Ou=0;function We(){throw Error(c(321))}function di(e,o){if(o===null)return!1;for(var a=0;a<o.length&&a<e.length;a++)if(!Eo(e[a],o[a]))return!1;return!0}function ui(e,o,a,t,r,n){if(ha=n,Ie=o,o.memoizedState=null,o.updateQueue=null,o.lanes=0,Ir.current=e===null||e.memoizedState===null?ku:Fu,e=a(t,r),Rt){n=0;do{if(Rt=!1,Dt=0,25<=n)throw Error(c(301));n+=1,qe=De=null,o.updateQueue=null,Ir.current=Mu,e=a(t,r)}while(Rt)}if(Ir.current=Pr,o=De!==null&&De.next!==null,ha=0,qe=De=Ie=null,Tr=!1,o)throw Error(c(300));return e}function mi(){var e=Dt!==0;return Dt=0,e}function qo(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return qe===null?Ie.memoizedState=qe=e:qe=qe.next=e,qe}function vo(){if(De===null){var e=Ie.alternate;e=e!==null?e.memoizedState:null}else e=De.next;var o=qe===null?Ie.memoizedState:qe.next;if(o!==null)qe=o,De=e;else{if(e===null)throw Error(c(310));De=e,e={memoizedState:De.memoizedState,baseState:De.baseState,baseQueue:De.baseQueue,queue:De.queue,next:null},qe===null?Ie.memoizedState=qe=e:qe=qe.next=e}return qe}function Nt(e,o){return typeof o=="function"?o(e):o}function pi(e){var o=vo(),a=o.queue;if(a===null)throw Error(c(311));a.lastRenderedReducer=e;var t=De,r=t.baseQueue,n=a.pending;if(n!==null){if(r!==null){var i=r.next;r.next=n.next,n.next=i}t.baseQueue=r=n,a.pending=null}if(r!==null){n=r.next,t=t.baseState;var s=i=null,u=null,h=n;do{var x=h.lane;if((ha&x)===x)u!==null&&(u=u.next={lane:0,action:h.action,hasEagerState:h.hasEagerState,eagerState:h.eagerState,next:null}),t=h.hasEagerState?h.eagerState:e(t,h.action);else{var A={lane:x,action:h.action,hasEagerState:h.hasEagerState,eagerState:h.eagerState,next:null};u===null?(s=u=A,i=t):u=u.next=A,Ie.lanes|=x,Sa|=x}h=h.next}while(h!==null&&h!==n);u===null?i=t:u.next=s,Eo(t,o.memoizedState)||(eo=!0),o.memoizedState=t,o.baseState=i,o.baseQueue=u,a.lastRenderedState=t}if(e=a.interleaved,e!==null){r=e;do n=r.lane,Ie.lanes|=n,Sa|=n,r=r.next;while(r!==e)}else r===null&&(a.lanes=0);return[o.memoizedState,a.dispatch]}function fi(e){var o=vo(),a=o.queue;if(a===null)throw Error(c(311));a.lastRenderedReducer=e;var t=a.dispatch,r=a.pending,n=o.memoizedState;if(r!==null){a.pending=null;var i=r=r.next;do n=e(n,i.action),i=i.next;while(i!==r);Eo(n,o.memoizedState)||(eo=!0),o.memoizedState=n,o.baseQueue===null&&(o.baseState=n),a.lastRenderedState=n}return[n,t]}function Ml(){}function _l(e,o){var a=Ie,t=vo(),r=o(),n=!Eo(t.memoizedState,r);if(n&&(t.memoizedState=r,eo=!0),t=t.queue,gi(Ul.bind(null,a,t,e),[e]),t.getSnapshot!==o||n||qe!==null&&qe.memoizedState.tag&1){if(a.flags|=2048,Ot(9,jl.bind(null,a,t,r,o),void 0,null),we===null)throw Error(c(349));(ha&30)!==0||zl(a,o,r)}return r}function zl(e,o,a){e.flags|=16384,e={getSnapshot:o,value:a},o=Ie.updateQueue,o===null?(o={lastEffect:null,stores:null},Ie.updateQueue=o,o.stores=[e]):(a=o.stores,a===null?o.stores=[e]:a.push(e))}function jl(e,o,a,t){o.value=a,o.getSnapshot=t,Bl(o)&&Vl(e)}function Ul(e,o,a){return a(function(){Bl(o)&&Vl(e)})}function Bl(e){var o=e.getSnapshot;e=e.value;try{var a=o();return!Eo(e,a)}catch{return!0}}function Vl(e){var o=zo(e,1);o!==null&&xo(o,e,1,-1)}function Wl(e){var o=qo();return typeof e=="function"&&(e=e()),o.memoizedState=o.baseState=e,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:Nt,lastRenderedState:e},o.queue=e,e=e.dispatch=Lu.bind(null,Ie,e),[o.memoizedState,e]}function Ot(e,o,a,t){return e={tag:e,create:o,destroy:a,deps:t,next:null},o=Ie.updateQueue,o===null?(o={lastEffect:null,stores:null},Ie.updateQueue=o,o.lastEffect=e.next=e):(a=o.lastEffect,a===null?o.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,o.lastEffect=e)),e}function Hl(){return vo().memoizedState}function xr(e,o,a,t){var r=qo();Ie.flags|=e,r.memoizedState=Ot(1|o,a,void 0,t===void 0?null:t)}function Ar(e,o,a,t){var r=vo();t=t===void 0?null:t;var n=void 0;if(De!==null){var i=De.memoizedState;if(n=i.destroy,t!==null&&di(t,i.deps)){r.memoizedState=Ot(o,a,n,t);return}}Ie.flags|=e,r.memoizedState=Ot(1|o,a,n,t)}function Gl(e,o){return xr(8390656,8,e,o)}function gi(e,o){return Ar(2048,8,e,o)}function Ql(e,o){return Ar(4,2,e,o)}function $l(e,o){return Ar(4,4,e,o)}function Kl(e,o){if(typeof o=="function")return e=e(),o(e),function(){o(null)};if(o!=null)return e=e(),o.current=e,function(){o.current=null}}function Yl(e,o,a){return a=a!=null?a.concat([e]):null,Ar(4,4,Kl.bind(null,o,e),a)}function vi(){}function Xl(e,o){var a=vo();o=o===void 0?null:o;var t=a.memoizedState;return t!==null&&o!==null&&di(o,t[1])?t[0]:(a.memoizedState=[e,o],e)}function Jl(e,o){var a=vo();o=o===void 0?null:o;var t=a.memoizedState;return t!==null&&o!==null&&di(o,t[1])?t[0]:(e=e(),a.memoizedState=[e,o],e)}function Zl(e,o,a){return(ha&21)===0?(e.baseState&&(e.baseState=!1,eo=!0),e.memoizedState=a):(Eo(a,o)||(a=Ds(),Ie.lanes|=a,Sa|=a,e.baseState=!0),o)}function qu(e,o){var a=ce;ce=a!==0&&4>a?a:4,e(!0);var t=ci.transition;ci.transition={};try{e(!1),o()}finally{ce=a,ci.transition=t}}function ec(){return vo().memoizedState}function wu(e,o,a){var t=ia(e);if(a={lane:t,action:a,hasEagerState:!1,eagerState:null,next:null},oc(e))ac(o,a);else if(a=ql(e,o,a,t),a!==null){var r=$e();xo(a,e,t,r),tc(a,o,t)}}function Lu(e,o,a){var t=ia(e),r={lane:t,action:a,hasEagerState:!1,eagerState:null,next:null};if(oc(e))ac(o,r);else{var n=e.alternate;if(e.lanes===0&&(n===null||n.lanes===0)&&(n=o.lastRenderedReducer,n!==null))try{var i=o.lastRenderedState,s=n(i,a);if(r.hasEagerState=!0,r.eagerState=s,Eo(s,i)){var u=o.interleaved;u===null?(r.next=r,ti(o)):(r.next=u.next,u.next=r),o.interleaved=r;return}}catch{}finally{}a=ql(e,o,r,t),a!==null&&(r=$e(),xo(a,e,t,r),tc(a,o,t))}}function oc(e){var o=e.alternate;return e===Ie||o!==null&&o===Ie}function ac(e,o){Rt=Tr=!0;var a=e.pending;a===null?o.next=o:(o.next=a.next,a.next=o),e.pending=o}function tc(e,o,a){if((a&4194240)!==0){var t=o.lanes;t&=e.pendingLanes,a|=t,o.lanes=a,hn(e,a)}}var Pr={readContext:go,useCallback:We,useContext:We,useEffect:We,useImperativeHandle:We,useInsertionEffect:We,useLayoutEffect:We,useMemo:We,useReducer:We,useRef:We,useState:We,useDebugValue:We,useDeferredValue:We,useTransition:We,useMutableSource:We,useSyncExternalStore:We,useId:We,unstable_isNewReconciler:!1},ku={readContext:go,useCallback:function(e,o){return qo().memoizedState=[e,o===void 0?null:o],e},useContext:go,useEffect:Gl,useImperativeHandle:function(e,o,a){return a=a!=null?a.concat([e]):null,xr(4194308,4,Kl.bind(null,o,e),a)},useLayoutEffect:function(e,o){return xr(4194308,4,e,o)},useInsertionEffect:function(e,o){return xr(4,2,e,o)},useMemo:function(e,o){var a=qo();return o=o===void 0?null:o,e=e(),a.memoizedState=[e,o],e},useReducer:function(e,o,a){var t=qo();return o=a!==void 0?a(o):o,t.memoizedState=t.baseState=o,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:o},t.queue=e,e=e.dispatch=wu.bind(null,Ie,e),[t.memoizedState,e]},useRef:function(e){var o=qo();return e={current:e},o.memoizedState=e},useState:Wl,useDebugValue:vi,useDeferredValue:function(e){return qo().memoizedState=e},useTransition:function(){var e=Wl(!1),o=e[0];return e=qu.bind(null,e[1]),qo().memoizedState=e,[o,e]},useMutableSource:function(){},useSyncExternalStore:function(e,o,a){var t=Ie,r=qo();if(Ee){if(a===void 0)throw Error(c(407));a=a()}else{if(a=o(),we===null)throw Error(c(349));(ha&30)!==0||zl(t,o,a)}r.memoizedState=a;var n={value:a,getSnapshot:o};return r.queue=n,Gl(Ul.bind(null,t,n,e),[e]),t.flags|=2048,Ot(9,jl.bind(null,t,n,a,o),void 0,null),a},useId:function(){var e=qo(),o=we.identifierPrefix;if(Ee){var a=_o,t=Mo;a=(t&~(1<<32-So(t)-1)).toString(32)+a,o=":"+o+"R"+a,a=Dt++,0<a&&(o+="H"+a.toString(32)),o+=":"}else a=Ou++,o=":"+o+"r"+a.toString(32)+":";return e.memoizedState=o},unstable_isNewReconciler:!1},Fu={readContext:go,useCallback:Xl,useContext:go,useEffect:gi,useImperativeHandle:Yl,useInsertionEffect:Ql,useLayoutEffect:$l,useMemo:Jl,useReducer:pi,useRef:Hl,useState:function(){return pi(Nt)},useDebugValue:vi,useDeferredValue:function(e){var o=vo();return Zl(o,De.memoizedState,e)},useTransition:function(){var e=pi(Nt)[0],o=vo().memoizedState;return[e,o]},useMutableSource:Ml,useSyncExternalStore:_l,useId:ec,unstable_isNewReconciler:!1},Mu={readContext:go,useCallback:Xl,useContext:go,useEffect:gi,useImperativeHandle:Yl,useInsertionEffect:Ql,useLayoutEffect:$l,useMemo:Jl,useReducer:fi,useRef:Hl,useState:function(){return fi(Nt)},useDebugValue:vi,useDeferredValue:function(e){var o=vo();return De===null?o.memoizedState=e:Zl(o,De.memoizedState,e)},useTransition:function(){var e=fi(Nt)[0],o=vo().memoizedState;return[e,o]},useMutableSource:Ml,useSyncExternalStore:_l,useId:ec,unstable_isNewReconciler:!1};function yo(e,o){if(e&&e.defaultProps){o=L({},o),e=e.defaultProps;for(var a in e)o[a]===void 0&&(o[a]=e[a]);return o}return o}function Ci(e,o,a,t){o=e.memoizedState,a=a(t,o),a=a==null?o:L({},o,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var Rr={isMounted:function(e){return(e=e._reactInternals)?ua(e)===e:!1},enqueueSetState:function(e,o,a){e=e._reactInternals;var t=$e(),r=ia(e),n=jo(t,r);n.payload=o,a!=null&&(n.callback=a),o=aa(e,n,r),o!==null&&(xo(o,e,r,t),Er(o,e,r))},enqueueReplaceState:function(e,o,a){e=e._reactInternals;var t=$e(),r=ia(e),n=jo(t,r);n.tag=1,n.payload=o,a!=null&&(n.callback=a),o=aa(e,n,r),o!==null&&(xo(o,e,r,t),Er(o,e,r))},enqueueForceUpdate:function(e,o){e=e._reactInternals;var a=$e(),t=ia(e),r=jo(a,t);r.tag=2,o!=null&&(r.callback=o),o=aa(e,r,t),o!==null&&(xo(o,e,t,a),Er(o,e,t))}};function rc(e,o,a,t,r,n,i){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,n,i):o.prototype&&o.prototype.isPureReactComponent?!Ct(a,t)||!Ct(r,n):!0}function nc(e,o,a){var t=!1,r=Zo,n=o.contextType;return typeof n=="object"&&n!==null?n=go(n):(r=Ze(o)?pa:Ve.current,t=o.contextTypes,n=(t=t!=null)?Ma(e,r):Zo),o=new o(a,n),e.memoizedState=o.state!==null&&o.state!==void 0?o.state:null,o.updater=Rr,e.stateNode=o,o._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=r,e.__reactInternalMemoizedMaskedChildContext=n),o}function ic(e,o,a,t){e=o.state,typeof o.componentWillReceiveProps=="function"&&o.componentWillReceiveProps(a,t),typeof o.UNSAFE_componentWillReceiveProps=="function"&&o.UNSAFE_componentWillReceiveProps(a,t),o.state!==e&&Rr.enqueueReplaceState(o,o.state,null)}function hi(e,o,a,t){var r=e.stateNode;r.props=a,r.state=e.memoizedState,r.refs={},ri(e);var n=o.contextType;typeof n=="object"&&n!==null?r.context=go(n):(n=Ze(o)?pa:Ve.current,r.context=Ma(e,n)),r.state=e.memoizedState,n=o.getDerivedStateFromProps,typeof n=="function"&&(Ci(e,o,n,a),r.state=e.memoizedState),typeof o.getDerivedStateFromProps=="function"||typeof r.getSnapshotBeforeUpdate=="function"||typeof r.UNSAFE_componentWillMount!="function"&&typeof r.componentWillMount!="function"||(o=r.state,typeof r.componentWillMount=="function"&&r.componentWillMount(),typeof r.UNSAFE_componentWillMount=="function"&&r.UNSAFE_componentWillMount(),o!==r.state&&Rr.enqueueReplaceState(r,r.state,null),br(e,a,r,t),r.state=e.memoizedState),typeof r.componentDidMount=="function"&&(e.flags|=4194308)}function Ha(e,o){try{var a="",t=o;do a+=te(t),t=t.return;while(t);var r=a}catch(n){r=`
Error generating stack: `+n.message+`
`+n.stack}return{value:e,source:o,stack:r,digest:null}}function Si(e,o,a){return{value:e,source:null,stack:a??null,digest:o??null}}function Ei(e,o){try{console.error(o.value)}catch(a){setTimeout(function(){throw a})}}var _u=typeof WeakMap=="function"?WeakMap:Map;function sc(e,o,a){a=jo(-1,a),a.tag=3,a.payload={element:null};var t=o.value;return a.callback=function(){kr||(kr=!0,ki=t),Ei(e,o)},a}function lc(e,o,a){a=jo(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var r=o.value;a.payload=function(){return t(r)},a.callback=function(){Ei(e,o)}}var n=e.stateNode;return n!==null&&typeof n.componentDidCatch=="function"&&(a.callback=function(){Ei(e,o),typeof t!="function"&&(ra===null?ra=new Set([this]):ra.add(this));var i=o.stack;this.componentDidCatch(o.value,{componentStack:i!==null?i:""})}),a}function cc(e,o,a){var t=e.pingCache;if(t===null){t=e.pingCache=new _u;var r=new Set;t.set(o,r)}else r=t.get(o),r===void 0&&(r=new Set,t.set(o,r));r.has(a)||(r.add(a),e=Ju.bind(null,e,o,a),o.then(e,e))}function dc(e){do{var o;if((o=e.tag===13)&&(o=e.memoizedState,o=o!==null?o.dehydrated!==null:!0),o)return e;e=e.return}while(e!==null);return null}function uc(e,o,a,t,r){return(e.mode&1)===0?(e===o?e.flags|=65536:(e.flags|=128,a.flags|=131072,a.flags&=-52805,a.tag===1&&(a.alternate===null?a.tag=17:(o=jo(-1,1),o.tag=2,aa(a,o,1))),a.lanes|=1),e):(e.flags|=65536,e.lanes=r,e)}var zu=be.ReactCurrentOwner,eo=!1;function Qe(e,o,a,t){o.child=e===null?Ol(o,null,a,t):Ua(o,e.child,a,t)}function mc(e,o,a,t,r){a=a.render;var n=o.ref;return Va(o,r),t=ui(e,o,a,t,n,r),a=mi(),e!==null&&!eo?(o.updateQueue=e.updateQueue,o.flags&=-2053,e.lanes&=~r,Uo(e,o,r)):(Ee&&a&&$n(o),o.flags|=1,Qe(e,o,t,r),o.child)}function pc(e,o,a,t,r){if(e===null){var n=a.type;return typeof n=="function"&&!Bi(n)&&n.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(o.tag=15,o.type=n,fc(e,o,n,t,r)):(e=Ur(a.type,null,t,o,o.mode,r),e.ref=o.ref,e.return=o,o.child=e)}if(n=e.child,(e.lanes&r)===0){var i=n.memoizedProps;if(a=a.compare,a=a!==null?a:Ct,a(i,t)&&e.ref===o.ref)return Uo(e,o,r)}return o.flags|=1,e=la(n,t),e.ref=o.ref,e.return=o,o.child=e}function fc(e,o,a,t,r){if(e!==null){var n=e.memoizedProps;if(Ct(n,t)&&e.ref===o.ref)if(eo=!1,o.pendingProps=t=n,(e.lanes&r)!==0)(e.flags&131072)!==0&&(eo=!0);else return o.lanes=e.lanes,Uo(e,o,r)}return bi(e,o,a,t,r)}function gc(e,o,a){var t=o.pendingProps,r=t.children,n=e!==null?e.memoizedState:null;if(t.mode==="hidden")if((o.mode&1)===0)o.memoizedState={baseLanes:0,cachePool:null,transitions:null},fe(Qa,mo),mo|=a;else{if((a&1073741824)===0)return e=n!==null?n.baseLanes|a:a,o.lanes=o.childLanes=1073741824,o.memoizedState={baseLanes:e,cachePool:null,transitions:null},o.updateQueue=null,fe(Qa,mo),mo|=e,null;o.memoizedState={baseLanes:0,cachePool:null,transitions:null},t=n!==null?n.baseLanes:a,fe(Qa,mo),mo|=t}else n!==null?(t=n.baseLanes|a,o.memoizedState=null):t=a,fe(Qa,mo),mo|=t;return Qe(e,o,r,a),o.child}function vc(e,o){var a=o.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(o.flags|=512,o.flags|=2097152)}function bi(e,o,a,t,r){var n=Ze(a)?pa:Ve.current;return n=Ma(o,n),Va(o,r),a=ui(e,o,a,t,n,r),t=mi(),e!==null&&!eo?(o.updateQueue=e.updateQueue,o.flags&=-2053,e.lanes&=~r,Uo(e,o,r)):(Ee&&t&&$n(o),o.flags|=1,Qe(e,o,a,r),o.child)}function Cc(e,o,a,t,r){if(Ze(a)){var n=!0;mr(o)}else n=!1;if(Va(o,r),o.stateNode===null)Nr(e,o),nc(o,a,t),hi(o,a,t,r),t=!0;else if(e===null){var i=o.stateNode,s=o.memoizedProps;i.props=s;var u=i.context,h=a.contextType;typeof h=="object"&&h!==null?h=go(h):(h=Ze(a)?pa:Ve.current,h=Ma(o,h));var x=a.getDerivedStateFromProps,A=typeof x=="function"||typeof i.getSnapshotBeforeUpdate=="function";A||typeof i.UNSAFE_componentWillReceiveProps!="function"&&typeof i.componentWillReceiveProps!="function"||(s!==t||u!==h)&&ic(o,i,t,h),oa=!1;var T=o.memoizedState;i.state=T,br(o,t,i,r),u=o.memoizedState,s!==t||T!==u||Je.current||oa?(typeof x=="function"&&(Ci(o,a,x,t),u=o.memoizedState),(s=oa||rc(o,a,s,t,T,u,h))?(A||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount()),typeof i.componentDidMount=="function"&&(o.flags|=4194308)):(typeof i.componentDidMount=="function"&&(o.flags|=4194308),o.memoizedProps=t,o.memoizedState=u),i.props=t,i.state=u,i.context=h,t=s):(typeof i.componentDidMount=="function"&&(o.flags|=4194308),t=!1)}else{i=o.stateNode,wl(e,o),s=o.memoizedProps,h=o.type===o.elementType?s:yo(o.type,s),i.props=h,A=o.pendingProps,T=i.context,u=a.contextType,typeof u=="object"&&u!==null?u=go(u):(u=Ze(a)?pa:Ve.current,u=Ma(o,u));var w=a.getDerivedStateFromProps;(x=typeof w=="function"||typeof i.getSnapshotBeforeUpdate=="function")||typeof i.UNSAFE_componentWillReceiveProps!="function"&&typeof i.componentWillReceiveProps!="function"||(s!==A||T!==u)&&ic(o,i,t,u),oa=!1,T=o.memoizedState,i.state=T,br(o,t,i,r);var _=o.memoizedState;s!==A||T!==_||Je.current||oa?(typeof w=="function"&&(Ci(o,a,w,t),_=o.memoizedState),(h=oa||rc(o,a,h,t,T,_,u)||!1)?(x||typeof i.UNSAFE_componentWillUpdate!="function"&&typeof i.componentWillUpdate!="function"||(typeof i.componentWillUpdate=="function"&&i.componentWillUpdate(t,_,u),typeof i.UNSAFE_componentWillUpdate=="function"&&i.UNSAFE_componentWillUpdate(t,_,u)),typeof i.componentDidUpdate=="function"&&(o.flags|=4),typeof i.getSnapshotBeforeUpdate=="function"&&(o.flags|=1024)):(typeof i.componentDidUpdate!="function"||s===e.memoizedProps&&T===e.memoizedState||(o.flags|=4),typeof i.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&T===e.memoizedState||(o.flags|=1024),o.memoizedProps=t,o.memoizedState=_),i.props=t,i.state=_,i.context=u,t=h):(typeof i.componentDidUpdate!="function"||s===e.memoizedProps&&T===e.memoizedState||(o.flags|=4),typeof i.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&T===e.memoizedState||(o.flags|=1024),t=!1)}return yi(e,o,a,t,n,r)}function yi(e,o,a,t,r,n){vc(e,o);var i=(o.flags&128)!==0;if(!t&&!i)return r&&yl(o,a,!1),Uo(e,o,n);t=o.stateNode,zu.current=o;var s=i&&typeof a.getDerivedStateFromError!="function"?null:t.render();return o.flags|=1,e!==null&&i?(o.child=Ua(o,e.child,null,n),o.child=Ua(o,null,s,n)):Qe(e,o,s,n),o.memoizedState=t.state,r&&yl(o,a,!0),o.child}function hc(e){var o=e.stateNode;o.pendingContext?El(e,o.pendingContext,o.pendingContext!==o.context):o.context&&El(e,o.context,!1),ni(e,o.containerInfo)}function Sc(e,o,a,t,r){return ja(),Jn(r),o.flags|=256,Qe(e,o,a,t),o.child}var Ii={dehydrated:null,treeContext:null,retryLane:0};function Ti(e){return{baseLanes:e,cachePool:null,transitions:null}}function Ec(e,o,a){var t=o.pendingProps,r=ye.current,n=!1,i=(o.flags&128)!==0,s;if((s=i)||(s=e!==null&&e.memoizedState===null?!1:(r&2)!==0),s?(n=!0,o.flags&=-129):(e===null||e.memoizedState!==null)&&(r|=1),fe(ye,r&1),e===null)return Xn(o),e=o.memoizedState,e!==null&&(e=e.dehydrated,e!==null)?((o.mode&1)===0?o.lanes=1:e.data==="$!"?o.lanes=8:o.lanes=1073741824,null):(i=t.children,e=t.fallback,n?(t=o.mode,n=o.child,i={mode:"hidden",children:i},(t&1)===0&&n!==null?(n.childLanes=0,n.pendingProps=i):n=Br(i,t,0,null),e=Ia(e,t,a,null),n.return=o,e.return=o,n.sibling=e,o.child=n,o.child.memoizedState=Ti(a),o.memoizedState=Ii,e):xi(o,i));if(r=e.memoizedState,r!==null&&(s=r.dehydrated,s!==null))return ju(e,o,i,t,s,r,a);if(n){n=t.fallback,i=o.mode,r=e.child,s=r.sibling;var u={mode:"hidden",children:t.children};return(i&1)===0&&o.child!==r?(t=o.child,t.childLanes=0,t.pendingProps=u,o.deletions=null):(t=la(r,u),t.subtreeFlags=r.subtreeFlags&14680064),s!==null?n=la(s,n):(n=Ia(n,i,a,null),n.flags|=2),n.return=o,t.return=o,t.sibling=n,o.child=t,t=n,n=o.child,i=e.child.memoizedState,i=i===null?Ti(a):{baseLanes:i.baseLanes|a,cachePool:null,transitions:i.transitions},n.memoizedState=i,n.childLanes=e.childLanes&~a,o.memoizedState=Ii,t}return n=e.child,e=n.sibling,t=la(n,{mode:"visible",children:t.children}),(o.mode&1)===0&&(t.lanes=a),t.return=o,t.sibling=null,e!==null&&(a=o.deletions,a===null?(o.deletions=[e],o.flags|=16):a.push(e)),o.child=t,o.memoizedState=null,t}function xi(e,o){return o=Br({mode:"visible",children:o},e.mode,0,null),o.return=e,e.child=o}function Dr(e,o,a,t){return t!==null&&Jn(t),Ua(o,e.child,null,a),e=xi(o,o.pendingProps.children),e.flags|=2,o.memoizedState=null,e}function ju(e,o,a,t,r,n,i){if(a)return o.flags&256?(o.flags&=-257,t=Si(Error(c(422))),Dr(e,o,i,t)):o.memoizedState!==null?(o.child=e.child,o.flags|=128,null):(n=t.fallback,r=o.mode,t=Br({mode:"visible",children:t.children},r,0,null),n=Ia(n,r,i,null),n.flags|=2,t.return=o,n.return=o,t.sibling=n,o.child=t,(o.mode&1)!==0&&Ua(o,e.child,null,i),o.child.memoizedState=Ti(i),o.memoizedState=Ii,n);if((o.mode&1)===0)return Dr(e,o,i,null);if(r.data==="$!"){if(t=r.nextSibling&&r.nextSibling.dataset,t)var s=t.dgst;return t=s,n=Error(c(419)),t=Si(n,t,void 0),Dr(e,o,i,t)}if(s=(i&e.childLanes)!==0,eo||s){if(t=we,t!==null){switch(i&-i){case 4:r=2;break;case 16:r=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:r=32;break;case 536870912:r=268435456;break;default:r=0}r=(r&(t.suspendedLanes|i))!==0?0:r,r!==0&&r!==n.retryLane&&(n.retryLane=r,zo(e,r),xo(t,e,r,-1))}return Ui(),t=Si(Error(c(421))),Dr(e,o,i,t)}return r.data==="$?"?(o.flags|=128,o.child=e.child,o=Zu.bind(null,e),r._reactRetry=o,null):(e=n.treeContext,uo=Xo(r.nextSibling),co=o,Ee=!0,bo=null,e!==null&&(po[fo++]=Mo,po[fo++]=_o,po[fo++]=fa,Mo=e.id,_o=e.overflow,fa=o),o=xi(o,t.children),o.flags|=4096,o)}function bc(e,o,a){e.lanes|=o;var t=e.alternate;t!==null&&(t.lanes|=o),ai(e.return,o,a)}function Ai(e,o,a,t,r){var n=e.memoizedState;n===null?e.memoizedState={isBackwards:o,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:r}:(n.isBackwards=o,n.rendering=null,n.renderingStartTime=0,n.last=t,n.tail=a,n.tailMode=r)}function yc(e,o,a){var t=o.pendingProps,r=t.revealOrder,n=t.tail;if(Qe(e,o,t.children,a),t=ye.current,(t&2)!==0)t=t&1|2,o.flags|=128;else{if(e!==null&&(e.flags&128)!==0)e:for(e=o.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&bc(e,a,o);else if(e.tag===19)bc(e,a,o);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===o)break e;for(;e.sibling===null;){if(e.return===null||e.return===o)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(fe(ye,t),(o.mode&1)===0)o.memoizedState=null;else switch(r){case"forwards":for(a=o.child,r=null;a!==null;)e=a.alternate,e!==null&&yr(e)===null&&(r=a),a=a.sibling;a=r,a===null?(r=o.child,o.child=null):(r=a.sibling,a.sibling=null),Ai(o,!1,r,a,n);break;case"backwards":for(a=null,r=o.child,o.child=null;r!==null;){if(e=r.alternate,e!==null&&yr(e)===null){o.child=r;break}e=r.sibling,r.sibling=a,a=r,r=e}Ai(o,!0,a,null,n);break;case"together":Ai(o,!1,null,null,void 0);break;default:o.memoizedState=null}return o.child}function Nr(e,o){(o.mode&1)===0&&e!==null&&(e.alternate=null,o.alternate=null,o.flags|=2)}function Uo(e,o,a){if(e!==null&&(o.dependencies=e.dependencies),Sa|=o.lanes,(a&o.childLanes)===0)return null;if(e!==null&&o.child!==e.child)throw Error(c(153));if(o.child!==null){for(e=o.child,a=la(e,e.pendingProps),o.child=a,a.return=o;e.sibling!==null;)e=e.sibling,a=a.sibling=la(e,e.pendingProps),a.return=o;a.sibling=null}return o.child}function Uu(e,o,a){switch(o.tag){case 3:hc(o),ja();break;case 5:Fl(o);break;case 1:Ze(o.type)&&mr(o);break;case 4:ni(o,o.stateNode.containerInfo);break;case 10:var t=o.type._context,r=o.memoizedProps.value;fe(hr,t._currentValue),t._currentValue=r;break;case 13:if(t=o.memoizedState,t!==null)return t.dehydrated!==null?(fe(ye,ye.current&1),o.flags|=128,null):(a&o.child.childLanes)!==0?Ec(e,o,a):(fe(ye,ye.current&1),e=Uo(e,o,a),e!==null?e.sibling:null);fe(ye,ye.current&1);break;case 19:if(t=(a&o.childLanes)!==0,(e.flags&128)!==0){if(t)return yc(e,o,a);o.flags|=128}if(r=o.memoizedState,r!==null&&(r.rendering=null,r.tail=null,r.lastEffect=null),fe(ye,ye.current),t)break;return null;case 22:case 23:return o.lanes=0,gc(e,o,a)}return Uo(e,o,a)}var Ic,Pi,Tc,xc;Ic=function(e,o){for(var a=o.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===o)break;for(;a.sibling===null;){if(a.return===null||a.return===o)return;a=a.return}a.sibling.return=a.return,a=a.sibling}},Pi=function(){},Tc=function(e,o,a,t){var r=e.memoizedProps;if(r!==t){e=o.stateNode,Ca(Oo.current);var n=null;switch(a){case"input":r=Xe(e,r),t=Xe(e,t),n=[];break;case"select":r=L({},r,{value:void 0}),t=L({},t,{value:void 0}),n=[];break;case"textarea":r=rn(e,r),t=rn(e,t),n=[];break;default:typeof r.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=cr)}sn(a,t);var i;a=null;for(h in r)if(!t.hasOwnProperty(h)&&r.hasOwnProperty(h)&&r[h]!=null)if(h==="style"){var s=r[h];for(i in s)s.hasOwnProperty(i)&&(a||(a={}),a[i]="")}else h!=="dangerouslySetInnerHTML"&&h!=="children"&&h!=="suppressContentEditableWarning"&&h!=="suppressHydrationWarning"&&h!=="autoFocus"&&(E.hasOwnProperty(h)?n||(n=[]):(n=n||[]).push(h,null));for(h in t){var u=t[h];if(s=r!=null?r[h]:void 0,t.hasOwnProperty(h)&&u!==s&&(u!=null||s!=null))if(h==="style")if(s){for(i in s)!s.hasOwnProperty(i)||u&&u.hasOwnProperty(i)||(a||(a={}),a[i]="");for(i in u)u.hasOwnProperty(i)&&s[i]!==u[i]&&(a||(a={}),a[i]=u[i])}else a||(n||(n=[]),n.push(h,a)),a=u;else h==="dangerouslySetInnerHTML"?(u=u?u.__html:void 0,s=s?s.__html:void 0,u!=null&&s!==u&&(n=n||[]).push(h,u)):h==="children"?typeof u!="string"&&typeof u!="number"||(n=n||[]).push(h,""+u):h!=="suppressContentEditableWarning"&&h!=="suppressHydrationWarning"&&(E.hasOwnProperty(h)?(u!=null&&h==="onScroll"&&Ce("scroll",e),n||s===u||(n=[])):(n=n||[]).push(h,u))}a&&(n=n||[]).push("style",a);var h=n;(o.updateQueue=h)&&(o.flags|=4)}},xc=function(e,o,a,t){a!==t&&(o.flags|=4)};function qt(e,o){if(!Ee)switch(e.tailMode){case"hidden":o=e.tail;for(var a=null;o!==null;)o.alternate!==null&&(a=o),o=o.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?o||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function He(e){var o=e.alternate!==null&&e.alternate.child===e.child,a=0,t=0;if(o)for(var r=e.child;r!==null;)a|=r.lanes|r.childLanes,t|=r.subtreeFlags&14680064,t|=r.flags&14680064,r.return=e,r=r.sibling;else for(r=e.child;r!==null;)a|=r.lanes|r.childLanes,t|=r.subtreeFlags,t|=r.flags,r.return=e,r=r.sibling;return e.subtreeFlags|=t,e.childLanes=a,o}function Bu(e,o,a){var t=o.pendingProps;switch(Kn(o),o.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return He(o),null;case 1:return Ze(o.type)&&ur(),He(o),null;case 3:return t=o.stateNode,Wa(),he(Je),he(Ve),li(),t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(vr(o)?o.flags|=4:e===null||e.memoizedState.isDehydrated&&(o.flags&256)===0||(o.flags|=1024,bo!==null&&(_i(bo),bo=null))),Pi(e,o),He(o),null;case 5:ii(o);var r=Ca(Pt.current);if(a=o.type,e!==null&&o.stateNode!=null)Tc(e,o,a,t,r),e.ref!==o.ref&&(o.flags|=512,o.flags|=2097152);else{if(!t){if(o.stateNode===null)throw Error(c(166));return He(o),null}if(e=Ca(Oo.current),vr(o)){t=o.stateNode,a=o.type;var n=o.memoizedProps;switch(t[No]=o,t[yt]=n,e=(o.mode&1)!==0,a){case"dialog":Ce("cancel",t),Ce("close",t);break;case"iframe":case"object":case"embed":Ce("load",t);break;case"video":case"audio":for(r=0;r<St.length;r++)Ce(St[r],t);break;case"source":Ce("error",t);break;case"img":case"image":case"link":Ce("error",t),Ce("load",t);break;case"details":Ce("toggle",t);break;case"input":ns(t,n),Ce("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!n.multiple},Ce("invalid",t);break;case"textarea":ls(t,n),Ce("invalid",t)}sn(a,n),r=null;for(var i in n)if(n.hasOwnProperty(i)){var s=n[i];i==="children"?typeof s=="string"?t.textContent!==s&&(n.suppressHydrationWarning!==!0&&lr(t.textContent,s,e),r=["children",s]):typeof s=="number"&&t.textContent!==""+s&&(n.suppressHydrationWarning!==!0&&lr(t.textContent,s,e),r=["children",""+s]):E.hasOwnProperty(i)&&s!=null&&i==="onScroll"&&Ce("scroll",t)}switch(a){case"input":pe(t),ss(t,n,!0);break;case"textarea":pe(t),ds(t);break;case"select":case"option":break;default:typeof n.onClick=="function"&&(t.onclick=cr)}t=r,o.updateQueue=t,t!==null&&(o.flags|=4)}else{i=r.nodeType===9?r:r.ownerDocument,e==="http://www.w3.org/1999/xhtml"&&(e=us(a)),e==="http://www.w3.org/1999/xhtml"?a==="script"?(e=i.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=i.createElement(a,{is:t.is}):(e=i.createElement(a),a==="select"&&(i=e,t.multiple?i.multiple=!0:t.size&&(i.size=t.size))):e=i.createElementNS(e,a),e[No]=o,e[yt]=t,Ic(e,o,!1,!1),o.stateNode=e;e:{switch(i=ln(a,t),a){case"dialog":Ce("cancel",e),Ce("close",e),r=t;break;case"iframe":case"object":case"embed":Ce("load",e),r=t;break;case"video":case"audio":for(r=0;r<St.length;r++)Ce(St[r],e);r=t;break;case"source":Ce("error",e),r=t;break;case"img":case"image":case"link":Ce("error",e),Ce("load",e),r=t;break;case"details":Ce("toggle",e),r=t;break;case"input":ns(e,t),r=Xe(e,t),Ce("invalid",e);break;case"option":r=t;break;case"select":e._wrapperState={wasMultiple:!!t.multiple},r=L({},t,{value:void 0}),Ce("invalid",e);break;case"textarea":ls(e,t),r=rn(e,t),Ce("invalid",e);break;default:r=t}sn(a,r),s=r;for(n in s)if(s.hasOwnProperty(n)){var u=s[n];n==="style"?fs(e,u):n==="dangerouslySetInnerHTML"?(u=u?u.__html:void 0,u!=null&&ms(e,u)):n==="children"?typeof u=="string"?(a!=="textarea"||u!=="")&&et(e,u):typeof u=="number"&&et(e,""+u):n!=="suppressContentEditableWarning"&&n!=="suppressHydrationWarning"&&n!=="autoFocus"&&(E.hasOwnProperty(n)?u!=null&&n==="onScroll"&&Ce("scroll",e):u!=null&&ue(e,n,u,i))}switch(a){case"input":pe(e),ss(e,t,!1);break;case"textarea":pe(e),ds(e);break;case"option":t.value!=null&&e.setAttribute("value",""+ie(t.value));break;case"select":e.multiple=!!t.multiple,n=t.value,n!=null?xa(e,!!t.multiple,n,!1):t.defaultValue!=null&&xa(e,!!t.multiple,t.defaultValue,!0);break;default:typeof r.onClick=="function"&&(e.onclick=cr)}switch(a){case"button":case"input":case"select":case"textarea":t=!!t.autoFocus;break e;case"img":t=!0;break e;default:t=!1}}t&&(o.flags|=4)}o.ref!==null&&(o.flags|=512,o.flags|=2097152)}return He(o),null;case 6:if(e&&o.stateNode!=null)xc(e,o,e.memoizedProps,t);else{if(typeof t!="string"&&o.stateNode===null)throw Error(c(166));if(a=Ca(Pt.current),Ca(Oo.current),vr(o)){if(t=o.stateNode,a=o.memoizedProps,t[No]=o,(n=t.nodeValue!==a)&&(e=co,e!==null))switch(e.tag){case 3:lr(t.nodeValue,a,(e.mode&1)!==0);break;case 5:e.memoizedProps.suppressHydrationWarning!==!0&&lr(t.nodeValue,a,(e.mode&1)!==0)}n&&(o.flags|=4)}else t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[No]=o,o.stateNode=t}return He(o),null;case 13:if(he(ye),t=o.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(Ee&&uo!==null&&(o.mode&1)!==0&&(o.flags&128)===0)Rl(),ja(),o.flags|=98560,n=!1;else if(n=vr(o),t!==null&&t.dehydrated!==null){if(e===null){if(!n)throw Error(c(318));if(n=o.memoizedState,n=n!==null?n.dehydrated:null,!n)throw Error(c(317));n[No]=o}else ja(),(o.flags&128)===0&&(o.memoizedState=null),o.flags|=4;He(o),n=!1}else bo!==null&&(_i(bo),bo=null),n=!0;if(!n)return o.flags&65536?o:null}return(o.flags&128)!==0?(o.lanes=a,o):(t=t!==null,t!==(e!==null&&e.memoizedState!==null)&&t&&(o.child.flags|=8192,(o.mode&1)!==0&&(e===null||(ye.current&1)!==0?Ne===0&&(Ne=3):Ui())),o.updateQueue!==null&&(o.flags|=4),He(o),null);case 4:return Wa(),Pi(e,o),e===null&&Et(o.stateNode.containerInfo),He(o),null;case 10:return oi(o.type._context),He(o),null;case 17:return Ze(o.type)&&ur(),He(o),null;case 19:if(he(ye),n=o.memoizedState,n===null)return He(o),null;if(t=(o.flags&128)!==0,i=n.rendering,i===null)if(t)qt(n,!1);else{if(Ne!==0||e!==null&&(e.flags&128)!==0)for(e=o.child;e!==null;){if(i=yr(e),i!==null){for(o.flags|=128,qt(n,!1),t=i.updateQueue,t!==null&&(o.updateQueue=t,o.flags|=4),o.subtreeFlags=0,t=a,a=o.child;a!==null;)n=a,e=t,n.flags&=14680066,i=n.alternate,i===null?(n.childLanes=0,n.lanes=e,n.child=null,n.subtreeFlags=0,n.memoizedProps=null,n.memoizedState=null,n.updateQueue=null,n.dependencies=null,n.stateNode=null):(n.childLanes=i.childLanes,n.lanes=i.lanes,n.child=i.child,n.subtreeFlags=0,n.deletions=null,n.memoizedProps=i.memoizedProps,n.memoizedState=i.memoizedState,n.updateQueue=i.updateQueue,n.type=i.type,e=i.dependencies,n.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return fe(ye,ye.current&1|2),o.child}e=e.sibling}n.tail!==null&&xe()>$a&&(o.flags|=128,t=!0,qt(n,!1),o.lanes=4194304)}else{if(!t)if(e=yr(i),e!==null){if(o.flags|=128,t=!0,a=e.updateQueue,a!==null&&(o.updateQueue=a,o.flags|=4),qt(n,!0),n.tail===null&&n.tailMode==="hidden"&&!i.alternate&&!Ee)return He(o),null}else 2*xe()-n.renderingStartTime>$a&&a!==1073741824&&(o.flags|=128,t=!0,qt(n,!1),o.lanes=4194304);n.isBackwards?(i.sibling=o.child,o.child=i):(a=n.last,a!==null?a.sibling=i:o.child=i,n.last=i)}return n.tail!==null?(o=n.tail,n.rendering=o,n.tail=o.sibling,n.renderingStartTime=xe(),o.sibling=null,a=ye.current,fe(ye,t?a&1|2:a&1),o):(He(o),null);case 22:case 23:return ji(),t=o.memoizedState!==null,e!==null&&e.memoizedState!==null!==t&&(o.flags|=8192),t&&(o.mode&1)!==0?(mo&1073741824)!==0&&(He(o),o.subtreeFlags&6&&(o.flags|=8192)):He(o),null;case 24:return null;case 25:return null}throw Error(c(156,o.tag))}function Vu(e,o){switch(Kn(o),o.tag){case 1:return Ze(o.type)&&ur(),e=o.flags,e&65536?(o.flags=e&-65537|128,o):null;case 3:return Wa(),he(Je),he(Ve),li(),e=o.flags,(e&65536)!==0&&(e&128)===0?(o.flags=e&-65537|128,o):null;case 5:return ii(o),null;case 13:if(he(ye),e=o.memoizedState,e!==null&&e.dehydrated!==null){if(o.alternate===null)throw Error(c(340));ja()}return e=o.flags,e&65536?(o.flags=e&-65537|128,o):null;case 19:return he(ye),null;case 4:return Wa(),null;case 10:return oi(o.type._context),null;case 22:case 23:return ji(),null;case 24:return null;default:return null}}var Or=!1,Ge=!1,Wu=typeof WeakSet=="function"?WeakSet:Set,F=null;function Ga(e,o){var a=e.ref;if(a!==null)if(typeof a=="function")try{a(null)}catch(t){Te(e,o,t)}else a.current=null}function Ri(e,o,a){try{a()}catch(t){Te(e,o,t)}}var Ac=!1;function Hu(e,o){if(jn=Xt,e=rl(),qn(e)){if("selectionStart"in e)var a={start:e.selectionStart,end:e.selectionEnd};else e:{a=(a=e.ownerDocument)&&a.defaultView||window;var t=a.getSelection&&a.getSelection();if(t&&t.rangeCount!==0){a=t.anchorNode;var r=t.anchorOffset,n=t.focusNode;t=t.focusOffset;try{a.nodeType,n.nodeType}catch{a=null;break e}var i=0,s=-1,u=-1,h=0,x=0,A=e,T=null;o:for(;;){for(var w;A!==a||r!==0&&A.nodeType!==3||(s=i+r),A!==n||t!==0&&A.nodeType!==3||(u=i+t),A.nodeType===3&&(i+=A.nodeValue.length),(w=A.firstChild)!==null;)T=A,A=w;for(;;){if(A===e)break o;if(T===a&&++h===r&&(s=i),T===n&&++x===t&&(u=i),(w=A.nextSibling)!==null)break;A=T,T=A.parentNode}A=w}a=s===-1||u===-1?null:{start:s,end:u}}else a=null}a=a||{start:0,end:0}}else a=null;for(Un={focusedElem:e,selectionRange:a},Xt=!1,F=o;F!==null;)if(o=F,e=o.child,(o.subtreeFlags&1028)!==0&&e!==null)e.return=o,F=e;else for(;F!==null;){o=F;try{var _=o.alternate;if((o.flags&1024)!==0)switch(o.tag){case 0:case 11:case 15:break;case 1:if(_!==null){var j=_.memoizedProps,Ae=_.memoizedState,g=o.stateNode,p=g.getSnapshotBeforeUpdate(o.elementType===o.type?j:yo(o.type,j),Ae);g.__reactInternalSnapshotBeforeUpdate=p}break;case 3:var v=o.stateNode.containerInfo;v.nodeType===1?v.textContent="":v.nodeType===9&&v.documentElement&&v.removeChild(v.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(c(163))}}catch(D){Te(o,o.return,D)}if(e=o.sibling,e!==null){e.return=o.return,F=e;break}F=o.return}return _=Ac,Ac=!1,_}function wt(e,o,a){var t=o.updateQueue;if(t=t!==null?t.lastEffect:null,t!==null){var r=t=t.next;do{if((r.tag&e)===e){var n=r.destroy;r.destroy=void 0,n!==void 0&&Ri(o,a,n)}r=r.next}while(r!==t)}}function qr(e,o){if(o=o.updateQueue,o=o!==null?o.lastEffect:null,o!==null){var a=o=o.next;do{if((a.tag&e)===e){var t=a.create;a.destroy=t()}a=a.next}while(a!==o)}}function Di(e){var o=e.ref;if(o!==null){var a=e.stateNode;switch(e.tag){case 5:e=a;break;default:e=a}typeof o=="function"?o(e):o.current=e}}function Pc(e){var o=e.alternate;o!==null&&(e.alternate=null,Pc(o)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(o=e.stateNode,o!==null&&(delete o[No],delete o[yt],delete o[Hn],delete o[Pu],delete o[Ru])),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}function Rc(e){return e.tag===5||e.tag===3||e.tag===4}function Dc(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||Rc(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function Ni(e,o,a){var t=e.tag;if(t===5||t===6)e=e.stateNode,o?a.nodeType===8?a.parentNode.insertBefore(e,o):a.insertBefore(e,o):(a.nodeType===8?(o=a.parentNode,o.insertBefore(e,a)):(o=a,o.appendChild(e)),a=a._reactRootContainer,a!=null||o.onclick!==null||(o.onclick=cr));else if(t!==4&&(e=e.child,e!==null))for(Ni(e,o,a),e=e.sibling;e!==null;)Ni(e,o,a),e=e.sibling}function Oi(e,o,a){var t=e.tag;if(t===5||t===6)e=e.stateNode,o?a.insertBefore(e,o):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(Oi(e,o,a),e=e.sibling;e!==null;)Oi(e,o,a),e=e.sibling}var ze=null,Io=!1;function ta(e,o,a){for(a=a.child;a!==null;)Nc(e,o,a),a=a.sibling}function Nc(e,o,a){if(Do&&typeof Do.onCommitFiberUnmount=="function")try{Do.onCommitFiberUnmount(Ht,a)}catch{}switch(a.tag){case 5:Ge||Ga(a,o);case 6:var t=ze,r=Io;ze=null,ta(e,o,a),ze=t,Io=r,ze!==null&&(Io?(e=ze,a=a.stateNode,e.nodeType===8?e.parentNode.removeChild(a):e.removeChild(a)):ze.removeChild(a.stateNode));break;case 18:ze!==null&&(Io?(e=ze,a=a.stateNode,e.nodeType===8?Wn(e.parentNode,a):e.nodeType===1&&Wn(e,a),ut(e)):Wn(ze,a.stateNode));break;case 4:t=ze,r=Io,ze=a.stateNode.containerInfo,Io=!0,ta(e,o,a),ze=t,Io=r;break;case 0:case 11:case 14:case 15:if(!Ge&&(t=a.updateQueue,t!==null&&(t=t.lastEffect,t!==null))){r=t=t.next;do{var n=r,i=n.destroy;n=n.tag,i!==void 0&&((n&2)!==0||(n&4)!==0)&&Ri(a,o,i),r=r.next}while(r!==t)}ta(e,o,a);break;case 1:if(!Ge&&(Ga(a,o),t=a.stateNode,typeof t.componentWillUnmount=="function"))try{t.props=a.memoizedProps,t.state=a.memoizedState,t.componentWillUnmount()}catch(s){Te(a,o,s)}ta(e,o,a);break;case 21:ta(e,o,a);break;case 22:a.mode&1?(Ge=(t=Ge)||a.memoizedState!==null,ta(e,o,a),Ge=t):ta(e,o,a);break;default:ta(e,o,a)}}function Oc(e){var o=e.updateQueue;if(o!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new Wu),o.forEach(function(t){var r=em.bind(null,e,t);a.has(t)||(a.add(t),t.then(r,r))})}}function To(e,o){var a=o.deletions;if(a!==null)for(var t=0;t<a.length;t++){var r=a[t];try{var n=e,i=o,s=i;e:for(;s!==null;){switch(s.tag){case 5:ze=s.stateNode,Io=!1;break e;case 3:ze=s.stateNode.containerInfo,Io=!0;break e;case 4:ze=s.stateNode.containerInfo,Io=!0;break e}s=s.return}if(ze===null)throw Error(c(160));Nc(n,i,r),ze=null,Io=!1;var u=r.alternate;u!==null&&(u.return=null),r.return=null}catch(h){Te(r,o,h)}}if(o.subtreeFlags&12854)for(o=o.child;o!==null;)qc(o,e),o=o.sibling}function qc(e,o){var a=e.alternate,t=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:if(To(o,e),wo(e),t&4){try{wt(3,e,e.return),qr(3,e)}catch(j){Te(e,e.return,j)}try{wt(5,e,e.return)}catch(j){Te(e,e.return,j)}}break;case 1:To(o,e),wo(e),t&512&&a!==null&&Ga(a,a.return);break;case 5:if(To(o,e),wo(e),t&512&&a!==null&&Ga(a,a.return),e.flags&32){var r=e.stateNode;try{et(r,"")}catch(j){Te(e,e.return,j)}}if(t&4&&(r=e.stateNode,r!=null)){var n=e.memoizedProps,i=a!==null?a.memoizedProps:n,s=e.type,u=e.updateQueue;if(e.updateQueue=null,u!==null)try{s==="input"&&n.type==="radio"&&n.name!=null&&is(r,n),ln(s,i);var h=ln(s,n);for(i=0;i<u.length;i+=2){var x=u[i],A=u[i+1];x==="style"?fs(r,A):x==="dangerouslySetInnerHTML"?ms(r,A):x==="children"?et(r,A):ue(r,x,A,h)}switch(s){case"input":an(r,n);break;case"textarea":cs(r,n);break;case"select":var T=r._wrapperState.wasMultiple;r._wrapperState.wasMultiple=!!n.multiple;var w=n.value;w!=null?xa(r,!!n.multiple,w,!1):T!==!!n.multiple&&(n.defaultValue!=null?xa(r,!!n.multiple,n.defaultValue,!0):xa(r,!!n.multiple,n.multiple?[]:"",!1))}r[yt]=n}catch(j){Te(e,e.return,j)}}break;case 6:if(To(o,e),wo(e),t&4){if(e.stateNode===null)throw Error(c(162));r=e.stateNode,n=e.memoizedProps;try{r.nodeValue=n}catch(j){Te(e,e.return,j)}}break;case 3:if(To(o,e),wo(e),t&4&&a!==null&&a.memoizedState.isDehydrated)try{ut(o.containerInfo)}catch(j){Te(e,e.return,j)}break;case 4:To(o,e),wo(e);break;case 13:To(o,e),wo(e),r=e.child,r.flags&8192&&(n=r.memoizedState!==null,r.stateNode.isHidden=n,!n||r.alternate!==null&&r.alternate.memoizedState!==null||(Li=xe())),t&4&&Oc(e);break;case 22:if(x=a!==null&&a.memoizedState!==null,e.mode&1?(Ge=(h=Ge)||x,To(o,e),Ge=h):To(o,e),wo(e),t&8192){if(h=e.memoizedState!==null,(e.stateNode.isHidden=h)&&!x&&(e.mode&1)!==0)for(F=e,x=e.child;x!==null;){for(A=F=x;F!==null;){switch(T=F,w=T.child,T.tag){case 0:case 11:case 14:case 15:wt(4,T,T.return);break;case 1:Ga(T,T.return);var _=T.stateNode;if(typeof _.componentWillUnmount=="function"){t=T,a=T.return;try{o=t,_.props=o.memoizedProps,_.state=o.memoizedState,_.componentWillUnmount()}catch(j){Te(t,a,j)}}break;case 5:Ga(T,T.return);break;case 22:if(T.memoizedState!==null){kc(A);continue}}w!==null?(w.return=T,F=w):kc(A)}x=x.sibling}e:for(x=null,A=e;;){if(A.tag===5){if(x===null){x=A;try{r=A.stateNode,h?(n=r.style,typeof n.setProperty=="function"?n.setProperty("display","none","important"):n.display="none"):(s=A.stateNode,u=A.memoizedProps.style,i=u!=null&&u.hasOwnProperty("display")?u.display:null,s.style.display=ps("display",i))}catch(j){Te(e,e.return,j)}}}else if(A.tag===6){if(x===null)try{A.stateNode.nodeValue=h?"":A.memoizedProps}catch(j){Te(e,e.return,j)}}else if((A.tag!==22&&A.tag!==23||A.memoizedState===null||A===e)&&A.child!==null){A.child.return=A,A=A.child;continue}if(A===e)break e;for(;A.sibling===null;){if(A.return===null||A.return===e)break e;x===A&&(x=null),A=A.return}x===A&&(x=null),A.sibling.return=A.return,A=A.sibling}}break;case 19:To(o,e),wo(e),t&4&&Oc(e);break;case 21:break;default:To(o,e),wo(e)}}function wo(e){var o=e.flags;if(o&2){try{e:{for(var a=e.return;a!==null;){if(Rc(a)){var t=a;break e}a=a.return}throw Error(c(160))}switch(t.tag){case 5:var r=t.stateNode;t.flags&32&&(et(r,""),t.flags&=-33);var n=Dc(e);Oi(e,n,r);break;case 3:case 4:var i=t.stateNode.containerInfo,s=Dc(e);Ni(e,s,i);break;default:throw Error(c(161))}}catch(u){Te(e,e.return,u)}e.flags&=-3}o&4096&&(e.flags&=-4097)}function Gu(e,o,a){F=e,wc(e)}function wc(e,o,a){for(var t=(e.mode&1)!==0;F!==null;){var r=F,n=r.child;if(r.tag===22&&t){var i=r.memoizedState!==null||Or;if(!i){var s=r.alternate,u=s!==null&&s.memoizedState!==null||Ge;s=Or;var h=Ge;if(Or=i,(Ge=u)&&!h)for(F=r;F!==null;)i=F,u=i.child,i.tag===22&&i.memoizedState!==null?Fc(r):u!==null?(u.return=i,F=u):Fc(r);for(;n!==null;)F=n,wc(n),n=n.sibling;F=r,Or=s,Ge=h}Lc(e)}else(r.subtreeFlags&8772)!==0&&n!==null?(n.return=r,F=n):Lc(e)}}function Lc(e){for(;F!==null;){var o=F;if((o.flags&8772)!==0){var a=o.alternate;try{if((o.flags&8772)!==0)switch(o.tag){case 0:case 11:case 15:Ge||qr(5,o);break;case 1:var t=o.stateNode;if(o.flags&4&&!Ge)if(a===null)t.componentDidMount();else{var r=o.elementType===o.type?a.memoizedProps:yo(o.type,a.memoizedProps);t.componentDidUpdate(r,a.memoizedState,t.__reactInternalSnapshotBeforeUpdate)}var n=o.updateQueue;n!==null&&kl(o,n,t);break;case 3:var i=o.updateQueue;if(i!==null){if(a=null,o.child!==null)switch(o.child.tag){case 5:a=o.child.stateNode;break;case 1:a=o.child.stateNode}kl(o,i,a)}break;case 5:var s=o.stateNode;if(a===null&&o.flags&4){a=s;var u=o.memoizedProps;switch(o.type){case"button":case"input":case"select":case"textarea":u.autoFocus&&a.focus();break;case"img":u.src&&(a.src=u.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(o.memoizedState===null){var h=o.alternate;if(h!==null){var x=h.memoizedState;if(x!==null){var A=x.dehydrated;A!==null&&ut(A)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(c(163))}Ge||o.flags&512&&Di(o)}catch(T){Te(o,o.return,T)}}if(o===e){F=null;break}if(a=o.sibling,a!==null){a.return=o.return,F=a;break}F=o.return}}function kc(e){for(;F!==null;){var o=F;if(o===e){F=null;break}var a=o.sibling;if(a!==null){a.return=o.return,F=a;break}F=o.return}}function Fc(e){for(;F!==null;){var o=F;try{switch(o.tag){case 0:case 11:case 15:var a=o.return;try{qr(4,o)}catch(u){Te(o,a,u)}break;case 1:var t=o.stateNode;if(typeof t.componentDidMount=="function"){var r=o.return;try{t.componentDidMount()}catch(u){Te(o,r,u)}}var n=o.return;try{Di(o)}catch(u){Te(o,n,u)}break;case 5:var i=o.return;try{Di(o)}catch(u){Te(o,i,u)}}}catch(u){Te(o,o.return,u)}if(o===e){F=null;break}var s=o.sibling;if(s!==null){s.return=o.return,F=s;break}F=o.return}}var Qu=Math.ceil,wr=be.ReactCurrentDispatcher,qi=be.ReactCurrentOwner,Co=be.ReactCurrentBatchConfig,ne=0,we=null,Pe=null,je=0,mo=0,Qa=Jo(0),Ne=0,Lt=null,Sa=0,Lr=0,wi=0,kt=null,oo=null,Li=0,$a=1/0,Bo=null,kr=!1,ki=null,ra=null,Fr=!1,na=null,Mr=0,Ft=0,Fi=null,_r=-1,zr=0;function $e(){return(ne&6)!==0?xe():_r!==-1?_r:_r=xe()}function ia(e){return(e.mode&1)===0?1:(ne&2)!==0&&je!==0?je&-je:Nu.transition!==null?(zr===0&&(zr=Ds()),zr):(e=ce,e!==0||(e=window.event,e=e===void 0?16:_s(e.type)),e)}function xo(e,o,a,t){if(50<Ft)throw Ft=0,Fi=null,Error(c(185));it(e,a,t),((ne&2)===0||e!==we)&&(e===we&&((ne&2)===0&&(Lr|=a),Ne===4&&sa(e,je)),ao(e,t),a===1&&ne===0&&(o.mode&1)===0&&($a=xe()+500,pr&&ea()))}function ao(e,o){var a=e.callbackNode;Nd(e,o);var t=$t(e,e===we?je:0);if(t===0)a!==null&&As(a),e.callbackNode=null,e.callbackPriority=0;else if(o=t&-t,e.callbackPriority!==o){if(a!=null&&As(a),o===1)e.tag===0?Du(_c.bind(null,e)):Il(_c.bind(null,e)),xu(function(){(ne&6)===0&&ea()}),a=null;else{switch(Ns(t)){case 1:a=gn;break;case 4:a=Ps;break;case 16:a=Wt;break;case 536870912:a=Rs;break;default:a=Wt}a=Gc(a,Mc.bind(null,e))}e.callbackPriority=o,e.callbackNode=a}}function Mc(e,o){if(_r=-1,zr=0,(ne&6)!==0)throw Error(c(327));var a=e.callbackNode;if(Ka()&&e.callbackNode!==a)return null;var t=$t(e,e===we?je:0);if(t===0)return null;if((t&30)!==0||(t&e.expiredLanes)!==0||o)o=jr(e,t);else{o=t;var r=ne;ne|=2;var n=jc();(we!==e||je!==o)&&(Bo=null,$a=xe()+500,ba(e,o));do try{Yu();break}catch(s){zc(e,s)}while(!0);ei(),wr.current=n,ne=r,Pe!==null?o=0:(we=null,je=0,o=Ne)}if(o!==0){if(o===2&&(r=vn(e),r!==0&&(t=r,o=Mi(e,r))),o===1)throw a=Lt,ba(e,0),sa(e,t),ao(e,xe()),a;if(o===6)sa(e,t);else{if(r=e.current.alternate,(t&30)===0&&!$u(r)&&(o=jr(e,t),o===2&&(n=vn(e),n!==0&&(t=n,o=Mi(e,n))),o===1))throw a=Lt,ba(e,0),sa(e,t),ao(e,xe()),a;switch(e.finishedWork=r,e.finishedLanes=t,o){case 0:case 1:throw Error(c(345));case 2:ya(e,oo,Bo);break;case 3:if(sa(e,t),(t&130023424)===t&&(o=Li+500-xe(),10<o)){if($t(e,0)!==0)break;if(r=e.suspendedLanes,(r&t)!==t){$e(),e.pingedLanes|=e.suspendedLanes&r;break}e.timeoutHandle=Vn(ya.bind(null,e,oo,Bo),o);break}ya(e,oo,Bo);break;case 4:if(sa(e,t),(t&4194240)===t)break;for(o=e.eventTimes,r=-1;0<t;){var i=31-So(t);n=1<<i,i=o[i],i>r&&(r=i),t&=~n}if(t=r,t=xe()-t,t=(120>t?120:480>t?480:1080>t?1080:1920>t?1920:3e3>t?3e3:4320>t?4320:1960*Qu(t/1960))-t,10<t){e.timeoutHandle=Vn(ya.bind(null,e,oo,Bo),t);break}ya(e,oo,Bo);break;case 5:ya(e,oo,Bo);break;default:throw Error(c(329))}}}return ao(e,xe()),e.callbackNode===a?Mc.bind(null,e):null}function Mi(e,o){var a=kt;return e.current.memoizedState.isDehydrated&&(ba(e,o).flags|=256),e=jr(e,o),e!==2&&(o=oo,oo=a,o!==null&&_i(o)),e}function _i(e){oo===null?oo=e:oo.push.apply(oo,e)}function $u(e){for(var o=e;;){if(o.flags&16384){var a=o.updateQueue;if(a!==null&&(a=a.stores,a!==null))for(var t=0;t<a.length;t++){var r=a[t],n=r.getSnapshot;r=r.value;try{if(!Eo(n(),r))return!1}catch{return!1}}}if(a=o.child,o.subtreeFlags&16384&&a!==null)a.return=o,o=a;else{if(o===e)break;for(;o.sibling===null;){if(o.return===null||o.return===e)return!0;o=o.return}o.sibling.return=o.return,o=o.sibling}}return!0}function sa(e,o){for(o&=~wi,o&=~Lr,e.suspendedLanes|=o,e.pingedLanes&=~o,e=e.expirationTimes;0<o;){var a=31-So(o),t=1<<a;e[a]=-1,o&=~t}}function _c(e){if((ne&6)!==0)throw Error(c(327));Ka();var o=$t(e,0);if((o&1)===0)return ao(e,xe()),null;var a=jr(e,o);if(e.tag!==0&&a===2){var t=vn(e);t!==0&&(o=t,a=Mi(e,t))}if(a===1)throw a=Lt,ba(e,0),sa(e,o),ao(e,xe()),a;if(a===6)throw Error(c(345));return e.finishedWork=e.current.alternate,e.finishedLanes=o,ya(e,oo,Bo),ao(e,xe()),null}function zi(e,o){var a=ne;ne|=1;try{return e(o)}finally{ne=a,ne===0&&($a=xe()+500,pr&&ea())}}function Ea(e){na!==null&&na.tag===0&&(ne&6)===0&&Ka();var o=ne;ne|=1;var a=Co.transition,t=ce;try{if(Co.transition=null,ce=1,e)return e()}finally{ce=t,Co.transition=a,ne=o,(ne&6)===0&&ea()}}function ji(){mo=Qa.current,he(Qa)}function ba(e,o){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Tu(a)),Pe!==null)for(a=Pe.return;a!==null;){var t=a;switch(Kn(t),t.tag){case 1:t=t.type.childContextTypes,t!=null&&ur();break;case 3:Wa(),he(Je),he(Ve),li();break;case 5:ii(t);break;case 4:Wa();break;case 13:he(ye);break;case 19:he(ye);break;case 10:oi(t.type._context);break;case 22:case 23:ji()}a=a.return}if(we=e,Pe=e=la(e.current,null),je=mo=o,Ne=0,Lt=null,wi=Lr=Sa=0,oo=kt=null,va!==null){for(o=0;o<va.length;o++)if(a=va[o],t=a.interleaved,t!==null){a.interleaved=null;var r=t.next,n=a.pending;if(n!==null){var i=n.next;n.next=r,t.next=i}a.pending=t}va=null}return e}function zc(e,o){do{var a=Pe;try{if(ei(),Ir.current=Pr,Tr){for(var t=Ie.memoizedState;t!==null;){var r=t.queue;r!==null&&(r.pending=null),t=t.next}Tr=!1}if(ha=0,qe=De=Ie=null,Rt=!1,Dt=0,qi.current=null,a===null||a.return===null){Ne=1,Lt=o,Pe=null;break}e:{var n=e,i=a.return,s=a,u=o;if(o=je,s.flags|=32768,u!==null&&typeof u=="object"&&typeof u.then=="function"){var h=u,x=s,A=x.tag;if((x.mode&1)===0&&(A===0||A===11||A===15)){var T=x.alternate;T?(x.updateQueue=T.updateQueue,x.memoizedState=T.memoizedState,x.lanes=T.lanes):(x.updateQueue=null,x.memoizedState=null)}var w=dc(i);if(w!==null){w.flags&=-257,uc(w,i,s,n,o),w.mode&1&&cc(n,h,o),o=w,u=h;var _=o.updateQueue;if(_===null){var j=new Set;j.add(u),o.updateQueue=j}else _.add(u);break e}else{if((o&1)===0){cc(n,h,o),Ui();break e}u=Error(c(426))}}else if(Ee&&s.mode&1){var Ae=dc(i);if(Ae!==null){(Ae.flags&65536)===0&&(Ae.flags|=256),uc(Ae,i,s,n,o),Jn(Ha(u,s));break e}}n=u=Ha(u,s),Ne!==4&&(Ne=2),kt===null?kt=[n]:kt.push(n),n=i;do{switch(n.tag){case 3:n.flags|=65536,o&=-o,n.lanes|=o;var g=sc(n,u,o);Ll(n,g);break e;case 1:s=u;var p=n.type,v=n.stateNode;if((n.flags&128)===0&&(typeof p.getDerivedStateFromError=="function"||v!==null&&typeof v.componentDidCatch=="function"&&(ra===null||!ra.has(v)))){n.flags|=65536,o&=-o,n.lanes|=o;var D=lc(n,s,o);Ll(n,D);break e}}n=n.return}while(n!==null)}Bc(a)}catch(B){o=B,Pe===a&&a!==null&&(Pe=a=a.return);continue}break}while(!0)}function jc(){var e=wr.current;return wr.current=Pr,e===null?Pr:e}function Ui(){(Ne===0||Ne===3||Ne===2)&&(Ne=4),we===null||(Sa&268435455)===0&&(Lr&268435455)===0||sa(we,je)}function jr(e,o){var a=ne;ne|=2;var t=jc();(we!==e||je!==o)&&(Bo=null,ba(e,o));do try{Ku();break}catch(r){zc(e,r)}while(!0);if(ei(),ne=a,wr.current=t,Pe!==null)throw Error(c(261));return we=null,je=0,Ne}function Ku(){for(;Pe!==null;)Uc(Pe)}function Yu(){for(;Pe!==null&&!bd();)Uc(Pe)}function Uc(e){var o=Hc(e.alternate,e,mo);e.memoizedProps=e.pendingProps,o===null?Bc(e):Pe=o,qi.current=null}function Bc(e){var o=e;do{var a=o.alternate;if(e=o.return,(o.flags&32768)===0){if(a=Bu(a,o,mo),a!==null){Pe=a;return}}else{if(a=Vu(a,o),a!==null){a.flags&=32767,Pe=a;return}if(e!==null)e.flags|=32768,e.subtreeFlags=0,e.deletions=null;else{Ne=6,Pe=null;return}}if(o=o.sibling,o!==null){Pe=o;return}Pe=o=e}while(o!==null);Ne===0&&(Ne=5)}function ya(e,o,a){var t=ce,r=Co.transition;try{Co.transition=null,ce=1,Xu(e,o,a,t)}finally{Co.transition=r,ce=t}return null}function Xu(e,o,a,t){do Ka();while(na!==null);if((ne&6)!==0)throw Error(c(327));a=e.finishedWork;var r=e.finishedLanes;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(c(177));e.callbackNode=null,e.callbackPriority=0;var n=a.lanes|a.childLanes;if(Od(e,n),e===we&&(Pe=we=null,je=0),(a.subtreeFlags&2064)===0&&(a.flags&2064)===0||Fr||(Fr=!0,Gc(Wt,function(){return Ka(),null})),n=(a.flags&15990)!==0,(a.subtreeFlags&15990)!==0||n){n=Co.transition,Co.transition=null;var i=ce;ce=1;var s=ne;ne|=4,qi.current=null,Hu(e,a),qc(a,e),Cu(Un),Xt=!!jn,Un=jn=null,e.current=a,Gu(a),yd(),ne=s,ce=i,Co.transition=n}else e.current=a;if(Fr&&(Fr=!1,na=e,Mr=r),n=e.pendingLanes,n===0&&(ra=null),xd(a.stateNode),ao(e,xe()),o!==null)for(t=e.onRecoverableError,a=0;a<o.length;a++)r=o[a],t(r.value,{componentStack:r.stack,digest:r.digest});if(kr)throw kr=!1,e=ki,ki=null,e;return(Mr&1)!==0&&e.tag!==0&&Ka(),n=e.pendingLanes,(n&1)!==0?e===Fi?Ft++:(Ft=0,Fi=e):Ft=0,ea(),null}function Ka(){if(na!==null){var e=Ns(Mr),o=Co.transition,a=ce;try{if(Co.transition=null,ce=16>e?16:e,na===null)var t=!1;else{if(e=na,na=null,Mr=0,(ne&6)!==0)throw Error(c(331));var r=ne;for(ne|=4,F=e.current;F!==null;){var n=F,i=n.child;if((F.flags&16)!==0){var s=n.deletions;if(s!==null){for(var u=0;u<s.length;u++){var h=s[u];for(F=h;F!==null;){var x=F;switch(x.tag){case 0:case 11:case 15:wt(8,x,n)}var A=x.child;if(A!==null)A.return=x,F=A;else for(;F!==null;){x=F;var T=x.sibling,w=x.return;if(Pc(x),x===h){F=null;break}if(T!==null){T.return=w,F=T;break}F=w}}}var _=n.alternate;if(_!==null){var j=_.child;if(j!==null){_.child=null;do{var Ae=j.sibling;j.sibling=null,j=Ae}while(j!==null)}}F=n}}if((n.subtreeFlags&2064)!==0&&i!==null)i.return=n,F=i;else e:for(;F!==null;){if(n=F,(n.flags&2048)!==0)switch(n.tag){case 0:case 11:case 15:wt(9,n,n.return)}var g=n.sibling;if(g!==null){g.return=n.return,F=g;break e}F=n.return}}var p=e.current;for(F=p;F!==null;){i=F;var v=i.child;if((i.subtreeFlags&2064)!==0&&v!==null)v.return=i,F=v;else e:for(i=p;F!==null;){if(s=F,(s.flags&2048)!==0)try{switch(s.tag){case 0:case 11:case 15:qr(9,s)}}catch(B){Te(s,s.return,B)}if(s===i){F=null;break e}var D=s.sibling;if(D!==null){D.return=s.return,F=D;break e}F=s.return}}if(ne=r,ea(),Do&&typeof Do.onPostCommitFiberRoot=="function")try{Do.onPostCommitFiberRoot(Ht,e)}catch{}t=!0}return t}finally{ce=a,Co.transition=o}}return!1}function Vc(e,o,a){o=Ha(a,o),o=sc(e,o,1),e=aa(e,o,1),o=$e(),e!==null&&(it(e,1,o),ao(e,o))}function Te(e,o,a){if(e.tag===3)Vc(e,e,a);else for(;o!==null;){if(o.tag===3){Vc(o,e,a);break}else if(o.tag===1){var t=o.stateNode;if(typeof o.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(ra===null||!ra.has(t))){e=Ha(a,e),e=lc(o,e,1),o=aa(o,e,1),e=$e(),o!==null&&(it(o,1,e),ao(o,e));break}}o=o.return}}function Ju(e,o,a){var t=e.pingCache;t!==null&&t.delete(o),o=$e(),e.pingedLanes|=e.suspendedLanes&a,we===e&&(je&a)===a&&(Ne===4||Ne===3&&(je&130023424)===je&&500>xe()-Li?ba(e,0):wi|=a),ao(e,o)}function Wc(e,o){o===0&&((e.mode&1)===0?o=1:(o=Qt,Qt<<=1,(Qt&130023424)===0&&(Qt=4194304)));var a=$e();e=zo(e,o),e!==null&&(it(e,o,a),ao(e,a))}function Zu(e){var o=e.memoizedState,a=0;o!==null&&(a=o.retryLane),Wc(e,a)}function em(e,o){var a=0;switch(e.tag){case 13:var t=e.stateNode,r=e.memoizedState;r!==null&&(a=r.retryLane);break;case 19:t=e.stateNode;break;default:throw Error(c(314))}t!==null&&t.delete(o),Wc(e,a)}var Hc;Hc=function(e,o,a){if(e!==null)if(e.memoizedProps!==o.pendingProps||Je.current)eo=!0;else{if((e.lanes&a)===0&&(o.flags&128)===0)return eo=!1,Uu(e,o,a);eo=(e.flags&131072)!==0}else eo=!1,Ee&&(o.flags&1048576)!==0&&Tl(o,gr,o.index);switch(o.lanes=0,o.tag){case 2:var t=o.type;Nr(e,o),e=o.pendingProps;var r=Ma(o,Ve.current);Va(o,a),r=ui(null,o,t,e,r,a);var n=mi();return o.flags|=1,typeof r=="object"&&r!==null&&typeof r.render=="function"&&r.$$typeof===void 0?(o.tag=1,o.memoizedState=null,o.updateQueue=null,Ze(t)?(n=!0,mr(o)):n=!1,o.memoizedState=r.state!==null&&r.state!==void 0?r.state:null,ri(o),r.updater=Rr,o.stateNode=r,r._reactInternals=o,hi(o,t,e,a),o=yi(null,o,t,!0,n,a)):(o.tag=0,Ee&&n&&$n(o),Qe(null,o,r,a),o=o.child),o;case 16:t=o.elementType;e:{switch(Nr(e,o),e=o.pendingProps,r=t._init,t=r(t._payload),o.type=t,r=o.tag=am(t),e=yo(t,e),r){case 0:o=bi(null,o,t,e,a);break e;case 1:o=Cc(null,o,t,e,a);break e;case 11:o=mc(null,o,t,e,a);break e;case 14:o=pc(null,o,t,yo(t.type,e),a);break e}throw Error(c(306,t,""))}return o;case 0:return t=o.type,r=o.pendingProps,r=o.elementType===t?r:yo(t,r),bi(e,o,t,r,a);case 1:return t=o.type,r=o.pendingProps,r=o.elementType===t?r:yo(t,r),Cc(e,o,t,r,a);case 3:e:{if(hc(o),e===null)throw Error(c(387));t=o.pendingProps,n=o.memoizedState,r=n.element,wl(e,o),br(o,t,null,a);var i=o.memoizedState;if(t=i.element,n.isDehydrated)if(n={element:t,isDehydrated:!1,cache:i.cache,pendingSuspenseBoundaries:i.pendingSuspenseBoundaries,transitions:i.transitions},o.updateQueue.baseState=n,o.memoizedState=n,o.flags&256){r=Ha(Error(c(423)),o),o=Sc(e,o,t,a,r);break e}else if(t!==r){r=Ha(Error(c(424)),o),o=Sc(e,o,t,a,r);break e}else for(uo=Xo(o.stateNode.containerInfo.firstChild),co=o,Ee=!0,bo=null,a=Ol(o,null,t,a),o.child=a;a;)a.flags=a.flags&-3|4096,a=a.sibling;else{if(ja(),t===r){o=Uo(e,o,a);break e}Qe(e,o,t,a)}o=o.child}return o;case 5:return Fl(o),e===null&&Xn(o),t=o.type,r=o.pendingProps,n=e!==null?e.memoizedProps:null,i=r.children,Bn(t,r)?i=null:n!==null&&Bn(t,n)&&(o.flags|=32),vc(e,o),Qe(e,o,i,a),o.child;case 6:return e===null&&Xn(o),null;case 13:return Ec(e,o,a);case 4:return ni(o,o.stateNode.containerInfo),t=o.pendingProps,e===null?o.child=Ua(o,null,t,a):Qe(e,o,t,a),o.child;case 11:return t=o.type,r=o.pendingProps,r=o.elementType===t?r:yo(t,r),mc(e,o,t,r,a);case 7:return Qe(e,o,o.pendingProps,a),o.child;case 8:return Qe(e,o,o.pendingProps.children,a),o.child;case 12:return Qe(e,o,o.pendingProps.children,a),o.child;case 10:e:{if(t=o.type._context,r=o.pendingProps,n=o.memoizedProps,i=r.value,fe(hr,t._currentValue),t._currentValue=i,n!==null)if(Eo(n.value,i)){if(n.children===r.children&&!Je.current){o=Uo(e,o,a);break e}}else for(n=o.child,n!==null&&(n.return=o);n!==null;){var s=n.dependencies;if(s!==null){i=n.child;for(var u=s.firstContext;u!==null;){if(u.context===t){if(n.tag===1){u=jo(-1,a&-a),u.tag=2;var h=n.updateQueue;if(h!==null){h=h.shared;var x=h.pending;x===null?u.next=u:(u.next=x.next,x.next=u),h.pending=u}}n.lanes|=a,u=n.alternate,u!==null&&(u.lanes|=a),ai(n.return,a,o),s.lanes|=a;break}u=u.next}}else if(n.tag===10)i=n.type===o.type?null:n.child;else if(n.tag===18){if(i=n.return,i===null)throw Error(c(341));i.lanes|=a,s=i.alternate,s!==null&&(s.lanes|=a),ai(i,a,o),i=n.sibling}else i=n.child;if(i!==null)i.return=n;else for(i=n;i!==null;){if(i===o){i=null;break}if(n=i.sibling,n!==null){n.return=i.return,i=n;break}i=i.return}n=i}Qe(e,o,r.children,a),o=o.child}return o;case 9:return r=o.type,t=o.pendingProps.children,Va(o,a),r=go(r),t=t(r),o.flags|=1,Qe(e,o,t,a),o.child;case 14:return t=o.type,r=yo(t,o.pendingProps),r=yo(t.type,r),pc(e,o,t,r,a);case 15:return fc(e,o,o.type,o.pendingProps,a);case 17:return t=o.type,r=o.pendingProps,r=o.elementType===t?r:yo(t,r),Nr(e,o),o.tag=1,Ze(t)?(e=!0,mr(o)):e=!1,Va(o,a),nc(o,t,r),hi(o,t,r,a),yi(null,o,t,!0,e,a);case 19:return yc(e,o,a);case 22:return gc(e,o,a)}throw Error(c(156,o.tag))};function Gc(e,o){return xs(e,o)}function om(e,o,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=o,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function ho(e,o,a,t){return new om(e,o,a,t)}function Bi(e){return e=e.prototype,!(!e||!e.isReactComponent)}function am(e){if(typeof e=="function")return Bi(e)?1:0;if(e!=null){if(e=e.$$typeof,e===no)return 11;if(e===io)return 14}return 2}function la(e,o){var a=e.alternate;return a===null?(a=ho(e.tag,o,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=o,a.type=e.type,a.flags=0,a.subtreeFlags=0,a.deletions=null),a.flags=e.flags&14680064,a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,o=e.dependencies,a.dependencies=o===null?null:{lanes:o.lanes,firstContext:o.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function Ur(e,o,a,t,r,n){var i=2;if(t=e,typeof e=="function")Bi(e)&&(i=1);else if(typeof e=="string")i=5;else e:switch(e){case me:return Ia(a.children,r,n,o);case Oe:i=8,r|=8;break;case ro:return e=ho(12,a,o,r|2),e.elementType=ro,e.lanes=n,e;case Ue:return e=ho(13,a,o,r),e.elementType=Ue,e.lanes=n,e;case Ye:return e=ho(19,a,o,r),e.elementType=Ye,e.lanes=n,e;case ve:return Br(a,r,n,o);default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case ge:i=10;break e;case Lo:i=9;break e;case no:i=11;break e;case io:i=14;break e;case _e:i=16,t=null;break e}throw Error(c(130,e==null?e:typeof e,""))}return o=ho(i,a,o,r),o.elementType=e,o.type=t,o.lanes=n,o}function Ia(e,o,a,t){return e=ho(7,e,t,o),e.lanes=a,e}function Br(e,o,a,t){return e=ho(22,e,t,o),e.elementType=ve,e.lanes=a,e.stateNode={isHidden:!1},e}function Vi(e,o,a){return e=ho(6,e,null,o),e.lanes=a,e}function Wi(e,o,a){return o=ho(4,e.children!==null?e.children:[],e.key,o),o.lanes=a,o.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},o}function tm(e,o,a,t,r){this.tag=o,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=Cn(0),this.expirationTimes=Cn(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Cn(0),this.identifierPrefix=t,this.onRecoverableError=r,this.mutableSourceEagerHydrationData=null}function Hi(e,o,a,t,r,n,i,s,u){return e=new tm(e,o,a,s,u),o===1?(o=1,n===!0&&(o|=8)):o=0,n=ho(3,null,null,o),e.current=n,n.stateNode=e,n.memoizedState={element:t,isDehydrated:a,cache:null,transitions:null,pendingSuspenseBoundaries:null},ri(n),e}function rm(e,o,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Re,key:t==null?null:""+t,children:e,containerInfo:o,implementation:a}}function Qc(e){if(!e)return Zo;e=e._reactInternals;e:{if(ua(e)!==e||e.tag!==1)throw Error(c(170));var o=e;do{switch(o.tag){case 3:o=o.stateNode.context;break e;case 1:if(Ze(o.type)){o=o.stateNode.__reactInternalMemoizedMergedChildContext;break e}}o=o.return}while(o!==null);throw Error(c(171))}if(e.tag===1){var a=e.type;if(Ze(a))return bl(e,a,o)}return o}function $c(e,o,a,t,r,n,i,s,u){return e=Hi(a,t,!0,e,r,n,i,s,u),e.context=Qc(null),a=e.current,t=$e(),r=ia(a),n=jo(t,r),n.callback=o??null,aa(a,n,r),e.current.lanes=r,it(e,r,t),ao(e,t),e}function Vr(e,o,a,t){var r=o.current,n=$e(),i=ia(r);return a=Qc(a),o.context===null?o.context=a:o.pendingContext=a,o=jo(n,i),o.payload={element:e},t=t===void 0?null:t,t!==null&&(o.callback=t),e=aa(r,o,i),e!==null&&(xo(e,r,i,n),Er(e,r,i)),i}function Wr(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Kc(e,o){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<o?a:o}}function Gi(e,o){Kc(e,o),(e=e.alternate)&&Kc(e,o)}function nm(){return null}var Yc=typeof reportError=="function"?reportError:function(e){console.error(e)};function Qi(e){this._internalRoot=e}Hr.prototype.render=Qi.prototype.render=function(e){var o=this._internalRoot;if(o===null)throw Error(c(409));Vr(e,o,null,null)},Hr.prototype.unmount=Qi.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var o=e.containerInfo;Ea(function(){Vr(null,e,null,null)}),o[ko]=null}};function Hr(e){this._internalRoot=e}Hr.prototype.unstable_scheduleHydration=function(e){if(e){var o=ws();e={blockedOn:null,target:e,priority:o};for(var a=0;a<$o.length&&o!==0&&o<$o[a].priority;a++);$o.splice(a,0,e),a===0&&Fs(e)}};function $i(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function Gr(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function Xc(){}function im(e,o,a,t,r){if(r){if(typeof t=="function"){var n=t;t=function(){var h=Wr(i);n.call(h)}}var i=$c(o,t,e,0,null,!1,!1,"",Xc);return e._reactRootContainer=i,e[ko]=i.current,Et(e.nodeType===8?e.parentNode:e),Ea(),i}for(;r=e.lastChild;)e.removeChild(r);if(typeof t=="function"){var s=t;t=function(){var h=Wr(u);s.call(h)}}var u=Hi(e,0,!1,null,null,!1,!1,"",Xc);return e._reactRootContainer=u,e[ko]=u.current,Et(e.nodeType===8?e.parentNode:e),Ea(function(){Vr(o,u,a,t)}),u}function Qr(e,o,a,t,r){var n=a._reactRootContainer;if(n){var i=n;if(typeof r=="function"){var s=r;r=function(){var u=Wr(i);s.call(u)}}Vr(o,i,e,r)}else i=im(a,o,e,r,t);return Wr(i)}Os=function(e){switch(e.tag){case 3:var o=e.stateNode;if(o.current.memoizedState.isDehydrated){var a=nt(o.pendingLanes);a!==0&&(hn(o,a|1),ao(o,xe()),(ne&6)===0&&($a=xe()+500,ea()))}break;case 13:Ea(function(){var t=zo(e,1);if(t!==null){var r=$e();xo(t,e,1,r)}}),Gi(e,1)}},Sn=function(e){if(e.tag===13){var o=zo(e,134217728);if(o!==null){var a=$e();xo(o,e,134217728,a)}Gi(e,134217728)}},qs=function(e){if(e.tag===13){var o=ia(e),a=zo(e,o);if(a!==null){var t=$e();xo(a,e,o,t)}Gi(e,o)}},ws=function(){return ce},Ls=function(e,o){var a=ce;try{return ce=e,o()}finally{ce=a}},un=function(e,o,a){switch(o){case"input":if(an(e,a),o=a.name,a.type==="radio"&&o!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+o)+'][type="radio"]'),o=0;o<a.length;o++){var t=a[o];if(t!==e&&t.form===e.form){var r=dr(t);if(!r)throw Error(c(90));Be(t),an(t,r)}}}break;case"textarea":cs(e,a);break;case"select":o=a.value,o!=null&&xa(e,!!a.multiple,o,!1)}},hs=zi,Ss=Ea;var sm={usingClientEntryPoint:!1,Events:[It,ka,dr,vs,Cs,zi]},Mt={findFiberByHostInstance:ma,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},lm={bundleType:Mt.bundleType,version:Mt.version,rendererPackageName:Mt.rendererPackageName,rendererConfig:Mt.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:be.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Is(e),e===null?null:e.stateNode},findFiberByHostInstance:Mt.findFiberByHostInstance||nm,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var $r=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!$r.isDisabled&&$r.supportsFiber)try{Ht=$r.inject(lm),Do=$r}catch{}}return to.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=sm,to.createPortal=function(e,o){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!$i(o))throw Error(c(200));return rm(e,o,null,a)},to.createRoot=function(e,o){if(!$i(e))throw Error(c(299));var a=!1,t="",r=Yc;return o!=null&&(o.unstable_strictMode===!0&&(a=!0),o.identifierPrefix!==void 0&&(t=o.identifierPrefix),o.onRecoverableError!==void 0&&(r=o.onRecoverableError)),o=Hi(e,1,!1,null,null,a,!1,t,r),e[ko]=o.current,Et(e.nodeType===8?e.parentNode:e),new Qi(o)},to.findDOMNode=function(e){if(e==null)return null;if(e.nodeType===1)return e;var o=e._reactInternals;if(o===void 0)throw typeof e.render=="function"?Error(c(188)):(e=Object.keys(e).join(","),Error(c(268,e)));return e=Is(o),e=e===null?null:e.stateNode,e},to.flushSync=function(e){return Ea(e)},to.hydrate=function(e,o,a){if(!Gr(o))throw Error(c(200));return Qr(null,e,o,!0,a)},to.hydrateRoot=function(e,o,a){if(!$i(e))throw Error(c(405));var t=a!=null&&a.hydratedSources||null,r=!1,n="",i=Yc;if(a!=null&&(a.unstable_strictMode===!0&&(r=!0),a.identifierPrefix!==void 0&&(n=a.identifierPrefix),a.onRecoverableError!==void 0&&(i=a.onRecoverableError)),o=$c(o,null,e,1,a??null,r,!1,n,i),e[ko]=o.current,Et(e),t)for(e=0;e<t.length;e++)a=t[e],r=a._getVersion,r=r(a._source),o.mutableSourceEagerHydrationData==null?o.mutableSourceEagerHydrationData=[a,r]:o.mutableSourceEagerHydrationData.push(a,r);return new Hr(o)},to.render=function(e,o,a){if(!Gr(o))throw Error(c(200));return Qr(null,e,o,!1,a)},to.unmountComponentAtNode=function(e){if(!Gr(e))throw Error(c(40));return e._reactRootContainer?(Ea(function(){Qr(null,null,e,!1,function(){e._reactRootContainer=null,e[ko]=null})}),!0):!1},to.unstable_batchedUpdates=zi,to.unstable_renderSubtreeIntoContainer=function(e,o,a,t){if(!Gr(a))throw Error(c(200));if(e==null||e._reactInternals===void 0)throw Error(c(38));return Qr(e,o,a,!1,t)},to.version="18.3.1-next-f1338f8080-20240426",to}var nd;function vm(){if(nd)return Xi.exports;nd=1;function l(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(l)}catch(C){console.error(C)}}return l(),Xi.exports=gm(),Xi.exports}var id;function Cm(){if(id)return Kr;id=1;var l=vm();return Kr.createRoot=l.createRoot,Kr.hydrateRoot=l.hydrateRoot,Kr}var hm=Cm(),M=ts();const m={bg:"#0a0a0f",surface:"#080c14",surface2:"#0f172a",border:"#1e293b",text:"#e2e8f0",textMuted:"#64748b",textDim:"#334155",m1:"#00D4FF",m2:"#7C3AED",m3:"#059669",m4:"#F59E0B",m5:"#7C3AED",m6:"#059669",m7:"#DC2626",m8:"#F59E0B",m9:"#06B6D4",m10:"#8B5CF6",m11:"#10B981",m12:"#F59E0B",success:"#10B981",error:"#EF4444",warning:"#F97316",xp:"#00D4FF"},Ya={moduleGroup:{marginBottom:24},moduleTitle:{fontSize:14,fontWeight:700,color:m.text,marginBottom:10,display:"flex",alignItems:"center",gap:8},noteCard:{padding:"12px 16px",borderRadius:6,border:`1px solid ${m.border}`,background:m.surface2,marginBottom:8},noteTitle:{fontSize:13,fontWeight:600,color:m.text,marginBottom:6},noteText:{fontSize:13,lineHeight:1.6,color:m.textMuted,whiteSpace:"pre-wrap"},empty:{textAlign:"center",padding:"40px 0",color:m.textMuted,fontSize:14}};function Sm({modules:l,notes:C}){return Object.values(C).some(b=>b&&b.trim())?d.jsx("div",{children:l.map(b=>{const E=b.topics.filter(S=>C[S.id]&&C[S.id].trim());return E.length===0?null:d.jsxs("div",{style:Ya.moduleGroup,children:[d.jsxs("div",{style:Ya.moduleTitle,children:[d.jsx("span",{children:b.icon}),d.jsx("span",{children:b.title})]}),E.map(S=>d.jsxs("div",{style:Ya.noteCard,children:[d.jsx("div",{style:Ya.noteTitle,children:S.title}),d.jsx("div",{style:Ya.noteText,children:C[S.id]})]},S.id))]},b.id)})}):d.jsx("div",{style:Ya.empty,children:"📝 Nenhuma anotação ainda. Comece a escrever nos tópicos!"})}function jt(l){if(l<60)return`${l}s`;const C=Math.floor(l/60);return C<60?`${C}min`:`${Math.floor(C/60)}h ${C%60}min`}const Se={section:{marginBottom:28},sectionTitle:{fontSize:14,fontWeight:700,color:m.text,marginBottom:12,display:"flex",alignItems:"center",gap:8},grid:{display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:8},topicCard:{padding:"10px 12px",borderRadius:6,border:`1px solid ${m.border}`,background:m.surface2,fontSize:12,lineHeight:1.4},topicTitle:{fontWeight:600,color:m.text,marginBottom:4},topicStatus:{fontSize:11,color:m.textMuted},moduleRow:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 14px",borderRadius:6,border:`1px solid ${m.border}`,background:m.surface2,marginBottom:6},moduleLabel:{fontSize:13,fontWeight:600,color:m.text,display:"flex",alignItems:"center",gap:8},moduleValue:{fontSize:13,color:m.textMuted},xpRow:{display:"flex",justifyContent:"space-between",padding:"8px 14px",borderRadius:6,background:m.surface2,marginBottom:4,fontSize:13},xpLabel:{color:m.textMuted},xpValue:{color:m.xp,fontWeight:600}};function Em({modules:l,completedTopics:C,checklists:c,quizzes:b,timers:E,xp:S}){let R=0,P=0,y=0;for(const O of l){O.topics.every(q=>C.includes(q.id))&&(y+=100);for(const q of O.topics){const k=c[q.id];k&&k.length>0&&k.every(Boolean)&&(R+=20);const K=b[q.id];if(K&&K.submitted){const Z=K.answers.reduce((V,U,G)=>V+(U===q.quiz[G].answer?1:0),0);P+=Z*10}}}return d.jsxs("div",{children:[l.map(O=>d.jsxs("div",{style:Se.section,children:[d.jsxs("div",{style:Se.sectionTitle,children:[d.jsx("span",{children:O.icon}),d.jsx("span",{children:O.title})]}),d.jsx("div",{style:Se.grid,children:O.topics.map(z=>{const q=C.includes(z.id);return d.jsxs("div",{style:{...Se.topicCard,borderColor:q?`${m.success}60`:m.border},children:[d.jsxs("div",{style:Se.topicTitle,children:[q?"✅":"○"," ",z.title]}),d.jsx("div",{style:Se.topicStatus,children:q?"Concluído":"Pendente"})]},z.id)})})]},O.id)),d.jsxs("div",{style:Se.section,children:[d.jsx("div",{style:Se.sectionTitle,children:"⏱ Tempo por Módulo"}),l.map(O=>d.jsxs("div",{style:Se.moduleRow,children:[d.jsxs("span",{style:Se.moduleLabel,children:[d.jsx("span",{children:O.icon})," ",O.title]}),d.jsx("span",{style:Se.moduleValue,children:jt(E[O.id]||0)})]},O.id))]}),d.jsxs("div",{style:Se.section,children:[d.jsx("div",{style:Se.sectionTitle,children:"⚡ Origem do XP"}),d.jsxs("div",{style:Se.xpRow,children:[d.jsx("span",{style:Se.xpLabel,children:"Checklists completos"}),d.jsxs("span",{style:Se.xpValue,children:[R," XP"]})]}),d.jsxs("div",{style:Se.xpRow,children:[d.jsx("span",{style:Se.xpLabel,children:"Respostas corretas no quiz"}),d.jsxs("span",{style:Se.xpValue,children:[P," XP"]})]}),d.jsxs("div",{style:Se.xpRow,children:[d.jsx("span",{style:Se.xpLabel,children:"Módulos completos"}),d.jsxs("span",{style:Se.xpValue,children:[y," XP"]})]}),d.jsxs("div",{style:{...Se.xpRow,borderTop:`1px solid ${m.border}`,marginTop:8,paddingTop:12},children:[d.jsx("span",{style:{...Se.xpLabel,fontWeight:700,color:m.text},children:"Total"}),d.jsxs("span",{style:{...Se.xpValue,fontSize:15},children:[S," XP"]})]})]})]})}const Ta={moduleRow:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px",borderRadius:6,border:`1px solid ${m.border}`,background:m.surface2,marginBottom:8},label:{fontSize:14,fontWeight:600,color:m.text,display:"flex",alignItems:"center",gap:8},value:{fontSize:14,color:m.textMuted,fontWeight:600},totalRow:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 16px",borderRadius:6,background:`${m.m1}08`,border:`1px solid ${m.m1}30`,marginTop:16,marginBottom:8},totalLabel:{fontSize:15,fontWeight:700,color:m.text},totalValue:{fontSize:15,fontWeight:700,color:m.xp},avgRow:{padding:"10px 16px",borderRadius:6,background:m.surface2,fontSize:13,color:m.textMuted,textAlign:"center"}};function bm({modules:l,timers:C,completedCount:c}){const b=l.reduce((S,R)=>S+(C[R.id]||0),0),E=c>0?Math.round(b/c):0;return d.jsxs("div",{children:[l.map(S=>d.jsxs("div",{style:Ta.moduleRow,children:[d.jsxs("span",{style:Ta.label,children:[d.jsx("span",{children:S.icon})," ",S.title]}),d.jsx("span",{style:Ta.value,children:jt(C[S.id]||0)})]},S.id)),d.jsxs("div",{style:Ta.totalRow,children:[d.jsx("span",{style:Ta.totalLabel,children:"Tempo Total"}),d.jsx("span",{style:Ta.totalValue,children:jt(b)})]}),d.jsxs("div",{style:Ta.avgRow,children:["Média por tópico concluído:"," ",c>0?jt(E):"—"]})]})}const Vo={empty:{textAlign:"center",padding:"40px 0",color:m.textMuted,fontSize:14},questionCard:{padding:"16px",borderRadius:8,border:`1px solid ${m.border}`,background:m.surface2,marginBottom:12},topicLabel:{fontSize:11,color:m.textMuted,marginBottom:8,textTransform:"uppercase",letterSpacing:.5},questionText:{fontSize:14,fontWeight:600,color:m.text,marginBottom:12,lineHeight:1.5},answerRow:{display:"flex",alignItems:"flex-start",gap:8,marginBottom:6,fontSize:13,lineHeight:1.4},wrongLabel:{color:m.error,fontWeight:600,flexShrink:0},correctLabel:{color:m.success,fontWeight:600,flexShrink:0},explanation:{marginTop:10,padding:"10px 12px",borderRadius:6,background:`${m.m1}08`,border:`1px solid ${m.m1}30`,fontSize:13,color:m.textMuted,lineHeight:1.5}};function ym({modules:l,quizzes:C}){const c=[];for(const b of l)for(const E of b.topics){const S=C[E.id];!S||!S.submitted||E.quiz.forEach((R,P)=>{S.answers[P]!==R.answer&&c.push({topicTitle:E.title,moduleIcon:b.icon,moduleName:b.title,question:R.question,givenAnswer:R.options[S.answers[P]],correctAnswer:R.options[R.answer],explanation:R.explanation})})}return c.length===0?d.jsx("div",{style:Vo.empty,children:"Nenhum erro para revisar 🎉"}):d.jsx("div",{children:c.map((b,E)=>d.jsxs("div",{style:Vo.questionCard,children:[d.jsxs("div",{style:Vo.topicLabel,children:[b.moduleIcon," ",b.moduleName," › ",b.topicTitle]}),d.jsx("div",{style:Vo.questionText,children:b.question}),d.jsxs("div",{style:Vo.answerRow,children:[d.jsx("span",{style:Vo.wrongLabel,children:"Sua resposta:"}),d.jsx("span",{style:{color:m.error},children:b.givenAnswer})]}),d.jsxs("div",{style:Vo.answerRow,children:[d.jsx("span",{style:Vo.correctLabel,children:"Correta:"}),d.jsx("span",{style:{color:m.success},children:b.correctAnswer})]}),d.jsx("div",{style:Vo.explanation,children:b.explanation})]},E))})}const Im=[{key:"progress",label:"📊 Progresso"},{key:"notes",label:"📝 Anotações"},{key:"review",label:"❌ Revisar"},{key:"time",label:"⏱ Tempo"}],Ao={overlay:{position:"fixed",inset:0,zIndex:200,background:"rgba(0,0,0,0.7)",display:"flex",alignItems:"center",justifyContent:"center"},modal:{width:"90vw",maxWidth:780,maxHeight:"85vh",background:m.surface,borderRadius:12,border:`1px solid ${m.border}`,display:"flex",flexDirection:"column",overflow:"hidden"},header:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 24px",borderBottom:`1px solid ${m.border}`,flexShrink:0},title:{fontSize:18,fontWeight:700,color:m.text},closeBtn:{width:32,height:32,borderRadius:6,border:`1px solid ${m.border}`,background:"transparent",color:m.textMuted,fontSize:16,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.15s"},tabs:{display:"flex",gap:0,borderBottom:`1px solid ${m.border}`,flexShrink:0},tab:{flex:1,padding:"12px 16px",fontSize:13,fontWeight:600,color:m.textMuted,background:"transparent",border:"none",borderBottom:"2px solid transparent",cursor:"pointer",transition:"all 0.15s",textAlign:"center"},tabActive:{color:m.text,borderBottomColor:m.m1,background:`${m.m1}08`},body:{flex:1,overflowY:"auto",padding:24},footer:{padding:"12px 24px",borderTop:`1px solid ${m.border}`,display:"flex",justifyContent:"center",flexShrink:0},resetBtn:{padding:"8px 20px",borderRadius:6,border:`1px solid ${m.error}40`,background:"transparent",color:m.error,fontSize:13,fontWeight:600,cursor:"pointer",transition:"all 0.15s"}};function Tm({modules:l,completedTopics:C,checklists:c,quizzes:b,notes:E,timers:S,xp:R,onClose:P,onReset:y}){const[O,z]=M.useState("progress"),q=C.length,k=()=>{window.confirm("Tem certeza que deseja resetar todo o progresso? Esta ação não pode ser desfeita.")&&y()};return d.jsx("div",{style:Ao.overlay,onClick:P,children:d.jsxs("div",{style:Ao.modal,onClick:K=>K.stopPropagation(),children:[d.jsxs("div",{style:Ao.header,children:[d.jsx("div",{style:Ao.title,children:"Dashboard"}),d.jsx("button",{style:Ao.closeBtn,onClick:P,"aria-label":"Fechar dashboard",children:"✕"})]}),d.jsx("div",{style:Ao.tabs,children:Im.map(K=>d.jsx("button",{style:{...Ao.tab,...O===K.key?Ao.tabActive:{}},onClick:()=>z(K.key),children:K.label},K.key))}),d.jsxs("div",{style:Ao.body,children:[O==="progress"&&d.jsx(Em,{modules:l,completedTopics:C,checklists:c,quizzes:b,timers:S,xp:R}),O==="notes"&&d.jsx(Sm,{modules:l,notes:E}),O==="review"&&d.jsx(ym,{modules:l,quizzes:b}),O==="time"&&d.jsx(bm,{modules:l,timers:S,completedCount:q})]}),d.jsx("div",{style:Ao.footer,children:d.jsx("button",{style:Ao.resetBtn,onClick:k,children:"🗑️ Resetar Progresso"})})]})})}const sd={container:{display:"flex",alignItems:"center",gap:6,padding:"4px 12px",borderRadius:6,border:`1px solid ${m.border}`,fontSize:13,fontWeight:600,whiteSpace:"nowrap"},icon:{fontSize:14}};function xm({seconds:l,moduleColor:C}){const c=jt(l||0);return d.jsxs("div",{style:{...sd.container,color:C||m.textMuted,borderColor:C?`${C}40`:m.border},children:[d.jsx("span",{style:sd.icon,children:"⏱"}),c]})}const Yr={container:{display:"flex",alignItems:"center",gap:10,fontSize:13,color:m.textMuted,whiteSpace:"nowrap"},barOuter:{width:80,height:6,background:m.border,borderRadius:3,overflow:"hidden"},label:{fontWeight:600},pct:{color:m.text,fontWeight:700,fontSize:12}},ld={phase1:`linear-gradient(90deg, ${m.m1}, ${m.m2}, ${m.m3}, ${m.m4})`,phase2:`linear-gradient(90deg, ${m.m5}, ${m.m6}, ${m.m7}, ${m.m8})`,phase3:`linear-gradient(90deg, ${m.m9}, ${m.m10}, ${m.m11}, ${m.m12})`};function Am({completedCount:l,totalTopics:C,currentPhase:c}){const b=C>0?Math.round(l/C*100):0,E=ld[c==null?void 0:c.id]||ld.phase1;return d.jsxs("div",{style:Yr.container,children:[d.jsxs("span",{style:Yr.label,children:[l," / ",C," tópicos"]}),d.jsx("div",{style:Yr.barOuter,children:d.jsx("div",{style:{height:"100%",width:`${b}%`,background:E,borderRadius:3,transition:"width 0.5s ease"}})}),d.jsxs("span",{style:Yr.pct,children:[b,"%"]})]})}const Xr={container:{display:"flex",alignItems:"center",gap:10,padding:"4px 12px",borderRadius:6,border:`1px solid ${m.border}`,fontSize:13,fontWeight:600,whiteSpace:"nowrap"},xpText:{color:m.xp},barOuter:{width:60,height:6,background:m.border,borderRadius:3,overflow:"hidden"},level:{fontSize:12,fontWeight:700,background:`linear-gradient(135deg, ${m.m1}, ${m.m2})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}};function Pm({xp:l}){const C=Math.floor(l/500)+1,b=l%500/500*100;return d.jsxs("div",{style:Xr.container,children:[d.jsxs("span",{style:Xr.xpText,children:["⚡ ",l," XP"]}),d.jsx("div",{style:Xr.barOuter,children:d.jsx("div",{style:{height:"100%",width:`${b}%`,background:`linear-gradient(90deg, ${m.m1}, ${m.m2})`,borderRadius:3,transition:"width 0.5s ease"}})}),d.jsxs("span",{style:Xr.level,children:["LVL ",C]})]})}const Jr={header:{position:"fixed",top:0,left:0,right:0,height:56,zIndex:100,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 24px",background:m.surface,borderBottom:`1px solid ${m.border}`},logo:{fontSize:18,fontWeight:700,letterSpacing:1,background:`linear-gradient(135deg, ${m.m1}, ${m.m2})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",userSelect:"none"},center:{display:"flex",alignItems:"center"},right:{display:"flex",alignItems:"center",gap:12}};function Rm({timerSeconds:l,moduleColor:C,xp:c,completedCount:b,totalTopics:E,currentPhase:S,onDashboardOpen:R}){var P;return d.jsxs("header",{style:Jr.header,children:[d.jsxs("div",{style:Jr.logo,children:[".NET ",((P=S==null?void 0:S.title)==null?void 0:P.toUpperCase())||"FASE 1"]}),d.jsx("div",{style:Jr.center,children:d.jsx(Am,{completedCount:b,totalTopics:E,currentPhase:S})}),d.jsxs("div",{style:Jr.right,children:[d.jsx(xm,{seconds:l,moduleColor:C}),d.jsx(Pm,{xp:c}),d.jsx("button",{onClick:R,"aria-label":"Abrir dashboard",style:{width:34,height:34,borderRadius:6,border:`1px solid ${m.border}`,background:"transparent",color:m.textMuted,fontSize:16,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.15s"},children:"📊"})]})]})}const Dm={success:m.success,xp:m.xp,unlock:m.warning},cd={container:{position:"fixed",bottom:20,right:20,zIndex:300,display:"flex",flexDirection:"column",gap:8,pointerEvents:"none"},toast:{pointerEvents:"auto",padding:"12px 20px",borderRadius:8,fontSize:14,fontWeight:600,color:m.text,background:m.surface2,border:`1px solid ${m.border}`,boxShadow:"0 4px 24px rgba(0,0,0,0.5)",animation:"slideIn 0.3s ease-out",cursor:"pointer",maxWidth:320,lineHeight:1.4}};function Nm({toasts:l,onDismiss:C}){return!l||l.length===0?null:d.jsx("div",{style:cd.container,children:l.map(c=>d.jsx("div",{style:{...cd.toast,borderLeftWidth:4,borderLeftStyle:"solid",borderLeftColor:Dm[c.type]||m.success},onClick:()=>C(c.id),children:c.message},c.id))})}function Om(l,C,c){const b=c.findIndex(S=>S.id===l);if(b===0)return!0;const E=c[b-1];return C.includes(E.id)}function qm(l,C,c){const b=C[l]||[],E=c[l]||{},S=b.length>0&&b.every(Boolean),R=E.submitted===!0;return S&&R}function Ja(l){return l.flatMap(C=>C.topics)}function wm(l,C){return C.find(c=>c.id===l)}function Lm(l,C){return C.find(c=>c.topics.some(b=>b.id===l))}function km({topic:l,isActive:C,isCompleted:c,isLocked:b,moduleColor:E,onClick:S}){const[R,P]=M.useState(!1),y=b?"🔒":c?"✅":C?"▶":"○",O={display:"flex",alignItems:"center",gap:8,padding:"6px 12px 6px 20px",fontSize:13,cursor:b?"not-allowed":"pointer",opacity:b?.4:1,color:C?m.text:c?m.success:m.textMuted,background:C?`${E}12`:R&&!b?`${m.text}08`:"transparent",borderRadius:4,transition:"background 0.15s, color 0.15s",userSelect:"none"},z=()=>{b||S(l.id)};return d.jsxs("div",{style:O,onClick:z,onMouseEnter:()=>P(!0),onMouseLeave:()=>P(!1),children:[d.jsx("span",{style:{fontSize:12,flexShrink:0},children:y}),d.jsx("span",{style:{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.title})]})}function Fm({module:l,currentTopicId:C,completedTopics:c,allTopics:b,isTopicUnlocked:E,onTopicClick:S}){const[R,P]=M.useState(!0),[y,O]=M.useState(!1),z=l.topics.filter(G=>c.includes(G.id)).length,q=l.topics.length,k={display:"flex",alignItems:"center",gap:8,padding:"10px 12px",cursor:"pointer",userSelect:"none",borderLeft:`3px solid ${l.color}`,background:y?`${l.color}10`:"transparent",transition:"background 0.15s"},K={fontSize:13,fontWeight:600,color:m.text,flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},Z={fontSize:11,color:z===q?m.success:m.textMuted,flexShrink:0},V={fontSize:10,color:m.textMuted,transition:"transform 0.15s",transform:R?"rotate(90deg)":"rotate(0deg)",flexShrink:0},U={display:R?"flex":"none",flexDirection:"column",gap:2,paddingBottom:4};return d.jsxs("div",{children:[d.jsxs("div",{style:k,onClick:()=>P(!R),onMouseEnter:()=>O(!0),onMouseLeave:()=>O(!1),children:[d.jsx("span",{style:{fontSize:14},children:l.icon}),d.jsx("span",{style:K,children:l.title}),z===q?d.jsx("span",{style:{fontSize:10,fontWeight:700,color:m.success,background:`${m.success}15`,padding:"2px 6px",borderRadius:4,letterSpacing:.5,flexShrink:0},children:"✓ COMPLETO"}):d.jsxs("span",{style:Z,children:[z,"/",q]}),d.jsx("span",{style:V,children:"▶"})]}),d.jsx("div",{style:U,children:l.topics.map(G=>d.jsx(km,{topic:G,isActive:G.id===C,isCompleted:c.includes(G.id),isLocked:!E(G.id,c,b),moduleColor:l.color,onClick:S},G.id))})]})}function Mm({phase:l,phaseIndex:C,isUnlocked:c,currentTopicId:b,completedTopics:E,allTopicsForPhase:S,isTopicUnlocked:R,onTopicClick:P,justUnlocked:y}){const[O,z]=M.useState(c),[q,k]=M.useState(!1),K=M.useRef(null),Z=l.data.flatMap(me=>me.topics),V=Z.filter(me=>E.includes(me.id)).length,U=Z.length,G=V===U&&U>0;M.useEffect(()=>{y&&K.current&&(z(!0),K.current.scrollIntoView({behavior:"smooth",block:"center"}))},[y]);const X=()=>{c&&z(!O)},ue={display:"flex",alignItems:"center",gap:8,padding:"10px 12px",cursor:c?"pointer":"not-allowed",userSelect:"none",borderBottom:`1px solid ${m.border}`,background:q&&c?`${l.color}10`:"transparent",opacity:c?1:.5,transition:"background 0.15s, opacity 0.3s",animation:y?"phaseUnlock 1s ease":"none"},be={fontSize:12,fontWeight:700,color:l.color,letterSpacing:.8,textTransform:"uppercase",flex:1},Me=G?{fontSize:10,fontWeight:700,color:m.success,background:`${m.success}15`,padding:"2px 6px",borderRadius:4,letterSpacing:.5}:{fontSize:11,color:m.textMuted,fontWeight:600},Re={fontSize:10,color:m.textMuted,transition:"transform 0.15s",transform:O&&c?"rotate(90deg)":"rotate(0deg)",flexShrink:0};return d.jsxs("div",{children:[d.jsx("style",{children:`
      ...
      `}),d.jsxs("div",{ref:K,style:ue,onClick:X,onMouseEnter:()=>k(!0),onMouseLeave:()=>k(!1),children:[d.jsx("span",{style:{fontSize:12},children:c?G?"✅":"▶":"🔒"}),d.jsx("span",{style:be,children:l.title}),d.jsx("span",{style:Me,children:G?"CONCLUÍDA":`${V}/${U}`}),c&&d.jsx("span",{style:Re,children:"▶"})]}),O&&c&&d.jsx("div",{children:l.data.map(me=>d.jsx(Fm,{module:me,currentTopicId:b,completedTopics:E,allTopics:S,isTopicUnlocked:R,onTopicClick:P},me.id))})]})}const _m={sidebar:{width:220,minWidth:220,height:"calc(100vh - 56px)",overflowY:"auto",background:m.surface,borderRight:`1px solid ${m.border}`,display:"flex",flexDirection:"column"}};function zm({allPhases:l,currentTopicId:C,completedTopics:c,allTopics:b,isTopicUnlocked:E,onTopicClick:S,justUnlockedPhase:R}){return d.jsx("aside",{style:_m.sidebar,children:l.map((P,y)=>{const O=y>0?l[y-1]:null,z=O?Ja(O.data):[],q=y===0||z.every(k=>c.includes(k.id));return d.jsx(Mm,{phase:P,phaseIndex:y,isUnlocked:q,currentTopicId:C,completedTopics:c,allTopicsForPhase:b,isTopicUnlocked:E,onTopicClick:S,justUnlocked:R===P.id},P.id)})})}const ke={container:{marginBottom:32,borderRadius:8,border:`1px solid ${m.border}`,overflow:"hidden",transition:"background 0.3s"},containerDone:{background:`${m.success}08`,borderColor:`${m.success}40`},header:{padding:"16px 20px 12px"},title:{fontSize:16,fontWeight:600,color:m.text,display:"flex",alignItems:"center",gap:8,marginBottom:12},progressRow:{display:"flex",alignItems:"center",gap:10,marginBottom:4},progressText:{fontSize:12,color:m.textMuted,whiteSpace:"nowrap"},progressBarOuter:{flex:1,height:4,background:m.border,borderRadius:2,overflow:"hidden"},list:{padding:"0 20px 16px",display:"flex",flexDirection:"column",gap:6},item:{display:"flex",alignItems:"flex-start",gap:10,padding:"8px 12px",borderRadius:6,background:m.surface2,cursor:"pointer",transition:"background 0.15s",userSelect:"none"},checkbox:{width:18,height:18,borderRadius:4,border:`2px solid ${m.textDim}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,marginTop:1,transition:"all 0.15s",cursor:"pointer"},checkboxChecked:{background:m.success,borderColor:m.success},checkmark:{color:"#fff",fontSize:11,fontWeight:700},itemText:{fontSize:14,lineHeight:1.5,color:m.text,transition:"all 0.15s"},itemTextChecked:{textDecoration:"line-through",color:m.textMuted},doneMessage:{padding:"12px 20px 16px",fontSize:14,color:m.success,fontWeight:600,display:"flex",alignItems:"center",gap:8}};function jm({items:l,topicId:C,checked:c,onChange:b}){const E=c||l.map(()=>!1),S=E.filter(Boolean).length,R=S===l.length&&l.length>0,P=l.length>0?S/l.length*100:0,y=R?{...ke.container,...ke.containerDone}:ke.container,O={height:"100%",width:`${P}%`,background:R?m.success:m.m1,borderRadius:2,transition:"width 0.3s ease"};return d.jsxs("div",{style:y,children:[d.jsxs("div",{style:ke.header,children:[d.jsxs("div",{style:ke.title,children:[d.jsx("span",{children:"✅"}),d.jsx("span",{children:"Pratique no VSCode"})]}),d.jsxs("div",{style:ke.progressRow,children:[d.jsxs("span",{style:ke.progressText,children:[S," / ",l.length," tarefas concluídas"]}),d.jsx("div",{style:ke.progressBarOuter,children:d.jsx("div",{style:O})})]})]}),d.jsx("div",{style:ke.list,children:l.map((z,q)=>{const k=E[q],K=k?{...ke.checkbox,...ke.checkboxChecked}:ke.checkbox,Z=k?{...ke.itemText,...ke.itemTextChecked}:ke.itemText;return d.jsxs("div",{style:ke.item,onClick:()=>b(q,!k),children:[d.jsx("div",{style:K,children:k&&d.jsx("span",{style:ke.checkmark,children:"✓"})}),d.jsx("span",{style:Z,children:z})]},`${C}-cl-${q}`)})}),R&&d.jsxs("div",{style:ke.doneMessage,children:[d.jsx("span",{children:"🎉"}),d.jsx("span",{children:"Parabéns! Todas as tarefas concluídas"})]})]})}const Ke={keyword:"#c678dd",type:"#e5c07b",string:"#98c379",comment:"#5c6370",number:"#d19a66",method:"#61afef",attribute:"#56b6c2"},Um=["abstract","as","async","await","base","bool","break","byte","case","catch","char","checked","class","const","continue","decimal","default","delegate","do","double","else","enum","event","explicit","extern","false","finally","fixed","float","for","foreach","goto","if","implicit","in","int","interface","internal","is","lock","long","namespace","new","null","object","operator","out","override","params","private","protected","public","readonly","record","ref","return","sbyte","sealed","short","sizeof","stackalloc","static","string","struct","switch","this","throw","true","try","typeof","uint","ulong","unchecked","unsafe","ushort","using","var","virtual","void","volatile","when","where","while","yield","init","required","get","set","value","partial","global","not","and","or","with"],Bm=["Console","String","Int32","Int64","Boolean","Decimal","Double","List","Dictionary","HashSet","Array","Task","IEnumerable","IList","ICollection","IDictionary","IDisposable","Exception","ArgumentException","InvalidOperationException","NullReferenceException","StringBuilder","Span","ReadOnlySpan","Memory","Func","Action","Predicate","EventHandler","IComparable","IEquatable","CancellationToken","CancellationTokenSource","HttpClient","ILogger","IRepository","IService"];function pd(l){return l.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Vm(l){return pd(l).split(`
`).map(E=>{if(E.trimStart().startsWith("//"))return`<span style="color:${Ke.comment};font-style:italic">${E}</span>`;let S=E;S=S.replace(/(\$?&quot;(?:[^&]|&(?!quot;))*?&quot;|&quot;(?:[^&]|&(?!quot;))*?&quot;)/g,`<span style="color:${Ke.string}">$1</span>`),S=S.replace(/(&#39;.&#39;|&#39;\\.'&#39;)/g,`<span style="color:${Ke.string}">$1</span>`),S=S.replace(/(\[(?:Obsolete|Serializable|Flags|Test|Fact|Theory|HttpGet|HttpPost|Route|ApiController|Required)\])/g,`<span style="color:${Ke.attribute}">$1</span>`),S=S.replace(/\b(\d+\.?\d*[fFdDmMlL]?)\b/g,`<span style="color:${Ke.number}">$1</span>`);const R=new RegExp(`\\b(${Bm.join("|")})\\b`,"g");S=S.replace(R,`<span style="color:${Ke.type}">$1</span>`);const P=new RegExp(`\\b(${Um.join("|")})\\b`,"g");S=S.replace(P,`<span style="color:${Ke.keyword}">$1</span>`);const y=S.indexOf("//");if(y>0){const O=S.substring(0,y),z=S.substring(y);(O.match(/<span/g)||[]).length===(O.match(/<\/span>/g)||[]).length&&(S=`${O}<span style="color:${Ke.comment};font-style:italic">${z}</span>`)}return S}).join(`
`)}function Wm(l){return pd(l).split(`
...
`)}function Hm(l,C){return C==="bash"?Wm(l):Vm(l)}const Po={container:{marginBottom:32,borderRadius:8,overflow:"hidden",border:`1px solid ${m.border}`},header:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"8px 16px",background:m.surface,borderBottom:`1px solid ${m.border}`},language:{fontSize:12,fontWeight:600,color:m.textMuted,textTransform:"uppercase",letterSpacing:.5},copyBtn:{fontSize:12,fontWeight:600,padding:"4px 12px",borderRadius:4,border:`1px solid ${m.border}`,background:"transparent",color:m.textMuted,cursor:"pointer",transition:"all 0.15s",letterSpacing:.5},copyBtnCopied:{color:m.success,borderColor:m.success},codeWrap:{padding:"16px 20px",overflowX:"auto",background:"#060a10"},pre:{margin:0,fontFamily:"'Cascadia Code', 'Fira Code', 'Consolas', monospace",fontSize:13,lineHeight:1.7,color:m.text,whiteSpace:"pre",tabSize:4},runWrap:{padding:"8px 16px",background:m.surface2,borderTop:`1px solid ${m.border}`,display:"flex",alignItems:"center",gap:8},runLabel:{fontSize:12,color:m.textDim,fontFamily:"'Cascadia Code', 'Fira Code', 'Consolas', monospace"},runCmd:{fontSize:12,color:m.m1,fontFamily:"'Cascadia Code', 'Fira Code', 'Consolas', monospace"}};function Gm({code:l,language:C,runCommand:c}){const[b,E]=M.useState(!1),S=M.useCallback(()=>{navigator.clipboard.writeText(l).then(()=>{E(!0),setTimeout(()=>E(!1),2e3)})},[l]),R=Hm(l,C),P=b?{...Po.copyBtn,...Po.copyBtnCopied}:Po.copyBtn;return d.jsxs("div",{style:Po.container,children:[d.jsxs("div",{style:Po.header,children:[d.jsx("span",{style:Po.language,children:C}),d.jsx("button",{style:P,onClick:S,children:b?"✓ COPIADO":"COPIAR"})]}),d.jsx("div",{style:Po.codeWrap,children:d.jsx("pre",{style:Po.pre,dangerouslySetInnerHTML:{__html:R}})}),c&&d.jsxs("div",{style:Po.runWrap,children:[d.jsx("span",{style:Po.runLabel,children:"$"}),d.jsx("span",{style:Po.runCmd,children:c})]})]})}const dd={container:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"20px 0",marginTop:32,borderTop:`1px solid ${m.border}`},indicator:{fontSize:13,color:m.textMuted}};function ud({children:l,disabled:C,onClick:c}){const[b,E]=M.useState(!1),S={fontSize:14,fontWeight:600,padding:"8px 20px",borderRadius:6,border:`1px solid ${C?m.textDim:m.m1}`,background:C?"transparent":b?`${m.m1}20`:"transparent",color:C?m.textDim:m.m1,cursor:C?"not-allowed":"pointer",opacity:C?.5:1,transition:"all 0.15s",minWidth:120,textAlign:"center"};return d.jsx("button",{style:S,disabled:C,onClick:c,onMouseEnter:()=>E(!0),onMouseLeave:()=>E(!1),title:C&&l.toString().includes("Próximo")?"Complete o checklist e o quiz para avançar":void 0,children:l})}function Qm({currentIndex:l,totalTopics:C,canAdvance:c,onPrevious:b,onNext:E}){const S=l===0,R=l===C-1;return d.jsxs("div",{style:dd.container,children:[d.jsx(ud,{disabled:S,onClick:b,children:"← Anterior"}),d.jsxs("span",{style:dd.indicator,children:["Tópico ",l+1," de ",C]}),d.jsx(ud,{disabled:R||!c,onClick:E,children:"Próximo →"})]})}const Xa={container:{marginBottom:32,borderRadius:8,border:`1px solid ${m.border}`,overflow:"hidden"},header:{padding:"16px 20px 0",display:"flex",alignItems:"center",justifyContent:"space-between"},title:{fontSize:16,fontWeight:600,color:m.text,display:"flex",alignItems:"center",gap:8},saveIndicator:{fontSize:12,transition:"opacity 0.3s"},body:{padding:"12px 20px 16px"},textarea:{width:"100%",minHeight:80,padding:"12px 14px",borderRadius:6,border:`1px solid ${m.border}`,background:m.surface2,color:m.text,fontSize:14,lineHeight:1.6,fontFamily:"'Segoe UI', system-ui, -apple-system, sans-serif",resize:"vertical",outline:"none",transition:"border-color 0.15s",boxSizing:"border-box"}};function $m({topicId:l,value:C,onChange:c}){const[b,E]=M.useState(!1),[S,R]=M.useState(!1),P=M.useRef(null),y=q=>{const k=q.target.value;c(k),E(!0),R(!1),P.current&&clearTimeout(P.current),P.current=setTimeout(()=>{E(!1),R(!0),setTimeout(()=>R(!1),2e3)},1e3)};M.useEffect(()=>()=>{P.current&&clearTimeout(P.current)},[]);const O=b?"💾 Salvando...":S?"✓ Salvo":"",z=b?m.warning:m.success;return d.jsxs("div",{style:Xa.container,children:[d.jsxs("div",{style:Xa.header,children:[d.jsxs("div",{style:Xa.title,children:[d.jsx("span",{children:"📝"}),d.jsx("span",{children:"Minhas Anotações"})]}),d.jsx("span",{style:{...Xa.saveIndicator,color:z,opacity:b||S?1:0},children:O})]}),d.jsx("div",{style:Xa.body,children:d.jsx("textarea",{style:Xa.textarea,value:C||"",onChange:y,placeholder:"Anote suas dúvidas, insights ou observações sobre este tópico...",onFocus:q=>{q.target.style.borderColor=m.m1},onBlur:q=>{q.target.style.borderColor=m.border}})})]})}const Fe={container:{marginBottom:32,borderRadius:8,border:`1px solid ${m.border}`,overflow:"hidden"},header:{padding:"16px 20px 12px"},title:{fontSize:16,fontWeight:600,color:m.text,display:"flex",alignItems:"center",gap:8,marginBottom:4},question:{padding:"16px 20px",borderTop:`1px solid ${m.border}`},questionText:{fontSize:14,fontWeight:600,color:m.text,marginBottom:12,lineHeight:1.5},questionNumber:{color:m.m1,marginRight:8},options:{display:"flex",flexDirection:"column",gap:8},option:{padding:"10px 14px",borderRadius:6,border:`1px solid ${m.border}`,background:m.surface2,fontSize:14,color:m.text,cursor:"pointer",transition:"all 0.15s",textAlign:"left",lineHeight:1.4},optionSelected:{borderColor:m.m1,background:`${m.m1}10`},optionCorrect:{borderColor:m.success,background:`${m.success}15`,color:m.success},optionWrong:{borderColor:m.error,background:`${m.error}15`,color:m.error},optionDisabled:{cursor:"default",opacity:.7},explanation:{marginTop:12,padding:"10px 14px",borderRadius:6,background:`${m.m1}08`,border:`1px solid ${m.m1}30`,fontSize:13,lineHeight:1.6,color:m.textMuted},footer:{padding:"12px 20px 16px",borderTop:`1px solid ${m.border}`,display:"flex",alignItems:"center",justifyContent:"space-between"},submitBtn:{padding:"10px 24px",borderRadius:6,border:"none",fontWeight:600,fontSize:14,cursor:"pointer",transition:"all 0.15s"},score:{fontSize:14,fontWeight:600}};function Km({questions:l,topicId:C,savedAnswers:c,savedSubmitted:b,onSubmit:E}){const[S,R]=M.useState(c||l.map(()=>-1)),[P,y]=M.useState(b||!1),O=S.every(V=>V!==-1),z=(V,U)=>{P||R(G=>{const X=[...G];return X[V]=U,X})},q=()=>{if(!O||P)return;y(!0);const U=S.reduce((G,X,ue)=>G+(X===l[ue].answer?1:0),0)*10;E(S,U)},k=P?S.reduce((V,U,G)=>V+(U===l[G].answer?1:0),0):0,K=(V,U)=>{const G=S[V]===U,X=l[V].answer===U;if(!P)return G?{...Fe.option,...Fe.optionSelected}:Fe.option;let ue={...Fe.option,...Fe.optionDisabled};return X?ue={...ue,...Fe.optionCorrect}:G&&!X&&(ue={...ue,...Fe.optionWrong}),ue},Z={...Fe.submitBtn,background:O?m.m1:m.textDim,color:O?"#000":m.textMuted,cursor:O?"pointer":"not-allowed"};return d.jsxs("div",{style:Fe.container,children:[d.jsx("div",{style:Fe.header,children:d.jsxs("div",{style:Fe.title,children:[d.jsx("span",{children:"🧠"}),d.jsx("span",{children:"Teste seu Conhecimento"})]})}),l.map((V,U)=>d.jsxs("div",{style:Fe.question,children:[d.jsxs("div",{style:Fe.questionText,children:[d.jsxs("span",{style:Fe.questionNumber,children:[U+1,"."]}),V.q]}),d.jsx("div",{style:Fe.options,children:V.options.map((G,X)=>d.jsx("button",{style:K(U,X),onClick:()=>z(U,X),disabled:P,children:G},X))}),P&&d.jsxs("div",{style:Fe.explanation,children:["💡 ",V.explanation]})]},`${C}-q-${U}`)),d.jsx("div",{style:Fe.footer,children:P?d.jsxs("span",{style:{...Fe.score,color:k===l.length?m.success:m.warning},children:[k," / ",l.length," corretas — +",k*10," ","XP"]}):d.jsx("button",{style:Z,onClick:q,disabled:!O,children:"Confirmar Respostas"})})]})}const Zr={container:{marginBottom:32},sectionTitle:{fontSize:16,fontWeight:600,color:m.text,marginBottom:16,display:"flex",alignItems:"center",gap:8},paragraph:{fontSize:15,lineHeight:1.8,color:m.text,marginBottom:16,fontFamily:"'Segoe UI', system-ui, -apple-system, sans-serif"},inlineCode:{fontFamily:"'Cascadia Code', 'Fira Code', 'Consolas', monospace",fontSize:13,background:m.surface2,color:m.m1,padding:"2px 6px",borderRadius:4,border:`1px solid ${m.border}`}};function Ym(l){return l.split(/(`[^`]+`)/g).map((c,b)=>{if(c.startsWith("`")&&c.endsWith("`")){const E=c.slice(1,-1);return d.jsx("code",{style:Zr.inlineCode,children:E},b)}return c})}function Xm({theory:l}){const C=l.split(`

`);return d.jsxs("div",{style:Zr.container,children:[d.jsxs("div",{style:Zr.sectionTitle,children:[d.jsx("span",{children:"📖"}),d.jsx("span",{children:"Teoria"})]}),C.map((c,b)=>d.jsx("p",{style:Zr.paragraph,children:Ym(c)},b))]})}const da={container:{marginBottom:24},breadcrumb:{display:"flex",alignItems:"center",gap:8,fontSize:14,color:m.textMuted,marginBottom:8},separator:{color:m.textDim},meta:{display:"flex",alignItems:"center",gap:16,marginBottom:8},weekTag:{fontSize:12,fontWeight:600,padding:"3px 10px",borderRadius:12,letterSpacing:.5},progressWrap:{display:"flex",alignItems:"center",gap:8,flex:1},progressText:{fontSize:12,color:m.textMuted,whiteSpace:"nowrap"},progressBarOuter:{flex:1,height:4,background:m.border,borderRadius:2,maxWidth:120,overflow:"hidden"}};function Jm({topic:l,module:C,completedTopics:c}){const b=C.topics.filter(y=>c.includes(y.id)).length,E=C.topics.length,S=b/E*100,R={...da.weekTag,background:`${C.color}20`,color:C.color},P={height:"100%",width:`${S}%`,background:C.color,borderRadius:2,transition:"width 0.3s ease"};return d.jsxs("div",{style:da.container,children:[d.jsxs("div",{style:da.breadcrumb,children:[d.jsx("span",{children:C.icon}),d.jsx("span",{style:{color:C.color},children:C.title}),d.jsx("span",{style:da.separator,children:"›"}),d.jsx("span",{style:{color:m.text},children:l.title})]}),d.jsxs("div",{style:da.meta,children:[d.jsx("span",{style:R,children:C.week}),d.jsxs("div",{style:da.progressWrap,children:[d.jsxs("span",{style:da.progressText,children:[b,"/",E," tópicos"]}),d.jsx("div",{style:da.progressBarOuter,children:d.jsx("div",{style:P})})]})]})]})}function Zm({topic:l,module:C,completedTopics:c,currentIndex:b,totalTopics:E,canAdvance:S,onPrevious:R,onNext:P,checklist:y,onChecklistChange:O,quizAnswers:z,quizSubmitted:q,onQuizSubmit:k,notes:K,onNotesChange:Z}){return d.jsxs("div",{children:[d.jsx(Jm,{topic:l,module:C,completedTopics:c}),d.jsx(Xm,{theory:l.theory}),d.jsx(Gm,{code:l.code,language:l.codeLanguage,runCommand:l.runCommand}),d.jsx(jm,{items:l.checklist,topicId:l.id,checked:y,onChange:O}),d.jsx(Km,{questions:l.quiz,topicId:l.id,savedAnswers:z,savedSubmitted:q,onSubmit:k}),d.jsx($m,{topicId:l.id,value:K,onChange:Z}),d.jsx(Qm,{currentIndex:b,totalTopics:E,canAdvance:S,onPrevious:R,onNext:P})]})}const de={currentTopic:"phase1:current_topic",completed:"phase1:completed_topics",xp:"phase1:xp",checklist:l=>`phase1:checklist_${l}`,quiz:l=>`phase1:quiz_${l}`,notes:l=>`phase1:notes_${l}`,timer:l=>`phase1:timer_${l}`,phase2Completed:"phase2:completed_topics",phase2Xp:"phase2:xp",phase2Unlocked:"phase2:unlocked",checklist2:l=>`phase2:checklist_${l}`,quiz2:l=>`phase2:quiz_${l}`,notes2:l=>`phase2:notes_${l}`,timer2:l=>`phase2:timer_${l}`,phase3Completed:"phase3:completed_topics",phase3Xp:"phase3:xp",phase3Unlocked:"phase3:unlocked",checklist3:l=>`phase3:checklist_${l}`,quiz3:l=>`phase3:quiz_${l}`,notes3:l=>`phase3:notes_${l}`,timer3:l=>`phase3:timer_${l}`},en=l=>/^m[5-8]/.test(l),on=l=>/^m(9|1[0-2])/.test(l);function es(l){return on(l)?de.checklist3(l):en(l)?de.checklist2(l):de.checklist(l)}function os(l){return on(l)?de.quiz3(l):en(l)?de.quiz2(l):de.quiz(l)}function as(l){return on(l)?de.notes3(l):en(l)?de.notes2(l):de.notes(l)}function rs(l){return on(l)?de.timer3(l):en(l)?de.timer2(l):de.timer(l)}const ep={id:"m1",title:"C# Fundamentos",icon:"⚡",week:"Semana 1",color:"#00D4FF",topics:[{id:"m1t1",moduleId:"m1",title:"Tipos & Variáveis",theory:`Em C#, toda variável possui um tipo que define quais valores ela pode armazenar e quais operações são permitidas. O sistema de tipos do C# é dividido em duas categorias fundamentais: value types e reference types.
...
public record ResumoExtrato(
    ...
    decimal TotalTaxas,
    decimal SaldoFinal);`,checklist:["Identificar 3 Code Smells no projeto da Fase 2 usando a lista do tópico","Aplicar Extract Method em um método longo (F1 no Rider ou Ctrl+R+M no VS)","Substituir pelo menos 3 magic numbers por constantes nomeadas","Criar um record para agrupar parâmetros de um método com 4+ params","Rodar os testes após cada refatoração para garantir que nada quebrou"],quiz:[{question:"Qual a definição correta de refatoração?",options:["Reescrever o código do zero para adicionar novas funcionalidades","Alterar a estrutura interna do código sem modificar seu comportamento externo observável","Corrigir bugs sem alterar a arquitetura","Otimizar performance do código"],answer:1,explanation:"Refatoração é exclusivamente sobre estrutura interna — o comportamento externo deve permanecer idêntico. Alterações de funcionalidade ou bugs são outras atividades."},{question:'O que é "Primitive Obsession" como Code Smell?',options:["Usar tipos primitivos (string, int) onde uma classe ou record expressaria melhor o conceito — ex: CPF como string em vez de um Value Object Cpf","Código que usa muitos loops primitivos","Excesso de if/else","Usar int em vez de long"],answer:0,explanation:"Primitive Obsession é usar string para CPF, email, telefone quando um Value Object com validação embutida expressaria melhor a intenção e garantiria a consistência."},{question:"Por que refatorar sem testes automatizados é arriscado?",options:["Testes não são necessários para refatorar","Sem testes não há como verificar que o comportamento externo não mudou — você pode introduzir bugs silenciosos que só aparecem em produção","Refatoração só é válida com 100% de cobertura","O compilador garante que o comportamento não mudou"],answer:1,explanation:"Testes são a rede de segurança da refatoração. Sem eles, qualquer mudança estrutural pode alterar o comportamento sem que ninguém perceba até explodir em produção."}]}]},fp=[pp,dp,up,mp],Ro=[{id:"phase1",title:"Fase 1",subtitle:"C# Fundamentos & Git",data:rp,color:"#00D4FF",weeks:"Semanas 1–4"},{id:"phase2",title:"Fase 2",subtitle:"Web API & Banco de Dados",data:cp,color:"#7C3AED",weeks:"Semanas 5–8"},{id:"phase3",title:"Fase 3",subtitle:"Qualidade & Arquitetura",data:fp,color:"#10B981",weeks:"Semanas 9–12"}];function Wo(l){var C;try{const c=(C=window.storage)==null?void 0:C.getItem(l);return c!=null?JSON.parse(c):void 0}catch{return}}function gp(l,C){var c;try{(c=window.storage)==null||c.setItem(l,JSON.stringify(C))}catch{}}const vp=["m1t1","m1t2","m1t3","m1t4","m2t1","m2t2","m2t3","m2t4","m3t1","m3t2","m3t3","m3t4","m4t1","m4t2","m4t3","m4t4"],Cp=["m5t1","m5t2","m5t3","m5t4","m6t1","m6t2","m6t3","m6t4","m7t1","m7t2","m7t3","m7t4","m8t1","m8t2","m8t3","m8t4","m8proj"],hp=["m9t1","m9t2","m9t3","m9t4","m10t1","m10t2","m10t3","m10t4","m11t1","m11t2","m11t3","m11t4","m12t1","m12t2","m12t3","m12t4","m12proj"],Sp=["m1","m2","m3","m4"],Ep=["m5","m6","m7","m8"],bp=["m9","m10","m11","m12"];function yp(){const[l,C]=M.useState(!0),[c,b]=M.useState(null),E=M.useRef(!1);return M.useEffect(()=>{if(E.current)return;E.current=!0;const S=Wo(de.currentTopic)??null,R=Wo(de.xp)??0,P=Wo(de.completed)??[],y=Wo(de.phase2Completed)??[],O=Wo(de.phase3Completed)??[],z=[...P,...y,...O],q={},k={},K={},Z={},V=[...vp,...Cp,...hp],U=[...Sp,...Ep,...bp];for(const G of V){const X=Wo(es(G));X!==void 0&&(q[G]=X);const ue=Wo(os(G));ue!==void 0&&(k[G]=ue);const be=Wo(as(G));be!==void 0&&(K[G]=be)}for(const G of U){const X=Wo(rs(G));X!==void 0&&(Z[G]=X)}b({currentTopic:S,completed:z,xp:R,checklists:q,quizzes:k,notes:K,timers:Z}),C(!1)},[]),{loading:l,initialState:c,saveItem:gp,STORAGE:de}}const Ip=5e3;function Tp(l,C,c){const[b,E]=M.useState(C||{}),S=M.useRef(null),R=M.useRef(!0),P=M.useRef(l),y=M.useRef(b);y.current=b,P.current=l;const O=M.useCallback(()=>{S.current&&clearInterval(S.current),P.current&&(S.current=setInterval(()=>{!R.current||!P.current||E(z=>({...z,[P.current]:(z[P.current]||0)+5}))},Ip))},[]);return M.useEffect(()=>{if(!l){S.current&&clearInterval(S.current);return}return O(),()=>{S.current&&clearInterval(S.current)}},[l,O]),M.useEffect(()=>{const z=()=>{R.current=document.visibilityState==="visible"};return document.addEventListener("visibilitychange",z),()=>{document.removeEventListener("visibilitychange",z)}},[]),M.useEffect(()=>{l&&c(rs(l),b[l]||0)},[b,l,c]),b}const md=3,xp=3e3;function Ap(){const[l,C]=M.useState([]),c=M.useRef(1),b=M.useCallback((S,R="success")=>{const P=c.current++;C(y=>{const O=[...y,{id:P,message:S,type:R}];return O.length>md?O.slice(-md):O}),setTimeout(()=>{C(y=>y.filter(O=>O.id!==P))},xp)},[]),E=M.useCallback(S=>{C(R=>R.filter(P=>P.id!==S))},[]);return{toasts:l,addToast:b,removeToast:E}}function Pp(l,C,c){const[b,E]=M.useState(l||0),S=M.useRef({checklists:new Set,quizzes:new Set,modules:new Set}),R=M.useCallback((q,k)=>{E(K=>{const Z=K+q;return C(de.xp,Z),Z}),k&&c&&c(k,"xp")},[C,c]),P=M.useCallback(q=>{S.current.checklists.has(q)||(S.current.checklists.add(q),R(20,"+20 XP — Checklist completo!"))},[R]),y=M.useCallback((q,k)=>{if(S.current.quizzes.has(q))return;S.current.quizzes.add(q);const K=k*10;K>0&&R(K,`+${K} XP — Quiz concluído!`)},[R]),O=M.useCallback((q,k)=>{S.current.modules.has(q)||(S.current.modules.add(q),R(100,`🎉 Módulo ${k} Concluído! +100 XP`))},[R]),z=M.useCallback((q,k,K,Z)=>{for(const V of q){const U=K[V];U&&U.length>0&&U.every(Boolean)&&S.current.checklists.add(V);const G=k[V];G&&G.submitted&&S.current.quizzes.add(V)}for(const V of Z)V.topics.every(G=>q.includes(G.id))&&S.current.modules.add(V.id)},[]);return{xp:b,awardChecklistXP:P,awardQuizXP:y,awardModuleXP:O,initAwarded:z}}const zt={layout:{display:"flex",marginTop:56,height:"calc(100vh - 56px)",background:m.bg,color:m.text,fontFamily:"'Segoe UI', system-ui, -apple-system, sans-serif"},main:{flex:1,height:"calc(100vh - 56px)",overflowY:"auto",padding:32},mainInner:{maxWidth:820,margin:"0 auto"},placeholder:{display:"flex",alignItems:"center",justifyContent:"center",height:"60vh",color:m.textMuted,fontSize:16},loading:{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",background:m.bg,color:m.textMuted,fontSize:16,fontFamily:"'Segoe UI', system-ui, -apple-system, sans-serif"}};function Rp(){var le,ie;const{loading:l,initialState:C,saveItem:c}=yp(),{toasts:b,addToast:E,removeToast:S}=Ap(),R=M.useMemo(()=>Ro.flatMap(H=>H.data),[]),P=M.useMemo(()=>Ja(R),[R]),[y,O]=M.useState(null),[z,q]=M.useState([]),[k,K]=M.useState({}),[Z,V]=M.useState({}),[U,G]=M.useState({}),[X,ue]=M.useState(!1),[be,Me]=M.useState(!1),[Re,me]=M.useState(null),Oe=M.useRef(!1),ro=M.useRef(!1),ge=y?Lm(y,R):null,Lo=M.useMemo(()=>{if(!y)return Ro[0];for(const H of Ro)if(H.data.some(oe=>oe.topics.some(pe=>pe.id===y)))return H;return Ro[0]},[y]),{xp:no,awardChecklistXP:Ue,awardQuizXP:Ye,awardModuleXP:io,initAwarded:_e}=Pp((C==null?void 0:C.xp)||0,c,E),ve=Tp((ge==null?void 0:ge.id)||null,(C==null?void 0:C.timers)||{},c);M.useEffect(()=>{if(l||X||!C)return;O(C.currentTopic),q(C.completed),K(C.checklists),V(C.quizzes),G(C.notes),_e(C.completed,C.quizzes,C.checklists,R);const H=Ja(Ro[0].data);Oe.current=H.every(pe=>C.completed.includes(pe.id));const oe=Ja(Ro[1].data);ro.current=oe.every(pe=>C.completed.includes(pe.id)),ue(!0)},[l,X,C,_e,R]),M.useEffect(()=>{X&&c(de.currentTopic,y)},[y,X,c]),M.useEffect(()=>{if(!X)return;const H=z.filter(Be=>/^m[1-4]/.test(Be)),oe=z.filter(Be=>/^m[5-8]/.test(Be)),pe=z.filter(Be=>/^m(9|1[0-2])/.test(Be));c(de.completed,H),c(de.phase2Completed,oe),c(de.phase3Completed,pe)},[z,X,c]),M.useEffect(()=>{if(X)for(const[H,oe]of Object.entries(k))c(es(H),oe)},[k,X,c]),M.useEffect(()=>{if(X)for(const[H,oe]of Object.entries(Z))c(os(H),oe)},[Z,X,c]),M.useEffect(()=>{if(X)for(const[H,oe]of Object.entries(U))c(as(H),oe)},[U,X,c]);const N=y?wm(y,P):null,W=N?P.findIndex(H=>H.id===N.id):-1,L=y?qm(y,k,Z):!1,f=M.useCallback((H,oe)=>{!y||!N||K(pe=>{const so=[...pe[y]||N.checklist.map(()=>!1)];return so[H]=oe,so.every(Boolean)&&Ue(y),{...pe,[y]:so}})},[y,N,Ue]),I=M.useCallback((H,oe)=>{if(!y)return;const pe=N.quiz.reduce((Be,so,Xe)=>Be+(H[Xe]===so.answer?1:0),0);V(Be=>({...Be,[y]:{answers:H,submitted:!0}})),Ye(y,pe)},[y,N,Ye]),J=M.useCallback(H=>{y&&G(oe=>({...oe,[y]:H}))},[y]),ee=M.useCallback(()=>{W>0&&O(P[W-1].id)},[W,P]),te=M.useCallback(()=>{if(W<P.length-1&&L){const H=P[W+1].id;q(oe=>{if(oe.includes(y))return oe;const pe=[...oe,y];return ge&&ge.topics.every(Xe=>Xe.id===y||pe.includes(Xe.id))&&io(ge.id,ge.title),Oe.current||Ja(Ro[0].data).every(Xe=>Xe.id===y||pe.includes(Xe.id))&&(Oe.current=!0,E("🎉 Fase 2 Desbloqueada! Web API & Banco de Dados","unlock"),me("phase2"),setTimeout(()=>me(null),2e3)),!ro.current&&Oe.current&&Ja(Ro[1].data).every(Xe=>Xe.id===y||pe.includes(Xe.id))&&(ro.current=!0,E("🎉 Fase 3 Desbloqueada! Qualidade & Arquitetura","unlock"),me("phase3"),setTimeout(()=>me(null),2e3)),E("🔓 Novo tópico desbloqueado","unlock"),pe}),O(H)}},[W,P,L,y,ge,io,E]),re=M.useCallback(()=>{O(null),q([]),K({}),V({}),G({}),Me(!1),Oe.current=!1,ro.current=!1,c(de.currentTopic,null),c(de.completed,[]),c(de.phase2Completed,[]),c(de.phase3Completed,[]),c(de.xp,0);for(const H of Ro)for(const oe of H.data)for(const pe of oe.topics)c(es(pe.id),void 0),c(os(pe.id),void 0),c(as(pe.id),void 0);for(const H of Ro)for(const oe of H.data)c(rs(oe.id),void 0);E("Progresso resetado com sucesso","success")},[c,E]);return l||!X?d.jsx("div",{style:zt.loading,children:"Carregando progresso..."}):d.jsxs(d.Fragment,{children:[d.jsx(Rm,{timerSeconds:ge&&ve[ge.id]||0,moduleColor:ge==null?void 0:ge.color,xp:no,completedCount:z.length,totalTopics:P.length,currentPhase:Lo,onDashboardOpen:()=>Me(!0)}),d.jsxs("div",{style:zt.layout,children:[d.jsx(zm,{allPhases:Ro,currentTopicId:y,completedTopics:z,allTopics:P,isTopicUnlocked:Om,onTopicClick:O,justUnlockedPhase:Re}),d.jsx("main",{style:zt.main,children:d.jsx("div",{style:zt.mainInner,children:N&&ge?d.jsx(Zm,{topic:N,module:ge,completedTopics:z,currentIndex:W,totalTopics:P.length,canAdvance:L,onPrevious:ee,onNext:te,checklist:k[y],onChecklistChange:f,quizAnswers:(le=Z[y])==null?void 0:le.answers,quizSubmitted:(ie=Z[y])==null?void 0:ie.submitted,onQuizSubmit:I,notes:U[y],onNotesChange:J}):d.jsx("div",{style:zt.placeholder,children:"Selecione um tópico para começar"})})})]}),d.jsx(Nm,{toasts:b,onDismiss:S}),be&&d.jsx(Tm,{modules:R,completedTopics:z,checklists:k,quizzes:Z,notes:U,timers:ve,xp:no,onClose:()=>Me(!1),onReset:re})]})}hm.createRoot(document.getElementById("root")).render(d.jsx(Rp,{}));
